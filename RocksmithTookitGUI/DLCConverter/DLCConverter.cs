            ...
            using (var ofd = new OpenFileDialog())
            {
                ...
                switch (SourcePlatform.platform)
                {
                    ...
                    case GamePlatform.PS3:
                        ...
                        break;
                    default:
                        MessageBox.Show("The converted audio on Wwise 2013 (2017,2018 for DLC Manager) for target platform should be selected.", MESSAGEBOX_CAPTION, MessageBoxButtons.OK, MessageBoxIcon.Warning);
                        return;
                }
