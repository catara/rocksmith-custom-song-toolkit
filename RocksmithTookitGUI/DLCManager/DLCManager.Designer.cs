...
namespace RocksmithToolkitGUI.DLCManager
{
    partial class DLCManager
    {
        ...
        private void InitializeComponent()
        {
            ...
            lbl_Access.Size = new System.Drawing.Size(85, 15);
            ...
            cbx_Artist_Sort.Items.AddRange(new object[] { "<Artist>", "<Title>", "<Version>", "<DLCName>", "<CDLC>", "<Album>", "<Track No.>", "<Year>", "<Rating>", "<Alternate Version>", "<Has Official>", "<Duplicate>", "<Description>", "<Live Details>", "<Attributes extended>", "<Avail. Instr.>", "<Tuning>", "<Instr. Rating.>", "<Multi Track Details>", "<Group>", "<Groups>", "<GroupIndex>", "<GroupIndexAndName>", "<FirstGroupIndexAndName>", "<BetaOrGroupIndex>", "<Beta>", "<DD>", "<Broken>", "<File Name>", "<Bonus>", "<Artist Short>", "<Album Short>", "<Title Sort>", "<Artist Sort>", "<Album Sort>", "<Author>", "<Quality Assurance Attributes>", "<lastConversionDateTime>", "<Avail. Tracks>", "<Avail. Tracks w Bonus>", "<Avail. Tracks w Favorite>", "<Avail. Tracks and Timings>", "<Avail. Tracks and ShortTimings>", "<Avail. Tracks and ShortTimings&Bonus>", "<Avail. Tracks and ShortTimings&Bonus&Favorite>", "<Bass Has DynamicDificulty>", "<Timestamp>", "<TimestampShort>", "<Live>", "<Acoustic>", "<Instrumental>", "<EP>", "<Uncensored>", "<SoundTrack>", "<Single>", "<Track Tile (potentially) removed details>", "<LyricsLanguage>", "<IntheWorks>", "<IntheWorksWDetails>", "<Karaoke>", "<Cover>", "<Demo>", "<Remix>", "<FullAlbum>", "<Remastered>", "<Manipulated>", "<Medley>", "<Multistrings>", "<Official>", "<Volume>", "<Preview Volume>", "<Import Date>", "<Bitrate>", "<ToDos>", "<CDLC_ID>", "<DLCM Release>", "<DLCM ReleaseName>", "<DLCM ReleaseVersion>", "<Date>", "<DigitechDropFlag>", "<DigitechDropDetails>", "<Capo>", "<CapoFret>" });
            ...
            toolTip1.SetToolTip(btn_DistribNotes, "Apply Standardization Rules");
