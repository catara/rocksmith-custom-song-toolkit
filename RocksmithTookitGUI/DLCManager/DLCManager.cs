            ...
            if (!errr)
            {
                ...
                else
                {
                    ...
                    if (artist == "Insert")
                    {
                        ...
                        command.CommandText += ",@param70,@param71,@param72,@param73,@param74,@param75" + ")";//,@param76
