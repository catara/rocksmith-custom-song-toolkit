...
namespace RocksmithToolkitGUI.DLCManager
{
    public partial class frm_Duplicates_Management : Form
    {
                        ...
                        foreach (var arg in datas.Arrangements)
                        {
                            ...
                            for (i = 0; i <= noOfRec - 1; i++)
                            {
                                ...
                                if (1 == 2) //37. Keep the Uncompressed Songs superorganized   chbx_Additional_Manipulations.GetItemChecked(36)                             
                                    ...
                                    arg.SongFile.File = arg.SongXml.File.Replace(".xml", ".json").Replace("\\songs\\arr", "\\" + DLCManagers.calc_path(xx));
        ...
        private DLCManagers.Files filed;
