...
namespace RocksmithToolkitGUI.DLCManager
{
    public partial class frm_Duplicates_Management : Form
    {
        ...
        //public SQLiteConnection cnz { get; set; }
        public SQLite.SQLiteConnection cnc { get; set; }
        ...
        public string hasFeaturing { get; set; }
        public string hasCapo { get; set; }
        public string isRemix { get; set; }
        public string isCover { get; set; }
        public string isMedley { get; set; }
        public string isMultiStrings { get; set; }
        public string isDeluxe { get; set; }
        public string isGreatestHits { get; set; }
        //public bool newold { get; set; }
        public string isMidi { get; set; }
        public string isGameSoundtrack { get; set; }
        public string isTVTheme { get; set; }
        public string isAmateurCover { get; set; }
        public string isMetalCover { get; set; }
        public string isUkulele { get; set; }
        public string tuningFrecv { get; set; }
        public string duplic { get; set; }
        public string hasSlide { get; set; }
        //public bool newold { get; set; }
        ...
        internal frm_Duplicates_Management(UtilitiesFunctions.MainDBfields filed, DLCPackageData datas, string author, string tkversion, string dD,
            ...
            string original_Platform, string IsLive, string LiveDetails, string IsAcoustic, string dupli_reasons
            ...
            , string HasCapo, string description, string tuningfrecv, string HasSlide, int duplicateofid, OleDbConnection cnnb, SQLite.SQLiteConnection cnnc)
        {
            ...
            this.hasCapo = HasCapo;
            this.isRemix = IsRemix;
            this.isCover = IsCover;
            this.isMedley = IsMedley;
            this.isMultiStrings = IsMultiStrings;
            this.isDeluxe = IsDeluxe;
            this.isGreatestHits = IsGretestHits;
            this.isMidi = IsMidi;
            this.isGameSoundtrack = IsGameSoundtrack;
            this.isTVTheme = IsTVTheme;
            this.isAmateurCover = IsAmateurCover;
            this.isMetalCover = IsMetalCover;
            this.isUkulele = IsUkulele;
            this.tuningFrecv = tuningfrecv;
            ...
            this.duplic = duplicateofid.ToString();
        ...
        private string Filename = Path.Combine(Application.StartupPath, "Text.txt");/*System.IO.*/
        ...
        private void DuplicatesManagement_Load(object sender, EventArgs e)
        {
            ...
            txt_ExistingDuplicateOfID.Text = duplic;
            ...
            txt_CustomsForge_LinkExisting.Text = eXisting.CustomsForge_Link;
            txt_CustomsForge_LikeExisting.Text = eXisting.CustomsForge_Like;
            txt_CustomsForge_ReleaseNotesExisting.Text = eXisting.CustomsForge_ReleaseNotes;
            ...
            //        daa.Dispose();
            DataSet ds = new DataSet(); var cmd = "SELECT * FROM Arrangements WHERE CDLC_ID=" + eXisting.ID.ToString() + GetArrOfficSQLTxt(false);
            ds = SelectFromDB("Arrangements", cmd, "", cnb, cnc);
            var noOfRec = 0;
            //MessageBox.Show("0.1");
        ...
        internal UtilitiesFunctions.MainDBfields[] files = new UtilitiesFunctions.MainDBfields[20000];
        private UtilitiesFunctions.MainDBfields eXisting;
        ...
        public static string GetTExtFromFile(string ss)
        {
            ...
            if (File.Exists(ss))
            {
                ...
                catch (Exception ex)
                {
                    ...
                    MessageBox.Show("Can not open XML/JSON file for duplication assessment ! " + ss + "-");
                    //                throw;
                }
        ...
        public void exit()
        {
            ...
            Comment = txt_DescriptionNew.Text;//not used
            ...
            isKaraoke = chbx_KaraokeNew.Checked ? "Yes" : "No";
            ...
            isDemo = chbx_DemoNew.Checked ? "Yes" : "No";
            isCover = chbx_CoverNew.Checked ? "Yes" : "No";
            isRemix = chbx_RemixNew.Checked ? "Yes" : "No";
            isMedley = chbx_MedleyNew.Checked ? "Yes" : "No";
            isMetalCover = chbx_MetalNew.Checked ? "Yes" : "No";
            isUkulele = chbx_UkuleleNew.Checked ? "Yes" : "No";
            isTVTheme = chbx_TVThemeNew.Checked ? "Yes" : "No";
            isAmateurCover = chbx_AmateurCoverNew.Checked ? "Yes" : "No";
            isMultiStrings = chbx_MultiStringsNew.Checked ? "Yes" : "No";
            isGameSoundtrack = chbx_GameSoundtrackNew.Checked ? "Yes" : "No";
            isMidi = chbx_MidiNew.Checked ? "Yes" : "No";
            isGreatestHits = chbx_GreatestHitsNew.Checked ? "Yes" : "No";
            isDeluxe = chbx_DeluxeNew.Checked ? "Yes" : "No";
            isMultiStrings = chbx_MultiStringsNew.Checked ? "Yes" : "No";
            inTheWorks = chbx_InTheWorksNew.Checked ? "Yes" : "No";
            hasCapo = chbx_CapoNew.Checked ? "Yes" : "No";
            hasSlide = chbx_SlideNew.Checked ? "Yes" : "No";
            ...
            {
                DeleteFromDB("Tones", "DELETE * FROM Tones WHERE CDLC_ID=" + lbl_IDExisting.Text, cnb, cnc);
                DeleteFromDB("Arrangements", "DELETE * FROM Arrangements WHERE CDLC_ID=" + lbl_IDExisting.Text, cnb, cnc);
            }
        }
        ...
        public void UpdateExisting()
        {
            ...
            sel += "\", Is_Deluxe = \"" + (chbx_DeluxeExisting.Checked ? "Yes" : "No");
            sel += "\", Is_GreatestHits = \"" + (chbx_GreatestHitsExisting.Checked ? "Yes" : "No");
            sel += "\", Is_FullAlbum = \"" + (chbx_FullAlbumExisting.Checked ? "Yes" : "No");
            sel += "\", Is_Karaoke = \"" + (chbx_KaraokeExisting.Checked ? "Yes" : "No");
            sel += "\", Is_TVTheme = \"" + (chbx_TVThemeExisting.Checked ? "Yes" : "No");
            sel += "\", Is_AmateurCover = \"" + (chbx_AmateurCoverExisting.Checked ? "Yes" : "No");
            sel += "\", Is_Midi = \"" + (chbx_MidiExisting.Checked ? "Yes" : "No");
            sel += "\", Is_GameSoundtrack = \"" + (chbx_GameSoundtrackExisting.Checked ? "Yes" : "No");
            sel += "\", Is_Instrumental = \"" + (chbx_InstrumentalExisting.Checked ? "Yes" : "No");
            sel += "\", Is_Demo = \"" + (chbx_DemoExisting.Checked ? "Yes" : "No");
            sel += "\", Is_Remix = \"" + (chbx_RemixExisting.Checked ? "Yes" : "No");
            sel += "\", Is_Cover = \"" + (chbx_CoverExisting.Checked ? "Yes" : "No");
            sel += "\", Has_Featuring = \"" + (chbx_FeaturingExisting.Checked ? "Yes" : "No");
            ...
            sel += "\", Is_Medley = \"" + (chbx_MedleyExisting.Checked ? "Yes" : "No");
            ...
            DataSet ddr = new DataSet(); ddr = UpdateDB("Main", sel + ";", cnb, cnc);
            if (reffy != 0)
                UpdateCompareBase();
        ...
        public void UpdateCompareBase()
        {
            ...
            sel += "\", Is_Karaoke = \"" + (chbx_KaraokeNew.Checked ? "Yes" : "No");
            sel += "\", Is_TVTheme = \"" + (chbx_TVThemeNew.Checked ? "Yes" : "No");
            sel += "\", Is_GameSoundtrack = \"" + (chbx_GameSoundtrackNew.Checked ? "Yes" : "No");
            sel += "\", Is_Midi = \"" + (chbx_MidiNew.Checked ? "Yes" : "No");
            sel += "\", Is_AmateurCover= \"" + (chbx_AmateurCoverNew.Checked ? "Yes" : "No");
            sel += "\", Is_Instrumental = \"" + (chbx_InstrumentalNew.Checked ? "Yes" : "No");
            sel += "\", Is_Demo = \"" + (chbx_DemoNew.Checked ? "Yes" : "No");
            sel += "\", Is_Remix = \"" + (chbx_RemixNew.Checked ? "Yes" : "No");
            sel += "\", Is_Cover = \"" + (chbx_CoverNew.Checked ? "Yes" : "No");
            sel += "\", Has_Featuring = \"" + (chbx_FeaturingNew.Checked ? "Yes" : "No");
            ...
            sel += "\", Is_Medley = \"" + (chbx_MedleyNew.Checked ? "Yes" : "No");
            sel += "\", Is_MetalCover = \"" + (chbx_MetalNew.Checked ? "Yes" : "No");
            sel += "\", Is_Ukulele = \"" + (chbx_UkuleleNew.Checked ? "Yes" : "No");
            sel += "\", Is_MultiStrings = \"" + (chbx_MultiStringsNew.Checked ? "Yes" : "No");
        ...
        public void ExistingChanged(object sender, EventArgs e)
        {
            ...
            {
                lbl_LenghtExisting.ForeColor = lbl_diffCount.ForeColor;
            }
            else
            {
        ...
        private void btn_DecompressAll_Click(object sender, EventArgs e)
        {
            ...
            MainDB frm = new MainDB(cnb, cnc, false);//.Replace("\\AccessDB.accdb;", "")
            frm.Show();
        }
        ...
        private void btn_RemoveOldNew_Click(object sender, EventArgs e)
        {
            ...
            if (txt_DescriptionExisting.Text.Contains("Same")) txt_DescriptionExisting.Text = "";
            if (txt_DescriptionNew.Text.Contains("Same")) txt_DescriptionNew.Text = "";
        }
        ...
        private void btn_PlayPreview_Click(object sender, EventArgs e)
        {
            ...
            startInfo.Arguments = System.String.Format(" -p \"{0}\"",
                                                t);
        ...
        private void btn_PlayAudio_Click(object sender, EventArgs e)
        {
            ...
            startInfo.Arguments = System.String.Format(" -p \"{0}\"", t);
            startInfo.UseShellExecute = true; startInfo.CreateNoWindow = true; //startInfo.RedirectStandardOutput = true; startInfo.RedirectStandardError = true;
        ...
        private void btn_WM_Lead(string xml_inst)
        {
            ...
            if (!File.Exists(xx)) { ErrorWindow frm1 = new ErrorWindow("Install WinMerge if you want to use it.", ConfigRepository.Instance()["dlcm_WinMerge_www"], "Missing WinMerge", false, false, true, "", "", "", false); frm1.ShowDialog(); return; }

            var startInfo = new ProcessStartInfo();
            startInfo.FileName = xx;
            startInfo.WorkingDirectory = AppWD.Replace("external_tools", "");// Path.GetDirectoryName();
            startInfo.Arguments = System.String.Format(xml_inst);
        ...
        {
            ErrorWindow frm1 = new ErrorWindow(this.allothers, "", "List of all other Duplicates being assessed (# + Original_FileName + Artist + Album " +
                "+ Song_Title + Author + Version + Duplicate_Of_ID)", false, false, true, "", "", "", false);
            frm1.ShowDialog();
        }
        ...
        {
            StartProcesss(@unpackedDir, null);
        ...
        {
            Standardization frm = new Standardization(c("dlcm_DBFolder"), c("dlcm_TempPath"), c("dlcm_RocksmithDLCPath"), c("dlcm_AdditionalManipul39").ToLower() == "yes" ? true : false, c("dlcm_AdditionalManipul40").ToLower() == "yes" ? true : false, cnb, txt_ArtistNew.Text, cnc);
            frm.Show();
        }
        ...
        private void lbl_Covers_Click(object sender, EventArgs e)
        {

        }

        private void lbl_Atention_Click(object sender, EventArgs e)
        {
        ...
        {
            txt_TitleNew.Text = txt_TitleNew.Text.Replace("(", "[").Replace(")", "]");
            txt_TitleExisting.Text = txt_TitleExisting.Text.Replace("(", "[").Replace(")", "]");
        }

        private void btn_OpenExistingFolder_Click(object sender, EventArgs e)
        {
            string filePath = eXisting.Folder_Name;
            StartProcesss(filePath, null);
        }

        private void btn_OpenNewFolder_Click(object sender, EventArgs e)
        {
            string filePath = Path.GetDirectoryName(dataNew.AlbumArtPath).Replace("gfxassets\\album_art", "");
            StartProcesss(filePath, null);
        }

        private void chbx_CapoExisting_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void bt_AddP5_Click(object sender, EventArgs e)
        {
        ...
        private void btn_AddStandard_Click(object sender, EventArgs e)
        {
            ...
            if (chbx_UkuleleNew.Checked != chbx_UkuleleExisting.Checked || chbx_DemoNew.Checked != chbx_DemoExisting.Checked ||
                chbx_InstrumentalNew.Checked != chbx_InstrumentalExisting.Checked || chbx_SingleNew.Checked != chbx_SingleExisting.Checked) bt_AddP1_Click(null, null);
            if (chbx_AmateurCoverNew.Checked != chbx_AmateurCoverExisting.Checked || chbx_FeaturingNew.Checked != chbx_FeaturingExisting.Checked ||
                chbx_RemixNew.Checked != chbx_RemixExisting.Checked || chbx_FullAlbumNew.Checked != chbx_FullAlbumExisting.Checked ||
                chbx_AcousticNew.Checked != chbx_AcousticExisting.Checked) bt_AddP2_Click(null, null);
            if (chbx_MetalNew.Checked != chbx_MetalExisting.Checked || chbx_MedleyNew.Checked != chbx_MedleyExisting.Checked ||
