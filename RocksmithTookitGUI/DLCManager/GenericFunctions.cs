...
namespace RocksmithToolkitGUI.DLCManager
{
    class GenericFunctions
    {
        ...
        public static void dbmissingHandle(string ex)
        {
            ...
            //DateTime zipdate2 = new DateTime(1900, 1, 1); var fil2 = ""; long fill2 = 0;
            //DateTime zipdate3 = new DateTime(1900, 1, 1); var fil3 = ""; long fill3 = 0;
            //DateTime zipdate0 = new DateTime(1900, 1, 1); var fil0 = ""; long fill0 = 0;
            if (!File.Exists(ConfigRepository.Instance()["dlcm_DBFolder"]))
            {
                ...
                if (File.Exists(AppWD + "\\AccessDB.accdb"))
                {
                    ...
                    try
                    {
                        ...
                        //getlastbackups
                        if (Directory.Exists(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\0_temp"))
                        {
                            //c("dlcm_DBFolder")) + "\\0_temp"
                            System.IO.DirectoryInfo downloadedMessageInfo2 = new DirectoryInfo(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\0_temp");
                        ...
                        UpdateLog(DateTime.Now, "Finished processing " + System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\0_temp searching for backups"
                        ...
                        result1 = System.Windows.Forms.MessageBox.Show("DB file not found: " + ConfigRepository.Instance()["dlcm_DBFolder"] + "!" +
                            "\n\n(Yes) 1. Do you want to restore last Saved/Backed-up DBsinto target folder? \n" + (fil is null ? "missing " + c("dlcm_0_temp") + "\\0_temp\\" + "backup " : fil)
                            + "\nGZ archive date: " + zipdate + ",size:" + fill +
                            "\n\n(No) 2. " + (!Directory.Exists(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder"))) ? "Create path:" : "") + " Copy template DBs (" +
                            "\nAccessDB " + ct1 + " " + sz1 + ";\nSQLLiteDB " + ct2 + " " + sz2 + ")\nto: " + System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) +
                            "\n\n(Cancel) 3. will reference to the DB Template in Program folder: " + AppWD
                ...
                if (result1 == DialogResult.Yes)
                {
                    ...
                    unzipdb(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")), fil);//unzip
                ...
                else if (result1 == DialogResult.No)
                {
                    ...
                    if (!Directory.Exists(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder"))))
                        try
                        {
                            Directory.CreateDirectory(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")));
                        }
                        catch (Exception ezx)
                        {
                            var tsst = "Error at path create..." + ezx; UpdateLog(DateTime.Now, tsst, false, ConfigRepository.Instance()["dlcm_TempPath"], "", "", null, null);
                        }
                    if (!Directory.Exists(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")))) missing = true;
                    else
                    {
                        ...
                        //}
                        FileCopy(AppWD + "\\AccessDB.accdb", System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\AccessDB.accdb", true, 1, false);
                        FileCopy(AppWD + "\\SQLLiteDB.db", System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\SQLLiteDB.db", true, 1, false);
                        FileCopy(AppWD + "\\LinkDB.accdb", System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\LinkDB.accdb", true, 1, false);
                        missing = false;
                    }
                }
            ...
            "(s: AccessDB.accdb-restored(" + File.Exists(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\AccessDB.accdb") + ")," +
            "\nLinkDB.accdb-restored(" + File.Exists(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\LinkDB.accdb") + ")," +
            "\nSQLLiteDB.db-restored(" + File.Exists(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\SQLLiteDB.db") + "),)" +
        ...
        public static void BackupDB(bool zip)/*, System.Windows.Forms.Label lbl*/
        {
            ...
            if (!File.Exists(zipFile) && zip)
            {
                ...
                AddFileToZip(zipFile, System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\AccessDB.accdb");
                AddFileToZip(zipFile, System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\SQLLiteDB.db");
                AddFileToZip(zipFile, System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\LinkDB.accdb");
                ...
                var debug_path = "";
                if (File.Exists(AppWD + "\\..\\..\\..\\rocksmith-custom-song-toolkit\\RocksmithToolkitLib\\RocksmithToolkitLib.Config.xml")) debug_path = "\\..\\..\\rocksmith-custom-song-toolkit\\\\DLCManager\\external_tools\\";
                else debug_path = "\\..\\..\\..\\..\\..\\DLCManager\\external_tools\\";

                if (AppWD.Contains("\\Debug\\")) FileCopy(zipFile, AppWD + debug_path + "\\dbbackup.gz", true, 1, false);
                FileCopy(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\AccessDB.accdb", AppWD + "\\AccessDB.accdb", true, 1, false);
                FileCopy(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\SQLLiteDB.db", AppWD + "\\SQLLiteDB.db", true, 1, false);
                FileCopy(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\LinkDB.accdb", AppWD + "\\LinkDB.accdb", true, 1, false);
                if (AppWD.Contains("\\Debug\\")) FileCopy(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\AccessDB.accdb", AppWD + debug_path + "\\AccessDB.accdb", true, 1, false);
                if (AppWD.Contains("\\Debug\\")) FileCopy(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\SQLLiteDB.db", AppWD + debug_path + "\\SQLLiteDB.db", true, 1, false);
                if (AppWD.Contains("\\Debug\\")) FileCopy(System.IO.Path.GetDirectoryName(c("dlcm_DBFolder")) + "\\LinkDB.accdb", AppWD + debug_path + "\\LinkDB.accdb", true, 1, false);
        ...
        static public string GetExtraAttributes(string origFN, string noMFN, string gom, string SongDisplayName, string Album, string PackageAuthor, string Name, string Artist, string title)
        {
            ...
            var IsInstrumental = ""; var IsEP = ""; var IsUncensored = ""; var IsCensored = ""; var IsFullAlbum = ""; var IsRemastered = ""; var InTheWorks = "";
            ...
            var multxt = "No Guitar"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "(No Guitars)"; }
            multxt = "No Band"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "(No Guitars)"; }
            multxt = "No Band Audio"; Titl = Check4MultiT(SongDisplayName, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "(No Guitars)"; }
            multxt = "No Lead"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = multxt; }
            multxt = "Lead"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "Only Lead"; }
            multxt = "(Lead)"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "No Lead"; }
            multxt = "Lead Only"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "Only Lead"; }
            multxt = "Only Lead"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = multxt; }
            multxt = "Drums Only"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "Only Drums"; }
            multxt = "(No Drums No Vocal)"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "Only Drums"; }
            multxt = "Only Guitars"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = multxt; }
            multxt = "No Bass"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = multxt; }
            multxt = "(Bass)"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "No Bass"; }
            multxt = "No Bass Audio"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "No Bass"; }
            multxt = "Bass Only"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "Only Bass"; }
            multxt = "Only Bass"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = multxt; }
            multxt = "No Rhythm"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = multxt; }
            multxt = "Only Rhythm"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = multxt; }
            multxt = "Rhythm Only"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "Only Rhythm"; }
            multxt = "(Only BackTrack)"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = multxt; }
            multxt = "(Only Back Track)"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = multxt; }
            multxt = "backingtrack"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "(Only BackTrack)"; }
            multxt = "backing track"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "(Only BackTrack)"; }
            multxt = "backing audio only"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "(Only BackTrack)"; }
            multxt = "backing track"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "(Only BackTrack)"; }
            multxt = "backing only"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "(Only BackTrack)"; }
            multxt = "backtrack"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "(Only BackTrack)"; }
            multxt = "backing"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "(Only BackTrack)"; }
            multxt = "Only Band"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = "(Only BackTrack)"; }
            multxt = "No Vocal"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = multxt; }
            multxt = "FullBand"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = ""; }
            multxt = "(FullBand)"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { Is_MultiTrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; MultiTrack_Version = ""; }

            //detect minor types
            multibool = ConfigRepository.Instance()["dlcm_AdditionalManipul104"] == "Yes" ? true : false;
            multxt = "Instrumental"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsInstrumental = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "(Single)"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; SongDisplayName = Titl.Split(';')[0]; }/*gom = Titl.Split(';')[0];*/
            multxt = "(Single)"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; Album = Titl.Split(';')[0]; }
            multxt = "(Single-Edit)"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "CD Single"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "12 inch"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"12 inch"; }
            multxt = "Singles 12"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"12 inch"; }
            multxt = "\"12"; if (IsSingle != "Yes") Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"12 inch"; }
            multxt = "12\""; if (IsSingle != "Yes") Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"12 inch"; }
            multxt = "'12"; if (IsSingle != "Yes") Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"12 inch"; }
            multxt = "12'"; if (IsSingle != "Yes") Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"12 inch"; }
            multxt = "7 inch"; if (IsSingle != "Yes") Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"7 inch"; }
            multxt = "\" 7inch"; if (IsSingle != "Yes") Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"7 inch"; }
            multxt = "'7"; if (IsSingle != "Yes") Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"7 inch"; }
            multxt = "7'"; if (IsSingle != "Yes") Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"7 inch"; }
            multxt = "'7"; if (IsSingle != "Yes") Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"7 inch"; }
            multxt = "7'"; if (IsSingle != "Yes") Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; LiveDetails += " \"7 inch"; }
            multxt = "Single"; if (IsSingle != "Yes") Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSingle = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "(EP)"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsEP = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "(EP)"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsEP = "Yes"; Album = Titl.Split(';')[0]; }
            ...
            multxt = "The Original Soundtrack from the Motion Picture"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Soundtrack from the Netflix Film"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Music from the Motion Picture Soundtrack"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Original Television Soundtrack"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsTVTheme = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Original Soundtrack from the Motion Picture"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Original Soundtrack from the Motion Picture"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "from the Motion Picture"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsTVTheme = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Original Soundtrack"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "The Original Motion Picture Soundtrack"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Original Motion Picture Soundtrack"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "original motion picture score"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Original Motion Picture"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Original Game Soundtrack"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsGameSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Original Motion Picture"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "(movie ver.)"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            // multxt = "Original Motion Picture"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title);; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "The Original Movie Soundtrack"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "main title theme"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsTVTheme = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "main title theme"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsTVTheme = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "TV Theme"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsTVTheme = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "TV Theme"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsTVTheme = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Original Soundtrack Album"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Original Soundtrack"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Soundtrack"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Soundtrack"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; }
            if (Album.Length > 2) if (Album.ToLower().Contains(" ost") || Album.ToLower().Contains("(ost") || Album.ToLower().Substring(0, 2) == "ost") { multxt = "OST"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; Album = Titl.Split(';')[0]; } }
            if (SongDisplayName.ToLower().Contains(" ost") || SongDisplayName.ToLower().Contains("(ost")) { multxt = "OST"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; } }
            multxt = "Theme Reprise"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsTVTheme = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Theme Song"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsTVTheme = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Theme Song"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsTVTheme = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = " Theme"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsTVTheme = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = " Theme"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsTVTheme = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Uncensored"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsUncensored = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Censored"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsCensored = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Clean Version"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsCensored = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "FullAlbum"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsFullAlbum = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Full Album"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsFullAlbum = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Remastered Version"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemastered = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Remastered"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemastered = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Remastered"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsRemastered = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Remaster"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemastered = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Karaoke Version"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsKaraoke = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Karaoke"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsKaraoke = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "early Demo"; Titl = SongDisplayName.ToLower().Contains("demon") ? ";" : Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsDemo = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Demo"; Titl = SongDisplayName.ToLower().Contains("demon") ? ";" : Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsDemo = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Demo"; Titl = Album.ToLower().Contains("demon") ? ";" : Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsDemo = "Yes"; Album = Titl.Split(';')[0]; Album = Titl.Split(';')[0]; }
            multxt = "Extended Version"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; Album = Titl.Split(';')[0]; Album = Titl.Split(';')[0]; }
            multxt = "Extended Version"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Extended Remixed"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; Album = Titl.Split(';')[0]; Album = Titl.Split(';')[0]; }
            multxt = "Extended Remixed"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Extended Mix"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Extended Mix"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Remixed"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; Album = Titl.Split(';')[0]; Album = Titl.Split(';')[0]; }
            multxt = "Remixed"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Megamix"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Remix"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Remix"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Remix"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Remix"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Mix"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Mix"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "radio edit"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Single Edit"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Movie Edit"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "movie ver"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsSoundtrack = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Extended"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Edit"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsRemix = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Cover"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, false, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsCover = "Yes"; /*SongDisplayName = Titl.Split(';')[0];*/ }
            multxt = "Medley"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsMedley = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Medley"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMedley = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Deluxe Box Set"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsDeluxe = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Deluxe Edition"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsDeluxe = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Deluxe"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsDeluxe = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Deluxe"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsDeluxe = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "GreatestHits"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsGreatestHits = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "GreatestHits"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsGreatestHits = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Greatest Hits"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsGreatestHits = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "Best Of"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ; if ("Yes" == Titl.Split(';')[1]) { IsGreatestHits = "Yes"; Album = Titl.Split(';')[0]; }
            multxt = "midi"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMidi = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Ukulele"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsUkulele = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Metal Version"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMetalCover = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "MetalCover"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMetalCover = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Metal Cover"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMetalCover = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "MetalVersion"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMetalCover = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "Metal Version"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMetalCover = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "5 String"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMultiStrings = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "6 String"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMultiStrings = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "7 String"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMultiStrings = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "8 String"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMultiStrings = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            multxt = "9 String"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title); if ("Yes" == Titl.Split(';')[1]) { IsMultiStrings = "Yes"; SongDisplayName = Titl.Split(';')[0]; }
            ...
            //Detect Live
            multxt = "(Live)"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title);
            ...
            multxt = "Unplugged"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title);
            ...
            multxt = "Live"; Titl = Album.ToLower().Contains("alive") || Album.ToLower().Contains("silver") || Album.ToLower().Contains("lives") || Album.ToLower().Contains("delivered") ? ";" : Check4MultiT(origFN, Album, multxt, false, "Album", Artist, Album, title);
            ...
            multxt = "Unplugged"; Titl = Check4MultiT(origFN, Album, multxt, multibool, "Album", Artist, Album, title); ;
            ...
            //Detect Featuring
            multxt = "Feat."; Titl = Check4MultiT(origFN, SongDisplayName, multxt, false, "SongDisplayName", Artist, Album, title);
            ...
            multxt = "Ft."; Titl = Check4MultiT(origFN, SongDisplayName, multxt, false, "SongDisplayName", Artist, Album, title);
            ...
            multxt = "Featuring"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, false, "SongDisplayName", Artist, Album, title);
            ...
            multxt = "Feat."; Titl = Check4MultiT(origFN, Artist, multxt, false, "Artist", Artist, Album, title);
            if ("Yes" == Titl.Split(';')[1] && Titl.Split(';')[0].Length > 5)
            {
                HasFeaturing = "Yes"; Artist = (Artist.Replace(" Feat.", "[Ft.").Replace(" feat.", "[Ft.")).Replace("(Feat.", "[Ft.").Replace("(feat.", "[Ft.")
                      + "]"; LiveDetails += gom.IndexOf(multxt) <= gom.Length - 4 || gom.IndexOf(multxt) <= -1 ? "" : gom.Replace(gom.Substring(0, Artist.IndexOf(multxt) + 4), "");
            }

            multxt = "Ft."; Titl = Check4MultiT(origFN, Artist, multxt, false, "Artist", Artist, Album, title);
            if ("Yes" == Titl.Split(';')[1] && Titl.Split(';')[0].Length > 3)
            {
            ...
            multxt = "Featuring"; Titl = Check4MultiT(origFN, Artist, multxt, false, "Artist", Artist, Album, title);
            if ("Yes" == Titl.Split(';')[1] && Titl.Split(';')[0].Length > 9)
            {
            ...
            //Detect Acoustic
            multxt = "Acoustic Version"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title);
            ...
            multxt = "Acoustic"; Titl = Check4MultiT(origFN, SongDisplayName, multxt, multibool, "SongDisplayName", Artist, Album, title);
            if ("Yes" == Titl.Split(';')[1] && Titl.Split(';')[0].Length > 6) { IsAcoustic = "Yes"; SongDisplayName = Titl.Split(';')[0].TrimEnd().TrimStart().Replace(" ()", ""); LiveDetails += gom.IndexOf(multxt) <= gom.Length - 4 ? "" : gom.Replace(gom.Substring(0, SongDisplayName.IndexOf(multxt) + 4), ""); }
            ...
            return Is_MultiTrack + ";" + MultiTrack_Version + ";" + IsLive + ";" + LiveDetails + ";" + IsAcoustic + ";" + IsSingle + ";" + IsSoundtrack + ";" + IsInstrumental + ";" + IsEP + ";" + IsUncensored + ";" + IsFullAlbum + ";"
                ...
                + ";" + IsDeluxe + ";" + IsGreatestHits + ";" + IsMidi + ";" + IsGameSoundtrack + ";" + IsTVTheme + ";" + IsAmateurCover + ";" + IsMetalCover + ";" + IsUkulele + ";" + IsCensored
                /*+ ";" + SongDisplayName + ";" + Album */;
        }

        public static string Check4MultiT(string origFN, string noMFN, string text, bool multibool, string tag, string Artist, string Album, string title)
        {
                ...
                || noMFN.ToLower().IndexOf(text) >= 0 || noMFN.ToLower().IndexOf(text.Replace(" ", "")) >= 0 || noMFN.ToLower().IndexOf(text.Replace(" ", "_")) >= 0 || noMFN.ToLower().IndexOf(text.Replace(" ", "-")) >= 0)
            {
                ...
                var t = ReplaceTxt(aaa, noMFN, multibool, tag, Artist, Album, title);
                if (t == "")
                    return aaa + ";" + "No";
                else return t + ";" + ((FN != origFN || noMFN != ST) ? "Yes" : "No");
            }
            return ReplaceTxt(aaa, noMFN, multibool, tag, Artist, Album, title) + ";" + "No";
        }

        public static string ReplaceTxt(string orgstr, string replstr, bool ask4permission, string tag, string Artist, string Album, string title)
        {
            var a = orgstr;
            ...
            if (orgstr != replstr)
            {
                ...
                {
                    frm2 = new ErrorWindow(txt, "", "Attribute Gathering/Meta Cleanup for : " + " - " + Artist + " - " + Album + " - " + title, true, true, true, //ignore,stop,okey
                     "Get attribute and leave the meta info as is", "Ignore setting of any flag and don't run any clean-up action", "Get above(editable) New-attribute and clean the meta info of it", true);
                    frm2.ShowDialog();
                }

                replstr = c("dlcm_Global2TempVariable").Contains("New Meta info: ") ? (c("dlcm_Global2TempVariable").Substring(c("dlcm_Global2TempVariable").IndexOf("New Meta info: ") + 15)) : replstr;
                //if (a != c("dlcm_Global2TempVariable")) 
                //    ass = c("dlcm_Global2TempVariable").Replace("REplaced: " + orgstr + " with " + replstr, "").Replace(txt, "REplaced: " + orgstr + " with " + replstr);
                //ConfigRepository.Instance()["dlcm_Global2TempVariable"] = ass;
                if (frm2 is null) a = replstr;
                else if (frm2.B2) return "";
                else if (frm2.B1) return a;
                else return replstr;
            }
            //ConfigRepository.Instance()["dlcm_Global2TempVariable"] = ass;
            return a;
        ...
        public static void CreatePackingGroup(string cmd, OleDbConnection cnb, string filter, int norows, SQLite.SQLiteConnection cnc, string format)
        {
            ...
            DeleteFromDB("Groups", "DELETE * FROM Groups WHERE Type = \"DLC\" AND Groupz like \"Packing-%\"", cnb, cnc);

            string[] sp = format.Replace("\"", "").Split(',');
            for (var i = 0; i < sp.Length; i++)
            {
                string insertcmd; insertcmd = "CDLC_ID, Groupz, Type, Comments, Date_Added ";
                var insertvalues = cmd.Replace("*", "ID, \"Packing-" + sp[i] + "\", \"DLC\", \"89\",\"" + DateTime.Now.ToString("yyyyMMdd HHmmssfff") + "\"") + ";";
                InsertIntoDBwValues("Groups", insertcmd, insertvalues, cnb, 0, cnc);
            }

            timestamp = UpdateLog(DateTime.Now, "Adding All to be packet to a Packing group" + norows, true, null, null, "", null, null);
        }
        ...
        public static string GetFilter(string Filtertxt, string SearchCmd, int i, string Searchcmdf, OleDbConnection cnb, string Group, string chbx_Format, string Import_Date, SQLite.SQLiteConnection cnc)
        {
            ...
            switch (true)
            {
                case true when Filtertxt == "No Tunning Frecvency":
                    SearchCmd += "A440TunningFrecv = \"\"";
                    break;
                ...
                case true when Filtertxt == "No Author":
                    ...
                    break;
                case true when Filtertxt.Contains("by Author: "):
                    SearchCmd += "Author =\"" + Filtertxt.Replace("by Author: ", "").Trim() + "\"";
                    break;
                ...
                case true when Filtertxt == "Uncensored":
                    ...
                    break;
                case true when Filtertxt == "Censored":
                    SearchCmd += "Is_Censored = \"Yes\"";
                    break;
                case true when Filtertxt == "Has Acoustic":
                    SearchCmd += "Has_Acoustic = \"Yes\"";
                    break;
                case true when Filtertxt == "ProductionReady":
                    SearchCmd += "ProductionReady = \"Yes\"";
                    break;
                case true when Filtertxt == "ProductionNOTReady":
                    SearchCmd += "ProductionReady = \"No\"";
                    break;
                ...
                case true when Filtertxt == "Medley":
                    ...
                    break;
                case true when Filtertxt == "Slide":
                    SearchCmd += "Has_Slide = \"Yes\"";
                    break;
                case true when Filtertxt == "Alternate Track":
                    SearchCmd += "Has_Alternate_Track = \"Yes\"";
                    break;
                case true when Filtertxt == "Pack Batch Blank":
                    SearchCmd += "Split4Pack <> \"\" or Split4Pack is not null";
                    break;
                case true when Filtertxt == "Packing":
                    var SearchCmd19 = "SELECT DISTINCT VAL(CDLC_ID) FROM Groups WHERE Type=\"DLC\" AND Groupz like \"%Packing%\"";
                ...
                case true when Filtertxt == "With Bonus":
                    ...
                    break;
                case true when Filtertxt == "with Alternate Track":
                    SearchCmd += "Has_Alternate_Track = \"Yes\"";
                    break;
                case true when Filtertxt == "AI Tracks Available":
                    SearchCmd += "AI_TrackAvail = \"Yes\"";
                    break;
                ...
                case true when Filtertxt == "Imported as PS3":
                    ...
                    break;
                case true when Filtertxt == "Imported as PS4":
                ...
                case true when Filtertxt == "Packed as PS3"://DLCID diff than Default
                    ...
                    break;
                case true when Filtertxt == "Packed as PS4"://DLCID diff than Default
                    SearchCmd += "ID IN (SELECT CDLC_ID FROM Pack_AuditTrail p WHERE u.ID=p.CDLC_ID AND Platform=\"PS4\" AND instr(replace(ucase(PackPath),\",\",\",\"),\"PS4\") >0)";
                    break;
                ...
                case true when Filtertxt == "In the Works":
                    //DataSet dgc = new DataSet(); dgc = SelectFromDB("Main", "SELECT m.ID FROM Main AS m WHERE IntheWorks = \"Yes\"", "", cnb, cnc);
                ...
                case true when Filtertxt == "No Arrangements":
                    ...
                    break;
                case true when Filtertxt == "No Arrangements in Main DB":
                    var SearchCmdb2 = "SELECT Main.ID" +
                                        " FROM Main " +
                                        " WHERE Has_Bass='No' and Has_Lead='No' and Has_Rhythm='No' and Has_Combo='No' aND Has_Vocals='No';";
                    DataSet dj = new DataSet(); dj = SelectFromDB("Main", SearchCmdb2, "", cnb, cnc);
                    var noOfRj = GetNoRec(dj, cnb, cnc);
                    SearchCmdb2 = SearchCmdb2.Replace(", )", ")");

                    var idg = "";
                    for (var ii = 0; ii < noOfRj; ii++)
                        idg += dj.Tables[0].Rows[ii].ItemArray[0].ToString() + ",";
                    idg += ";"; idg = idg.Replace(", ;", ";");
                    if (!idg.Contains(",")) idg = "0";
                    SearchCmd += "ID IN (" + idg + ")";
                    break;
                ...
                case true when Filtertxt.Length > 12:
                    if (Filtertxt.Substring(0, 12) == "MultiSelect[")
                    {
                        ...
                        for (var b = 0; b < grp.Length; b++)
                        {
                            ...
                            SCmd = SCmd.Replace(") OR ID)", ")");
                        }
                        SearchCmd = SCmd.Substring(0, SCmd.Length - 17);
                        SearchCmd = SearchCmd.Substring(0, SearchCmd.Length - 1) + ")";
                        SearchCmd = SearchCmd.Contains(")") && !SearchCmd.Contains("(") ? SearchCmd.Replace(")", "") : SearchCmd;
                        SearchCmd = "SELECT ID FROM Main u WHERE ID in (" + GetSelectIDs(SearchCmd.Replace(") OR ID)", ")"), cnb, cnc) + ")";
                        //var SearchCmd6 = ;SELECT * FROM Main u LEFT JOIN Groups AS m ON m.CDLC_ID = CSTR(u.ID) WHERE m.Groupz =  \"Zoe\"
                        //SearchCmd += "CSTR(u.ID) IN (" + "SELECT m.CDLC_ID FROM Groups AS m WHERE m.CDLC_ID = CSTR(u.ID) AND m.Groupz =  \"" + Filtertxt.Substring(6, Filtertxt.Length - 6).Trim() + "\"" + ")";
            ...
            if (norec > 0)
            {
                ...
                if (norecs > 0)
                    ...
                    for (int j = 0; j < norecs; j++)
                        ...
                        //    }
                        if (c(dsg.Tables[0].Rows[j].ItemArray[0].ToString()) != fnn)
                        {
            ...
            for (var j = 0; j <= noOfRezc - 1; j++)
            {
                ...
                else
                {
                    ...
                    catch (Exception Exx)
                    {
                        ...
                        var timestamp = UpdateLog(DateTime.Now, "Get Track w bonus and parts" + Exx.Message, true, ConfigRepository.Instance()["dlcm_TempPath"], "", "DLCManager", null, null);
                        continue;
                    }
                }
                ...
                B += GetArarngementType(RouteMask, Arrangement_Name, "B;L;R;C;V", "Bass");
                if (o == B + L + R + C) L += GetArarngementType(RouteMask, Arrangement_Name, "B;L;R;C;V", "Lead");
                if (o == B + L + R + C) R += GetArarngementType(RouteMask, Arrangement_Name, "B;L;R;C;V", "Rhythm");
                if (o == B + L + R + C) C += GetArarngementType(RouteMask, Arrangement_Name, "B;L;R;C;V", "Combo");

                if (Bonus.ToLower() == "true" && o != B + L + R + C)
                {
                    o = B + L + R + C;
                    if (o == B + L + R + C) B += GetArarngementType(RouteMask, Arrangement_Name, "b;b;b;b;b", "Bass");
                    if (o == B + L + R + C) L += GetArarngementType(RouteMask, Arrangement_Name, "b;b;b;b;b", "Lead");
                    if (o == B + L + R + C) R += GetArarngementType(RouteMask, Arrangement_Name, "b;b;b;b;b", "Rhythm");
                    if (o == B + L + R + C) C += GetArarngementType(RouteMask, Arrangement_Name, "b;b;b;b;b", "Combo");
                }

                if (Part is not null && Part != "" && o != B + L + R + C)
                    if (double.Parse(Part) == 2)
                    {
                        o = B + L + R + C;
                        if (o == B + L + R + C) B += GetArarngementType(RouteMask, Arrangement_Name, "a;a;a;a;a", "Bass");
                        if (o == B + L + R + C) L += GetArarngementType(RouteMask, Arrangement_Name, "a;a;a;a;a", "Lead");
                        if (o == B + L + R + C) R += GetArarngementType(RouteMask, Arrangement_Name, "a;a;a;a;a", "Rhythm");
                        if (o == B + L + R + C) C += GetArarngementType(RouteMask, Arrangement_Name, "a;a;a;a;a", "Combo");
                    }
            }
            var ret = L + B + R + C + V;
            return ret;
        ...
        public static string GetArarngementType(string RouteMask, string Arrangement_Name, string retur, string Instr)
        {
            var ret = "";
            if ((RouteMask == "Bass" || RouteMask == "4" || Arrangement_Name == "Bass" || Arrangement_Name == "3") && (Instr == "Bass" || Instr == "")) ret += retur.Split(';')[0];
            else if ((RouteMask == "Lead" || RouteMask == "1" || Arrangement_Name == "Lead" || Arrangement_Name == "2") && (Instr == "Lead" || Instr == "")) ret += retur.Split(';')[1];
            else if ((RouteMask == "Rhythm" || RouteMask == "3" || Arrangement_Name == "Rhythm" || Arrangement_Name == "4") && (Instr == "Rhythm" || Instr == "")) ret += retur.Split(';')[2];
            else if ((RouteMask == "Combo" || RouteMask == "2" || Arrangement_Name == "Combo") && (Instr == "Combo" || Instr == "")) ret += retur.Split(';')[3];/*|| Arrangement_Name == ""*/
            else if ((RouteMask == "Vocals" || RouteMask == "JVocals" || Arrangement_Name == "Vocals" || Arrangement_Name == "JVocals") && (Instr == "Voclas" || Instr == "")) ret += retur.Split(';')[4];/*|| Arrangement_Name == "2"*/
            return ret;
        }
                    ...
                    , string sep1, string sep2, bool beta, bool sort, bool arrangoff, SQLite.SQLiteConnection cnc)//, string always_grp, string grp)
        {
                ...
                if (curtext == ">")
                {
                    ...
                    switch (curelem)
                    {
                        ...
                        case "<DLCName>":
                            ...
                            break;
                        case "<Track No.>":
                            tzt = ((SongRecord[k].Track_No == "" || SongRecord[k].Track_No == "0" || SongRecord[k].Track_No == "00" || SongRecord[k].Track_No == "-1") ? "" : ("-" + SongRecord[k].Track_No));
                            break;
                        case "<Year>":
                        ...
                        case "<Duplicate>":
                            ...
                            break;
                        case "<Capo>":
                            tzt = SongRecord[k].Has_Capo == "Yes" ? "_Capo" : "";
                            break;
                        case "<Alternate Track>":
                            tzt = SongRecord[k].Has_Alternate_Track == "Yes" ? "_AltTrack" : "";
                            break;
                        case "<NonA440>":
                            tzt = SongRecord[k].A440TunningFrecv == "Yes" || SongRecord[k].A440TunningFrecv == "" ? "" : "_NotA440";//_A440
                            break;
                        case "<A440/NonA440>":
                            tzt = SongRecord[k].A440TunningFrecv == "Yes" || SongRecord[k].A440TunningFrecv == "" ? "_A440" : "_NotA440";//_
                            break;
                        case "<CF Author>":
                            tzt = "customforge auth_" + SongRecord[k].CF_Author;
                            break;
                        case "<Based on RB>":
                            tzt = "rockband source_" + SongRecord[k].BasedOn_RB;
                            break;
                        case "<Based on CF>":
                            tzt = "customforge source_" + SongRecord[k].BasedOn_CF;
                            break;
                        case "<Based on GP>":
                            tzt = "tabs files_" + SongRecord[k].BasedOn_GP;
                            break;
                        case "<Based on Tabs>":
                            tzt = "tabs source_" + SongRecord[k].BasedOn_Tabs;
                            break;
                        case "<Based on Youtube>":
                            tzt = "youtube source_" + SongRecord[k].BasedOn_Youtube;
                            break;
                        case "<Has Official>":
                        ...
                        //    break;
                        case "<Description>":
                            tzt = (SongRecord[k].Description == "" ? "" : "Notes: " + getfirst30(SongRecord[k].Description)) +
                                (SongRecord[k].Live_Details == "" ? "" : "-Details:" + getfirst30(SongRecord[k].Live_Details)) +
                                (SongRecord[k].ToDos == "" ? "" : "-todos:" + getfirst30(SongRecord[k].ToDos)) +
                                (SongRecord[k].ToneDetails == "" ? "" : "-ToneDetails:" + getfirst30(SongRecord[k].ToneDetails)) +
                            (SongRecord[k].FilesMissingIssues == "" ? "" : "-FilesMissingIssues:" + getfirst30(SongRecord[k].FilesMissingIssues));
                            break;
                        case "<Tuning>":
                        ...
                        case "<Multi Track Details>":
                            tzt = SongRecord[k].MultiTrack_Version == "" ? "" : (SongRecord[k].AI_TrackAvail == "Yes" ? "-MultiTrack by AI " : "-MultiTrack ") +
                                 SongRecord[k].MultiTrack_Version;
                            break;
                        case "<Multi Track>":
                            tzt = SongRecord[k].MultiTrack_Version == "" ? "" : SongRecord[k].MultiTrack_Version;
                            break;
                        case "<Live Details>":
                        ...
                        case "<Attributes extended>":
                            ...
                            if (SongRecord[0].Has_Other_Officials == "Yes") tzt += Manipulate_strings("<Official>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            ...
                            if (SongRecord[0].Is_Original == "Yes") tzt += Manipulate_strings("<Has Official>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<Capo>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<Deluxe>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<A440/NonA440>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<Alternate Track>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<MetalCover>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<Ukulele>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<Slide>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<Has/Is_Alternate>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            ...
                            tzt += Manipulate_strings("<NonA440>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<Censored>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<Has_Acoustic>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<NOTProductionReady>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<AI Tracks Available>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt = tzt == "" || tzt == "__" ? "" : "Attributes & Extras: " + tzt;
                            break;
                        case "<Attributes>":
                            tzt += Manipulate_strings("<Bonus>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            tzt += Manipulate_strings("<Live>", 0, false, false, bassRemoved, SongRecord, "[", "]", beta, false, false, cnc);
                            ...
                            break;
                        case "<Group>":
                            tzt = SongRecord[k].Groups.Replace("Group ", "");
                            break;
                        case "<Groups>":
                            DataSet dvs = new DataSet(); dvs = SelectFromDB("Group", "SELECT DISTINCT(Groupz) FROM Groups WHERE CDLC_ID=\"" + SongRecord[k].ID + "\" AND Type=\"DLC\" AND Groupz not like '%Packing%' ORDER BY Groupz", "", cnb, cnc);//,Comments ,Comments
                            ...
                            break;
                        case "<GroupIndex>":
                            DataSet dbs = new DataSet(); dbs = SelectFromDB("Groups", "SELECT TOP 1 Comments,Groupz FROM Groups WHERE Type=\"DLC\" AND Groupz=\"" + SongRecord[k].Groups.Replace("Group ", "")
                                + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360'" +
                                "" + (c("dlcm_AdditionalManipul126") == "Yes" ? ",'Default'" : "") + ") ORDER BY Comments,Groupz", "", cnb, cnc);
                            var noOfRehc = GetNoRec(dbs, cnb, cnc);//dbs.Tables.Count > 0 ? dbs.Tables[0].Rows.Count : 0;
                            if (noOfRehc > 0) tzt = dbs.Tables[0].Rows[0].ItemArray[0].ToString().Replace("Group ", "");
                            break;
                        case "<GroupIndexAndName>":
                            DataSet dös = new DataSet(); dös = SelectFromDB("Groups", "SELECT TOP 1 Groupz, Comments FROM Groups WHERE Type=\"DLC\" AND Groupz=\"" + SongRecord[k].Groups.Replace("Group ", "")
                                + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360'"
                                + (c("dlcm_AdditionalManipul126") == "Yes" ? ",'Default'" : "") + ")  ORDER BY Comments,Groupz", "", cnb, cnc);
                            var noOfRehq = GetNoRec(dös, cnb, cnc);//dqs.Tables.Count > 0 ? dqs.Tables[0].Rows.Count : 0;
                            if (noOfRehq > 0) tzt = dös.Tables[0].Rows[0].ItemArray[1].ToString() + dös.Tables[0].Rows[0].ItemArray[0].ToString().Replace("Group ", "");
                            break;
                        case "<GroupIndexAddedDateAndName>":
                            DataSet dàs = new DataSet(); dàs = SelectFromDB("Groups", "SELECT TOP 1 Date_Added FROM Groups WHERE Type=\"DLC\" AND CDLC_ID=\"" + SongRecord[k].ID
                                 + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360'"
                                 + (c("dlcm_AdditionalManipul126") == "Yes" ? ",'Default'" : "") + ") ORDER BY Comments,Groupz", "", cnb, cnc);

                            DataSet dés = new DataSet(); dés = SelectFromDB("Groups", "SELECT TOP 1 Groupz, Comments FROM Groups WHERE Type=\"DLC\" AND Groupz=\"" + SongRecord[k].Groups.Replace("Group ", "")
                                + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360'"
                                + (c("dlcm_AdditionalManipul126") == "Yes" ? ",'Default'" : "") + ")  ORDER BY Comments,Groupz", "", cnb, cnc);
                            var noOfRe = GetNoRec(dés, cnb, cnc);//dqs.Tables.Count > 0 ? dqs.Tables[0].Rows.Count : 0;
                            if (noOfRe > 0) tzt = dés.Tables[0].Rows[0].ItemArray[1].ToString()
                                    + dés.Tables[0].Rows[0].ItemArray[0].ToString().Replace("Group ", "") + dàs.Tables[0].Rows[0].ItemArray[0].ToString();
                            break;
                        case "<GroupIndexAddedDateIndexDescAndName>":
                            var da = getDataAddedIndexDescNo(SongRecord[k].ID, SongRecord[k].Groups.Replace("Group ", ""), true, cnb, cnc);

                            DataSet dms = new DataSet(); dés = SelectFromDB("Groups", "SELECT TOP 1 Groupz, Comments FROM Groups WHERE Type=\"DLC\" AND Groupz=\"" + SongRecord[k].Groups.Replace("Group ", "")
                                + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360'"
                                + (c("dlcm_AdditionalManipul126") == "Yes" ? ",'Default'" : "") + ")  ORDER BY Comments,Groupz", "", cnb, cnc);
                            var noOfR = GetNoRec(dés, cnb, cnc);//dqs.Tables.Count > 0 ? dqs.Tables[0].Rows.Count : 0;
                            if (noOfR > 0) tzt = dés.Tables[0].Rows[0].ItemArray[1].ToString() + dés.Tables[0].Rows[0].ItemArray[0].ToString().Replace("Group ", "") + da;
                            break;
                        case "<FirstGroupIndexAddedDateIndexDescAndName>":
                            var df = getDataAddedIndexDescNo(SongRecord[k].ID, SongRecord[k].Groups.Replace("Group ", ""), true, cnb, cnc);

                            DataSet djs = new DataSet(); djs = SelectFromDB("Groups", "SELECT TOP 1 Groupz, Comments,Date_Added FROM Groups WHERE Type=\"DLC\" AND CDLC_ID=\"" + SongRecord[k].ID
                                + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360'"
                                + (c("dlcm_AdditionalManipul126") == "Yes" ? ",'Default'" : "") + ")  ORDER BY Comments,Groupz", "", cnb, cnc);
                            var noOfRep = GetNoRec(djs, cnb, cnc);//dqs.Tables.Count > 0 ? dqs.Tables[0].Rows.Count : 0;
                            if (noOfRep > 0) tzt = djs.Tables[0].Rows[0].ItemArray[1].ToString() + djs.Tables[0].Rows[0].ItemArray[0].ToString().Replace("Group ", "") + df;
                            break;
                        case "<FirstGroupIndexAddedDateAndName>":
                            DataSet dzs = new DataSet(); dzs = SelectFromDB("Groups", "SELECT TOP 1 Groupz, Comments,Date_Added FROM Groups WHERE Type=\"DLC\" AND CDLC_ID=\"" + SongRecord[k].ID
                                + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360'"
                                + (c("dlcm_AdditionalManipul126") == "Yes" ? ",'Default'" : "") + ")  ORDER BY Comments,Groupz", "", cnb, cnc);
                            var noOfRp = GetNoRec(dzs, cnb, cnc);//dqs.Tables.Count > 0 ? dqs.Tables[0].Rows.Count : 0;
                            if (noOfRp > 0) tzt = dzs.Tables[0].Rows[0].ItemArray[1].ToString() + dzs.Tables[0].Rows[0].ItemArray[2].ToString()
                                    + dzs.Tables[0].Rows[0].ItemArray[0].ToString().Replace("Group ", "");
                            break;
                        case "<GroupAddedDate>":
                            DataSet dis = new DataSet(); dis = SelectFromDB("Groups", "SELECT TOP 1 Date_Added FROM Groups WHERE Type=\"DLC\" AND CDLC_ID=\"" + SongRecord[k].ID
                                + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360'" +
                                (c("dlcm_AdditionalManipul126") == "Yes" ? ", 'Default'" : "") + ") ORDER BY Comments", "", cnb, cnc);
                            var noOfRei = GetNoRec(dis, cnb, cnc); //dps.Tables.Count > 0 ? dps.Tables[0].Rows.Count : 0;
                            if (noOfRei > 0) tzt = dis.Tables[0].Rows[0].ItemArray[0].ToString();
                            break;
                        case "<FirstGroupIndexAndName>":
                            DataSet dps = new DataSet(); dps = SelectFromDB("Groups", "SELECT TOP 1 Comments,Groupz FROM Groups WHERE Type=\"DLC\" AND CDLC_ID=\"" + SongRecord[k].ID
                                + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360'" +
                                (c("dlcm_AdditionalManipul126") == "Yes" ? ", 'Default'" : "") + ") ORDER BY Comments", "", cnb, cnc);
                            var noOfRepq = GetNoRec(dps, cnb, cnc); //dps.Tables.Count > 0 ? dps.Tables[0].Rows.Count : 0;
                            if (noOfRepq > 0) tzt = dps.Tables[0].Rows[0].ItemArray[0].ToString() + dps.Tables[0].Rows[0].ItemArray[1].ToString().Replace("Group ", "");
                            break;
                        case "<BetaOrGroupIndex>":
                            DataSet dgs = new DataSet(); dgs = SelectFromDB("Groups", "SELECT TOP 1 Comments,Groupz FROM Groups WHERE Type=\"DLC\" AND Groupz=\"" + SongRecord[k].Groups.Replace("Group ", "")
                                + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360'" +
                                (c("dlcm_AdditionalManipul126") == "Yes" ? ", 'Default'" : "") + " ORDER BY Comments,Groupz", "", cnb, cnc);
                            var noOfRegc = GetNoRec(dgs, cnb, cnc);//dgs.Tables.Count > 0 ? dgs.Tables[0].Rows.Count : 0;
                            if (noOfRegc > 0)
                                tzt = dgs.Tables[0].Rows[0].ItemArray[0].ToString().Replace("Group ", "");
                            else
                            {
                                if (beta)
                                    fulltxt = "0" + fulltxt;
                        ...
                        case "<ProductionReady>":
                            tzt = ((SongRecord[k].ProductionReady == "Yes") ? "-ProductionReady " : (SongRecord[k].ProductionReady == "No" ? "-NOTProductionReady " : ""));
                            break;
                        case "<NOTProductionReady>":
                            tzt = ((SongRecord[k].ProductionReady == "No") ? "-NOTProductionReady " : "");
                            break;
                        case "<Censored>":
                            tzt = ((SongRecord[k].Is_Censored == "Yes") ? "-Censored " : "");
                            break;
                        case "<Has_Acoustic>":
                            tzt = ((SongRecord[k].Is_Censored == "Yes") ? "-HasAcoustic " : "");
                            break;
                        case "<SoundTrack>":
                        ...
                        case "<Ukulele>":
                            ...
                            break;
                        case "<Slide>":
                            tzt = ((SongRecord[k].Has_Slide == "Yes") ? "-Slide " : "");
                            break;
                        case "<Has/Is_Alternate>":
                            tzt = ((SongRecord[k].Duplicate_Of != SongRecord[k].ID) ? (SongRecord[k].Duplicate_Of == "0" ? "" : "-IsAlternateOf " + SongRecord[k].Duplicate_Of + " ") : "_" + SongRecord[k].ID + "-HasAlternates ");
                            break;
                        case "<Has/Is_Official>":
                            tzt = ((SongRecord[k].Is_Original == "Yes") ? "-IsOfficial " : ((SongRecord[k].Has_Other_Officials == "Yes" ? "_HasOfficial" : "")));
                            break;
                        case "<Official>":
                        ...
                        case "<Date>":
                            ...
                            break;
                        case "<AI Tracks Available>":
                            tzt = SongRecord[k].AI_TrackAvail == "Yes" ? "_HasAIsplitTracks" : "";
                            break;
                        case "<CapoFret>":
                        ...
                        case "<Bass Has DynamicDificulty>":
                            tzt = ((SongRecord[k].Bass_Has_DD == "No" || bassRemoved) && SongRecord[k].Has_DD == "Yes" && SongRecord[k].Has_Bass == "Yes" ? (fulltxt.Contains("noBDD") ? "" : "noBDD") : "");
                            break;
                        case "<Avail. Instr.>":
                        ...
                        case "<Avail. Tracks and ShortTimings&Bonus>":
                            ...
                            for (var j = 0; j <= noOfRecv - 1; j++)
                            {
                                ...
                                tzt += (Arrangement_Name == "2" || Arrangement_Name == "Combo" || RouteMask == "Combo" ? " C" + b + p + shortstart : "")
                                    + (RouteMask == "Bass" ? " B" + b + p + shortstart : "") + (RouteMask == "Rhythm" ? " R" + b + p + shortstart :
                                    ((RouteMask == "None" && ArrangementType == "Vocal") ? " V" + b + p + shortstart : ((RouteMask == "Lead") ? " L" + p + shortstart : "")));
                            }
                            break;
                        case "<Avail. Tracks w Bonus&Alternates&Favorites>":
                            ...
                            for (var j = 0; j <= noOfRecm - 1; j++)
                            {
                                ...
                                tzt += (Arrangement_Name == "2" || Arrangement_Name == "Combo" || RouteMask == "Combo" ? "C" + b + a + f : "") + (RouteMask == "Bass" ? "B" + b + a + f : "") +
                        ...
                        case "<Avail. Tracks and ShortTimings&Bonus&Favorite>":
                            ...
                            for (var j = 0; j <= noOfRecq - 1; j++)
                            {
                                ...
                                tzt += (Arrangement_Name == "2" || Arrangement_Name == "Combo" || RouteMask == "Combo" ? " C" + b + a + f + shortstart : "") + (RouteMask == "Bass" ? " B" + b + a + f + shortstart : "") +
                        ...
                        case "<Avail. Tracks and ShortTimings>":
                            ...
                            for (var j = 0; j <= noOfRecS - 1; j++)
                            {
                                ...
                                tzt += (Arrangement_Name == "2" || RouteMask == "2" || RouteMask == "Combo" ? " C" + p + shorterstart : "") + (RouteMask == "Bass" ? " B" + p + shorterstart : "")
                        ...
                        default:
                            if ((origQAs) || (ifn))
                            {
                                ...
                                {
                                    case "<DD>":
                                        tzt = SongRecord[k].Has_DD == "Yes" ? (bassRemoved && SongRecord[k].Has_Guitar != "Yes" ? "noBDD" : (fulltxt.Contains("DD") ? "" : "DD")) : "noDD";
                                        break;
                                    case "<CDLC>":
                                    ...
                                    case "<Quality Assurance Attributes>":
                                        ...
                                        break;
                                    case "<Improvements Assurance Recommendations>":
                                        //- If other alternates have more Instruments/Vocals please indicate
                                        //- ?others songs same album diff years?
                                        //- ?no track no?
                                        //- ?no tones?
                                        //- ?no elongated lyrics?

                                        //8DataSet dsp = new DataSet(); dsp = SelectFromDB("Main", "SELECT Max(Part) FROM Arrangements WHERE CDLC_ID=" + SongRecord[k].ID + GetArrOfficSQLTxt(arrangoff), "", cnb, cnc);
                                        //var noOfRecPS = GetNoRec(dsp, cnb, cnc) > 0 ? (string.IsNullOrEmpty(dsp.Tables[0].Rows[0].ItemArray[0].ToString()) ? 0 : int.Parse(dsp.Tables[0].Rows[0].ItemArray[0].ToString())) : 0;
                                        var cmdf = "SELECT ID, Has_Bass, Has_Lead, Has_Rhythm, Has_Combo, Has_Vocals FROM Main WHERE ID=" + (SongRecord[k].Duplicate_Of == "" ? "12345678" : SongRecord[k].Duplicate_Of);    //\" + "\""   (== "0" ? SongRecord[k].ID : SongRecord[k].Duplicate_Of) +                                 DataSet drs = new DataSet(); drs = SelectFromDB("Main",cmdf                                            , "", cnb, cnc);
                                        DataSet drs = new DataSet(); drs = SelectFromDB("Main", cmdf, "", cnb, cnc);
                                        var noOfRecZ = GetNoRec(drs, cnb, cnc);//if (SongRecord[k].Duplicate_Of != "0") dss.Tables[0].Rows.Count;+ " AND Duplicate_Of<>"
                                        var ip = "";
                                        for (var j = 0; j <= noOfRecZ - 1; j++)
                                        {
                                            var improv = "";
                                            var ID = drs.Tables[0].Rows[j].ItemArray[0].ToString();
                                            var Has_Bass = drs.Tables[0].Rows[j].ItemArray[1].ToString().ToLower();
                                            var Has_Lead = drs.Tables[0].Rows[j].ItemArray[2].ToString().ToLower();
                                            var Has_Rhythm = drs.Tables[0].Rows[j].ItemArray[3].ToString().ToLower();
                                            var Has_Combo = drs.Tables[0].Rows[j].ItemArray[4].ToString().ToLower();
                                            var Has_Vocals = drs.Tables[0].Rows[j].ItemArray[5].ToString().ToLower();
                                            if (Has_Lead != "" && Has_Lead != "no") if (SongRecord[k].Has_Lead.ToLower() != Has_Lead) improv += " has Lead,";
                                            if (Has_Bass != "no" && Has_Bass != "no") if (SongRecord[k].Has_Bass.ToLower() != Has_Bass) improv += " has Bass,";
                                            if (Has_Rhythm != "" && Has_Rhythm != "no") if (SongRecord[k].Has_Rhythm.ToLower() != Has_Rhythm) improv += " has Ryhthm,";
                                            if (Has_Combo != "" && Has_Combo != "no") if (SongRecord[k].Has_Combo.ToLower() != Has_Combo) improv += " has Combo,";
                                            if (Has_Vocals != "" && Has_Vocals != "no") if (SongRecord[k].Has_Vocals.ToLower() != Has_Vocals) improv += " has Vocals,";
                                            if (improv != "") ip += ID + improv;
                                        }
                                        tzt = ip != "" ? "Suggested Improvements: " + ip : "";
                                        break;
            ...
            if ((sep1 + sep2).Length > 0) return (fulltxt.Trim()).Replace(sep1 + sep2, "").Replace(sep1 + " " + sep2, "").Replace(sep1 + "_", sep1)
                    .Replace("_" + sep2, sep2).Replace(sep1 + "-", sep1).Replace("-" + sep2, sep2).Replace(sep1 + " ", sep1).Replace(" " + sep2, sep2)
                    .Replace(sep1 + "_", sep1).Replace("_" + sep2, sep2).Replace(sep2 + "_", sep2).Replace("_" + sep1, sep1).Replace(" " + sep2, sep2).Replace(sep2 + sep1, " ").Replace("  ", " ").Trim();
            ...
            , string txt_Platform, bool arrangoff, float not_p, string Song_Lenght, string txt_DuplicateOf, string Folder_Name, string txt_Title)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Chose a Track first!", MESSAGEBOX_CAPTION, MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            else
            {
                try
                {
                    ...
                    {
                        System.Windows.MessageBox.Show("issues at reading xml..please press restore");
                        return;
                    }
                ...
                {
                    timestamp = UpdateLog(DateTime.Now, "Shift voval notes w issues: " + Exx.Message, true, ConfigRepository.Instance()["dlcm_TempPath"], "", "DLCManager", null, null);
                }
            ...
            if (cmb_Tracks is null ? false : cmb_Tracks.ToLower().IndexOf("vocal") >= 0)
            {
                ...
                if (txt_ID != DLCID)
                {
                    var insertcmdd = "Arrangement_Name, CDLC_ID, Bonus, JSONFilePath, XMLFilePath, XMLFile_Hash, ScrollSpeed, Tunning, Rating, PlaythroughYBLink, CustomsForge_Link," +
                        ...
                        "SNGFileHash, Has_Sections, Comments, Start_Time, CleanedXML_Hash, Json_Hash, Part, MaxDifficulty, Default, Primary, A440TunningFrecv, Alternate, Slide";
                    var insertvalues = "SELECT Arrangement_Name, " + txt_ID + ", Bonus, \"" + destination_dir + "\\manifests\\\"+right(JSONFilePath,len(JSONFilePath)-" +
                        ...
                        " Json_Hash, Part, MaxDifficulty, \"\", \"\", \"\", Alternate, \"\" FROM Arrangements WHERE ID = " + ArrangID;
                ...
                {
                    tsst = "Error ..." + ex.Message; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), "", "", null, null);
                }
                ...
                if (XMLFilePath != "")
                    ...
                    catch (Exception ex) { tsst = "Error ..." + ex.Message; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), "", "", null, null); }
            }
            else
            {
                DialogResult result11 = DialogResult.No;
                if (not_t.Split(';')[0] == "0") result11 = System.Windows.Forms.MessageBox.Show("You are trying to shift the Arrangements notes by 0 seconds (num_Lyrics is set to: " + num_Lyrics.ToString() + ")" +
                ...
                {
                    System.Windows.MessageBox.Show("Not yet implemented"); return;
                }

                var bonus = "bonus";
                if (cmb_Tracks is not null)
                    if (txt_ID != DLCID && cmb_Tracks.ToString() != "")
                    {
                        var cmd = "SELECT XMLFilePath, XMLFileName, RouteMask, Start_Time, JSONFilePath, SNGFileName, Arrangement_Name FROM Arrangements WHERE ID = " + ArrangID + " AND Bonus =\"True\" and RouteMask=\"" + dus.Tables[0].Rows[0].ItemArray[2].ToString() + "\"" + GetArrOfficSQLTxt(arrangoff);
                        ...
                        if (noOfRec > 0)
                        {
                            DialogResult result1 = System.Windows.Forms.MessageBox.Show("Normal Bonus track already existing. Not adding current proposed track. ", MESSAGEBOX_CAPTION,
                        ...
                        var insertcmdd = "Arrangement_Name, CDLC_ID, Bonus, JSONFilePath, XMLFilePath, XMLFile_Hash, ScrollSpeed, Tunning, Rating, PlaythroughYBLink, CustomsForge_Link," +
                            "ArrangementSort, TuningPitch, ToneBase, Idd, MasterId, ArrangementType, String0, String1, String2, String3, String4, String5, PluckedType, RouteMask," +
                            "XMLFileName, XMLFileLLID, XMLFileUUID, SNGFileName, SNGFileLLID, SNGFileUUID, ToneMultiplayer, ToneA, ToneB, ToneC, ToneD, ConversionDateTime," +
                            "SNGFileHash, Has_Sections, Comments, Start_Time, CleanedXML_Hash, Json_Hash, Part, MaxDifficulty, OrigSongTrack, PrimaryTrack, Favorite, Broken, Official, PersistentID, CapoFret, Alternate, A440TunningFrecv, Slide";
                        var insertvalues = "SELECT Arrangement_Name, " + txt_ID + ", Bonus, \"" + destination_dir + "\\manifests\\\"+right(JSONFilePath,len(JSONFilePath)-" +
                            ...
                            " String0, String1, String2, String3, String4, String5, PluckedType, RouteMask, XMLFileName, XMLFileLLID, XMLFileUUID, SNGFileName, SNGFileLLID," +
                            " SNGFileUUID, ToneMultiplayer, ToneA, ToneB, ToneC, ToneD, ConversionDateTime, SNGFileHash, Has_Sections, \"Added from " + DLCID + " " + txt_Title + "\", (Start_Time+" + s2s + "), CleanedXML_Hash," +
                            " Json_Hash, Part, MaxDifficulty, OrigSongTrack, PrimaryTrack, Favorite, Broken, Official, PersistentID, CapoFret, Alternate, A440TunningFrecv, Slide FROM Arrangements WHERE ID = " + ArrangID;

                        InsertIntoDBwValues("Arrangements", insertcmdd, insertvalues, cnb, 0, cnc);

                        var upd = "UPDATE Main SET " + dis.Tables[0].Rows[0].ItemArray[6].ToString() == "Bass" ? "Has_Bass" : (dis.Tables[0].Rows[0].ItemArray[6].ToString() == "Combo" ? "Has_Combo"
                            : (dis.Tables[0].Rows[0].ItemArray[6].ToString() == "Lead" ? "Has_Lead" : (dis.Tables[0].Rows[0].ItemArray[6].ToString() == "Rhythm" ? "Has_Rhythm"
                            : ((dis.Tables[0].Rows[0].ItemArray[6].ToString() == "Vocals" ? "Has_Vocals"
                            : (dis.Tables[0].Rows[0].ItemArray[6].ToString() == "3" ? "Has_Bass" : (dis.Tables[0].Rows[0].ItemArray[6].ToString() == "2" ? "Has_Combo"
                            : (dis.Tables[0].Rows[0].ItemArray[6].ToString() == "0" ? "Has_Lead" : (dis.Tables[0].Rows[0].ItemArray[6].ToString() == "1" ? "Has_Rhythm"
                            : ((dis.Tables[0].Rows[0].ItemArray[6].ToString() == "4" ? "Has_Vocals"
                            : ("")))))))))))) + "=\"Yes\", Description=\"" + dis.Tables[0].Rows[0].ItemArray[6].ToString() + " track, added from " + DLCID + " " + txt_Title + "\", (Start_Time+" + s2s + "),\"";
                        UpdateDB("Arrangements", upd, cnb, cnc);
                ...
                try
                {
                    ...
                    if (XMLFilePath != "")
                        if (not_t == "0")
                            ...
                            {
                                tsst = "Error shifting timings..." + ex.Message; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), "", "", null, null);
                            }
                        else // add variable diff to notes //shift notes
                            try
                            {
                                xmlContent = Song2014.LoadFromFile(newXMLFilePath);
                                ...
                                for (var j = 0; j < xmlContent.PhraseIterations.Length; j++)
                                    if (xmlContent.PhraseIterations[j].Time > 0)
                                        xmlContent.PhraseIterations[j].Time = calcreltime(xmlContent.PhraseIterations[j].Time, not_t, xmlContent.PhraseIterations[0].Time, false, XMLFilePath
                                            , (j > 0 ? xmlContent.PhraseIterations[j - 1].Time : 0), -1);
                                //for (var j = 0; j < xmlContent.Ebeats.Length; j++)
                                ...
                                for (var j = 0; j < xmlContent.Levels.Length; j++)
                                {
                                    if (not_t.Contains("p3"))
                                    {
                                        ...
                                        if (xmlContent.Levels[j].Notes.Length > 3000 || xmlContent.Levels[j].Chords.Length > 3000)
                                            System.Windows.MessageBox.Show("more than 3000 notes/chords: " + xmlContent.Levels[j].Notes.Length + "/" + xmlContent.Levels[j].Chords.Length);
                                        ...
                                        for (var k = 0; k < xmlContent.Levels[j].Chords.Length; k++) if (xmlContent.Levels[j].Chords[k].Time > 0)
                                        {
                                            ...
                                            sounds[xmlContent.Levels[j].Notes.Length + k, 3] = xmlContent.Levels[j].Chords[k].ChordNotes is null ? 0 : xmlContent.Levels[j].Chords[k].ChordNotes[0].Sustain;
                                        }
                                        ...
                                        for (var k = 0; k < len; k++)
                                        {
                                            ...
                                            {
                                                sounds[k, 0] = calcreltime(sounds[k, 0], not_t, sounds[0, 0], false, XMLFilePath, (k > 0 ? sounds[k - 1, 0] : 0), prev);
                                                sounds[k, 3] = calcreltime(sounds[k, 3], not_t, sounds[0, 0], false, XMLFilePath, (k > 0 ? sounds[k - 1, 3] : 0), prev);
                                            }
                                        }
                                        ...
                                        for (var k = 0; k < len; k++)
                                            ...
                                            else if (sounds[k, 1] == 1)
                                            {
                                                ...
                                                if (xmlContent.Levels[j].Chords[int.Parse(sounds[k, 2].ToString())].ChordNotes is not null)
                                        ...
                                        for (var k = 0; k < xmlContent.Levels[j].Chords.Length; k++)
                                            if (xmlContent.Levels[j].Chords[k].ChordNotes is not null)
                                                for (var m = 0; m < xmlContent.Levels[j].Chords[k].ChordNotes.Length; m++)
                                                {
                                                    xmlContent.Levels[j].Chords[k].ChordNotes[m].Time = xmlContent.Levels[j].Chords[k].Time;
                                        ...
                                        for (var k = 0; k < xmlContent.Levels[j].Notes.Length; k++)
                                            if (xmlContent.Levels[j].Notes[k].Time > 0)
                                            {
                                                xmlContent.Levels[j].Notes[k].Time = calcreltime(xmlContent.Levels[j].Notes[k].Time, not_t, xmlContent.Levels[j].Notes[0].Time, false, XMLFilePath
                                                    , (k > 0 ? xmlContent.Levels[j].Notes[k - 1].Time : 0), -1);
                                        ...
                                        for (var k = 0; k < xmlContent.Levels[j].Chords.Length; k++)
                                            if (xmlContent.Levels[j].Chords[k].Time > 0)
                                            {
                                                xmlContent.Levels[j].Chords[k].Time = calcreltime(xmlContent.Levels[j].Chords[k].Time, not_t, xmlContent.Levels[j].Chords[0].Time, false, XMLFilePath
                                                    , (k > 0 ? xmlContent.Levels[j].Chords[k - 1].Time : 0), -1);
                                                for (var m = 0; m < xmlContent.Levels[j].Chords[k].ChordNotes.Length; m++)
                                                    xmlContent.Levels[j].Chords[k].ChordNotes[m].Time = xmlContent.Levels[j].Chords[k].Time;
                                            }
                                    }
                                    ...
                                    for (var k = 0; k < xmlContent.Levels[j].Anchors.Length; k++)
                                        if (xmlContent.Levels[j].Anchors[k].Time > 0)
                                            xmlContent.Levels[j].Anchors[k].Time = calcreltime(xmlContent.Levels[j].Anchors[k].Time, not_t, xmlContent.Levels[j].Anchors[0].Time, false, XMLFilePath
                                                , (k > 0 ? xmlContent.Levels[j].Anchors[k - 1].Time : 0), -1);
                                        ...
                                        if (xmlContent.Levels[j].HandShapes[k].StartTime > 0)
                                            ...
                                            else
                                            {
                                                xmlContent.Levels[j].HandShapes[k].StartTime = calcreltime(xmlContent.Levels[j].HandShapes[k].StartTime, not_t, xmlContent.Levels[j].HandShapes[0].StartTime, true, XMLFilePath
                                                        , (j > 0 ? xmlContent.Levels[j].HandShapes[k - 1].StartTime : 0), -1);
                                                xmlContent.Levels[j].HandShapes[k].EndTime = calcreltime(xmlContent.Levels[j].HandShapes[k].EndTime, not_t, xmlContent.Levels[j].HandShapes[0].StartTime, true, XMLFilePath
                                                        , (j > 0 ? xmlContent.Levels[j].HandShapes[k - 1].EndTime : 0), -1);
                                            }
                    ...
                    if (cmb_Tracks is not null) if (cmb_Tracks.ToString() != "")
                    {
            ...
            if (tsst == "")
                System.Windows.MessageBox.Show((cmb_Tracks is null ? "" : (cmb_Tracks.ToString() != "" ? "" : "(Single)")) + "Track " + lwnght + " shifted by " +
                    (not_t.Contains(";") ? (not_t.Split(';')[0] + "%" + ", starting time: " + not_t.Split(';')[1] + ", end time: " + not_t.Split(';')[2] + ", last actual note: " + not_t.Split(';')[5])
                    : num_Lyrics));
            else
                if (dus.Tables.Count > 0) System.Windows.MessageBox.Show("Track " + dus.Tables[0].Rows[0].ItemArray[1].ToString() + " was NOT shifted by " + (not_t == "0" ? num_Lyrics :
                    (not_t.Contains(";") ? (not_t.Split(';')[0] + "%" + ", starting time: " + not_t.Split(';')[1] + ", end time: " + not_t.Split(';')[2] + ", last actual note: " + not_t.Split(';')[5]) : num_Lyrics))
                    + "\n\nDue to: " + tsst);
                else if (dus.Tables.Count > 0) System.Windows.MessageBox.Show("Issue at shifting notes!");

            not_t = "0";
            return;
        }

        public static float calcreltime(float iniv, string not_t, float startt, bool ignotetim, string xsml, float prev_new_note, float prev)
        {
            ...
            {
                float pn = float.Parse((Math.Round((ignotetim ? getprevapprox_note_or_cord(xsml, iniv) : prev), 3)).ToString()); //getprevnote_or_cord(xsml, iniv) replaced by prev
        ...
        public static double getprevnote_or_cord(string xsml, double t)
        {
            ...
            for (var j = 0; j < xmlContent.Levels.Length; j++)
            {
                for (var k = 0; k < xmlContent.Levels[j].Notes.Length; k++)
                {
                    note = xmlContent.Levels[j].Notes[k].Time;
                    if (xmlContent.Levels[j].Notes.Length <= k + 1)
                        if (xmlContent.Levels[j].Notes[k].Time == note) prev = note;
                }
        ...
        public static double getprevapprox_note_or_cord(string xsml, double t)
        {
            ...
            {
                for (var k = 0; k < xmlContent.Levels[j].Notes.Length; k++)
                    if (xmlContent.Levels[j].Notes[k].Time < note)
                        if (0 <= k - 1)
        ...
        public static string getDataAddedIndexDescNo(string idd, string Grp, bool desc, OleDbConnection cnb, SQLite.SQLiteConnection cnc)
        {
            var cmd = "SELECt " +
                //"number from (SELECT number FROM (SELECT ID,ROW_NUMBER() OVER (ORDER BY (SELECT 1)) AS number FROM Groups WHERE Type=\"DLC\" AND Groupz=\"" + Grp.Replace("Group ", "")
                //                 + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360'"
                //                 + (c("dlcm_AdditionalManipul126") == "Yes" ? ",'Default'" : "") + ") ORDER BY Date_Added DESC) WHERE AND CDLC_ID=\"" + id + "\")";
                "CDLC_ID FROM Groups WHERE Type=\"DLC\" AND Groupz=\"" + Grp.Replace("Group ", "") + "\" AND Groupz not in ('Packing-PS3','Packing-Mac','Packing-Pc','Packing-XBOX360','Default') ORDER BY Date_Added DESC";
            DataSet dzs = new DataSet(); dzs = SelectFromDB("Groups", cmd, "", cnb, cnc); //\"Hot (monthly)

            var noOfRep = GetNoRec(dzs, cnb, cnc);//dqs.Tables.Count > 0 ? dqs.Tables[0].Rows.Count : 0;
            var tzt = "";
            if (noOfRep > 0) for (var i = 0; i < noOfRep; i++)
                if (dzs.Tables[0].Rows[i].ItemArray[0].ToString() == idd)
                {
                    tzt = (i + 1).ToString(); break;
                }
            return tzt;
        }
        ...
        public static void DeleteRecords(string IDs, string cmd, string DBPath, string TempPath, string norows, string hash, OleDbConnection cnb, System.Windows.Forms.ProgressBar pB_ReadDLCs, SQLite.SQLiteConnection cnc)
        {
            //Delete records
            ...
            if (result1 == DialogResult.Yes)
            {
                ...
                // //Delete Tones_GearList
                DeleteFromDB("Tones_GearList", "DELETE * FROM Tones_GearList WHERE Tone_ID IN (SELECT ID FROM Tones WHERE CDLC_ID IN (" + IDs + "))", cnb, cnc);//sometimes tones have zer0 cdlc id
                // //Delete Tones_GearList
                DeleteFromDB("Tones_GearList", "DELETE * FROM Tones_GearList WHERE CDLC_ID IN (" + IDs + ")", cnb, cnc);
        ...
        public static string AddDD(string Folder_Name, string Is_Original, string xml, Platform platform, bool superOrg, bool InternalLog, string noLevels)
        {
            ...
            var c = string.Format(" -c \"{0}\"", System.IO.Path.GetFullPath("ddc\\ddc_default.xml"));
            startInfo.FileName = System.IO.Path.Combine(AppWD, "..\\..\\ddc", "ddc.exe");
            ...
            startInfo.Arguments = string.Format("\"{0}\" -l {1} -s {2} {3}{4}{5}",
                                                System.IO.Path.GetFileName(xml),
                                                4, "N", c,
                                                    " -p Y", " -t Y");
        ...
        public static string RemoveDD(string Folder_Name, string Is_Original, string xml, Platform platform, bool superOrg, bool InternalLog, string UseInternalLog)
        {
            ...
            try
            {
                ...
                var rampPath = System.IO.Path.Combine(AppWD.Replace("DLCManager\\external_tools", ""), "ddc\\ddc_dd_remover.xml");
                var cfgPath = System.IO.Path.Combine(AppWD.Replace("DLCManager\\external_tools", ""), "ddc\\ddc_default.cfg");
                ...
                {
                    var tsst = "Error at remove DD..." + ex.Message; UpdateLog(DateTime.Now, tsst, false, "", "", "", null, null);
                    UseInternalLog = "Yes";
                }
                ...
                if (Is_Original == "Yes" || !string.IsNullOrEmpty(consoleOutput) || UseInternalLog == "Yes")
                    ...
                    { //http://code.google.com/p/rocksmith-custom-song-creator/issues/detail?id=60
                        ...
                        if (xml.Length > 0)
                        {
                            ...
                            var diff = 0;
                            float[] timea = new float[20000]; //keeps the timestamp of each note
                            float[] timeb = new float[20000]; //keeps the timestamp of each anchor
                            string[] notes = new string[20000]; // keeps the full note details
                            string[] bends = new string[20000]; // keeps the bends single note details
                            string[] anchor = new string[20000]; // keeps the full note details
                            int[] lvla = new int[20000]; //keeps the level of the note&timestamp
                            string[] bnds = new string[20000]; //keeps the bends of the note&timestamp
                            int[] lvlb = new int[20000]; //keeps the level of the note&timestamp
                            ...
                            while ((line = fxml.ReadLine()) != null)
                            {
                                ...
                                if (line.Contains("<note time=\""))
                                {
                                    ...
                                    {
                                        var tsst = "Error11 ..." + ex.Message; UpdateLog(DateTime.Now, tsst, false, c("dlcm_TempPath"), "", "", null, null);
                                ...
                                if (line.Contains("<anchor time=\""))
                                {
                                    ...
                                    {
                                        var tsst = "Error12 ..." + ex.Message; UpdateLog(DateTime.Now, tsst, false, c("dlcm_TempPath"), "", "", null, null);
                    ...
                    {
                        var tsst = "Erro at Internal remove DD..." + ex + " " + xml; UpdateLog(DateTime.Now, tsst, false, "", "", "", null, null);
                    }
            }
            catch (Exception ex)
            {
                var tsst = "Erro at Load XML remove DD..." + ex.Message; UpdateLog(DateTime.Now, tsst, false, "", "", "", null, null);
            }
        ...
        public static void Downstream(string fn, float bitrate, string windw)
        {
            ...
            startInfo.FileName = System.IO.Path.Combine(AppWD, "oggdec.exe");
            ...
            if (File.Exists(t))
                using (var DDC = new Process())
                {
                    ...
                    if (DDC.ExitCode == 0)
                    {
                        ...
                        {
                            FileName = System.IO.Path.Combine(AppWD, "oggenc.exe"),
                            ...
                            using (var DDgC = new Process())
                            {
                                ...
                                if (DDgC.ExitCode == 0)
                                {
                                    ...
                                    do //sometimes it fails
                                    {
                                        ...
                                        catch (Exception ex) { var tsst = "Error13 ..." + ex.Message; UpdateLog(DateTime.Now, tsst, false, c("dlcm_TempPath"), "", "", null, null); }
                                        if (!File.Exists(t.Replace(".ogg", ".wem")) || fi.Length == 0)
                                        {
                                            ...
                                            if (i > 3)
                                            {
                                                ...
                                                var appRootDir = System.IO.Path.GetDirectoryName(System.Windows.Forms.Application.ExecutablePath);
                                                var templateDir = System.IO.Path.Combine(appRootDir, "Template");
                                ...
                                {
                                    var tsst = "Erro15 ..." + "Erro downsizingpreview" + DDgC.ExitCode + DDgC.StartInfo.FileName + DDgC.StartInfo.ErrorDialog + DDgC.StartInfo.Arguments; UpdateLog(DateTime.Now, tsst, false, c("dlcm_TempPath"), "", "", null, null);
                    ...
                    {
                        var tsst = "Erro16 ..." + "Erro downsizingpreview" + DDC.ExitCode + DDC.StartInfo.FileName + DDC.StartInfo.ErrorDialog + DDC.StartInfo.Arguments; UpdateLog(DateTime.Now, tsst, false, c("dlcm_TempPath"), "", "", null, null);
                        File.Copy(fn + ".old", fn, true);
                    }
                }
        ...
        public static bool checkaudiofilesifreadable(string audio)
        {
            ...
            else xx = System.IO.Path.Combine(AppWD, "MediaInfo_CLI_Windows_x64", "MediaInfo.exe");
        ...
        {
            Random randomp = new Random();
            if (e is not null) if (e.Result is not null) if (e.Result.ToString().ToLower() == "done") return;
            var packid = "";
            ...
            var frmt = ""; //used to set succesfully packed formats to remove their "Packing" grp (Groups table) entry
            ...
            try
            {
                ...
                string chbx_PS4 = args[43]; string txt_OldPath = args[44];
                string chbx_Format = (chbx_PC != "" ? "PC" : (chbx_PS3 != "" ? "PS3" : (chbx_XBOX != "" ? "XBOX360" : (chbx_Mac != "" ? "Mac" : (chbx_PS4 != "" ? "PS4" : "")))));
                timestamp = UpdateLog(timestamp, tsst, false, tmpPath, multithreadname, form, null, null);
                ...
                string dlcSavePath = "";
                string h = ""; DLCPackageData dataPs3 = new DLCPackageData(); DLCPackageData dataMac = null; DLCPackageData dataPc = null; DLCPackageData dataXbox360 = null; DLCPackageData dataPS4 = null;
                ...
                if (chbx_CopyOld && chbx_CopyOldEnabled)
                {
                    ...
                    else
                    {
                        ...
                        randomp = new Random();
                        var packageName = System.IO.Path.GetFileNameWithoutExtension(oldfilePath).StripPlatformEndName();
                        if (chbx_UniqueID) packageName += packid;
                        packageName = packageName.Replace(".", "_");
                        var targetFileName = string.Format(nameTemplate, System.IO.Path.Combine(System.IO.Path.GetDirectoryName(oldfilePath), packageName), TargetPlatform.GetPathName()[2]);
                        ...
                        h = TempPath + "\\0_repacked\\" + (chbx_Format == "PC" ? "PC" : (chbx_Format == "Mac" ? "MAC" : (chbx_Format == "PS3" ? "PS3" : (chbx_Format == "XBOX360" ? "XBOX360" : "PS4")))) + "\\"; //+ Path.GetFileNameWithoutExtension(Path.GetFileNameWithoutExtension(DataViewGrid.Rows[i].Cells["Original_FileName"].Value.ToString()));
                        h += System.IO.Path.GetFileNameWithoutExtension(targetFileName);
                        targetFileName = h;
                        // CONVERSION
                        ...
                        else
                        {
                            ...
                            {
                                // Replace AppId
                                var appIdFile = System.IO.Path.Combine(unpackedDir, "appid.appid");
                            ...
                            if (SourcePlatform.platform == GamePlatform.XBox360)
                                dirToPack = Directory.GetDirectories(System.IO.Path.Combine(unpackedDir, Packer.ROOT_XBOX360))[0];
                ...
                //select the last packed locally or the NAS stored one
                var cmdu = "SELECT PackPath+\"\\\"+FileName" +
                        ", DLC_Name, Song_Title, Song_Title_Sort, Artist, Artist_Sort, Album, Album_Sort, Reason" +
                        " FROM Pack_AuditTrail WHERE Platform=\"" + chbx_Format + "\" and CDLC_ID=" + ID
                        + " and (Reason <> 'Last Pack' AND reason <>'Last Pack existing') ORDER BY ID DESC;";
                var lp_dlcnam = ""; var lp_Reas0n = ""; var lp_artist = ""; var lp_artists = ""; var lp_songtitle = ""; var lp_songtitles = ""; var lp_album = ""; var lp_albums = "";
                string ttt2 = ""; string ttt1 = ""; string packcomment = "";
                if (((chbx_Last_Packed && chbx_Last_PackedEnabled) && !(chbx_CopyOld && chbx_CopyOldEnabled)) && (!File.Exists(h) || h == ""))
                {
                    DataSet dvr = new DataSet(); dvr = SelectFromDB("Pack_AuditTrail", cmdu, "", cnb, cnc);
                    rec = GetNoRec(dvr, cnb, cnc); //dvr.Tables[0].Rows.Count;
                    if (rec > 0)
                        for (var j = 0; j < rec; j++)
                        {
                            h = dvr.Tables[0].Rows[j].ItemArray[0].ToString();
                            lp_dlcnam = dvr.Tables[0].Rows[j].ItemArray[1].ToString();
                            lp_songtitle = dvr.Tables[0].Rows[j].ItemArray[2].ToString();
                            lp_songtitles = dvr.Tables[0].Rows[j].ItemArray[3].ToString();
                            lp_artist = dvr.Tables[0].Rows[j].ItemArray[4].ToString();
                            lp_artists = dvr.Tables[0].Rows[j].ItemArray[5].ToString();
                            lp_album = dvr.Tables[0].Rows[j].ItemArray[6].ToString();
                            lp_albums = dvr.Tables[0].Rows[j].ItemArray[7].ToString();
                            lp_Reas0n = dvr.Tables[0].Rows[j].ItemArray[8].ToString();
                            if (!File.Exists(h) && lp_artist != "") h = h.Replace("C:\\t\\0", c("dlcm_0_repacked"));
                            if (!File.Exists(h) || lp_artist == "") h = "";
                            else break;
                        }
                }
                if ((!(chbx_Last_Packed && chbx_Last_PackedEnabled) || (chbx_Last_Packed && chbx_Last_PackedEnabled && (rec == 0 || h == ""))) && !(chbx_CopyOld && chbx_CopyOldEnabled) && (!File.Exists(h) || h == ""))
                {
                    var i = 0;
                    lp_Reas0n = "";
                    tsst = "Repacking " + SongRecord[0].NoRec + " song(s)"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                    foreach (var filez in SongRecord)
                    {
                        ...
                        //RemoveDD DD 
                        tsst = "removing DD"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        bassRemoved = false;
                        ...
                        do
                        {
                            ...
                            catch (Exception ex)
                            {
                                ...
                                tsst = "Issues at reading folder!! Retry: " + countd + "/10 " + ex.Message; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                            }
                        }
                        while (!done && countd <= 10);

                        if (xmlFilez[0] != null && ConfigRepository.Instance()["dlcm_AdditionalManipul102"] != "Yes")
                            foreach (var xml in xmlFilez)
                            {
                                if (xml.ToLower().IndexOf("showlights") < 0 && xml.ToLower().IndexOf("vocals") < 0 && c("dlcm_AdditionalManipul102") != "Yes" && xml != null)
                                        ...
                                        if (xmlContent is not null)
                                        {
                                            if (xmlContent.Arrangement.ToLower() == "bass" && !(xml.IndexOf(".old") > 0))
                                                ...
                                                if ((ConfigRepository.Instance()["dlcm_AdditionalManipul3"] == "Yes" || chbx_RemoveBassDD) && chbx_BassDD && (!(chbx_KeepBassDD && ConfigRepository.Instance()["dlcm_AdditionalManipul52"] == "Yes") && !(chbx_KeepDD && ConfigRepository.Instance()["dlcm_AdditionalManipul53"] == "Yes")))
                                                {
                                                    ...
                                                    //filez.Bass_Has_DD = bassRemoved ? "No" : "Yes";
                                                }
                                            ...
                                            if (xmlContent.Arrangement.ToLower() != "bass" && xml.IndexOf(".old") <= 0)
                                            {
                                                if (ConfigRepository.Instance()["dlcm_AdditionalManipul3"] == "Yes" && !(chbx_KeepDD && ConfigRepository.Instance()["dlcm_AdditionalManipul53"] == "Yes"))
                                                {
                                                    ...
                                                    //filez.Has_DD = bassRemoved ? "No" : "Yes";
                                                }
                                            }
                                        }
                                    }
                                    ...
                                    {
                                        var tust = "Error remove dd..." + ex.Message; timestamp = UpdateLog(timestamp, tust, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                    }
                            }

                        //AddDD DD 
                        tsst = "Adding DD"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        var ddAdded = false;
                        if (xmlFilez[0] != null)
                            foreach (var xml in xmlFilez)
                            {
                                if (xml.ToLower().IndexOf("showlights") < 0 && xml.ToLower().IndexOf("vocals") < 0 && (c("dlcm_AdditionalManipul26") == "Yes" ||
                                    ConfigRepository.Instance()["dlcm_AdditionalManipul12"] == "Yes") && (filez.Bass_Has_DD != "Yes" || filez.Has_DD != "Yes") && xml != null)
                                    try
                                    {
                                        Song2014 xmlContent = null;
                                        xmlContent = Song2014.LoadFromFile(xml);
                                        if (xmlContent is not null)
                                        {
                                            if (xmlContent.Arrangement.ToLower() == "bass" && !(ConfigRepository.Instance()["dlcm_AdditionalManipul26"] == "Yes") && xml.IndexOf(".old") <= 0
                                                && filez.Bass_Has_DD == "Yes")
                                            {
                                                ddAdded = (AddDD(Folder_Name, chbx_Original, xml, platformz, false, true, "5") == "Yes") ? true : false;
                                                timestamp = UpdateLog(timestamp, "Removing Bass.." + filez.ID + "-" + filez.Artist + "-" + filez.Song_Title, true, tmpPath, multithreadname, form, null, null);
                                            }

                                            if (xmlContent.Arrangement.ToLower() != "bass" && xml.IndexOf(".old") <= 0)
                                            {
                                                if (ConfigRepository.Instance()["dlcm_AdditionalManipul12"] == "Yes" && filez.Has_DD == "Yes")
                                                {
                                                    ddAdded = (AddDD(Folder_Name, chbx_Original, xml, platformz, false, true, "5") == "Yes") ? true : false;
                                                    timestamp = UpdateLog(timestamp, "Removing non bass DD.." + filez.ID + "-" + filez.Artist + "-" + filez.Song_Title, true, tmpPath, multithreadname, form, null, null);
                                                }
                        ...
                        tsst = "Adding Author info"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        if ((filez.Author == "Custom Song Creator" || filez.Author == "") && ConfigRepository.Instance()["dlcm_AdditionalManipul47"] == "Yes" && filez.Is_Original != "Yes" && ConfigRepository.Instance()["dlcm_AdditionalManipul102"] != "Yes")
                        {
                        ...
                        //modify lyrics
                        tsst = "Modifying lyrics"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        if (ConfigRepository.Instance()["dlcm_AdditionalManipul102"] != "Yes")
                            try
                            {
                                cleanlyrics(filez.ID, cnb, false, cnc);
                                ttt2 = (c("dlcm_AdditionalManipul73") == "Yes" && filez.Has_Vocals == "Yes" && c("dlcm_AdditionalManipul102") != "Yes")
                                   ...
                                   : (c("dlcm_AdditionalManipul133") == "Yes" ? AddLyricsWStuff(filez.ID, filez.Description, Groupss, filez.Has_DD, (filez.Bass_Has_DD == "Yes") ? "No" : "Yes", filez.Bass_Has_DD, filez.Author, filez.Is_Acoustic, filez.Is_Live, filez.Live_Details
                                   , filez.Is_Multitrack, filez.Is_Original, cnb, cnc, SongRecord, chbx_Beta, false) : "");
                                ttt1 = (ConfigRepository.Instance()["dlcm_AdditionalManipul74"]).ToLower() == "Yes".ToLower() && filez.Has_Vocals.ToLower() == "Yes".ToLower() && c("dlcm_AdditionalManipul102") != "Yes"
                                   ? AddTrackStart2Lyrics(filez.ID, cnb, false, cnc) : "";
                                if (ttt2 != "" || ttt1 != "") cleanlyrics(filez.ID, cnb, false, cnc);
                            }
                            catch (Exception ex)
                            {
                                var tust = "Issues at mody lyrics..." + ex.Message; timestamp = UpdateLog(timestamp, tust, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                            }

                        //open lyrics after manipulation
                        if (c("dlcm_AdditionalManipul73") == "Yes" && c("dlcm_AdditionalManipul94") == "Yes" &&
                            (c("dlcm_AdditionalManipul133") == "Yes" || filez.Has_Vocals == "Yes")
                            && c("dlcm_AdditionalManipul102") != "Yes" && ConfigRepository.Instance()["dlcm_AdditionalManipul102"] != "Yes")
                        {
                            ...
                            var noOfRec = GetNoRec(dus, cnb, cnc); //dus.Tables[0].Rows.Count;
                            var ST = ""; var XMLFilePath = "";
                            for (i = 0; i <= noOfRec - 1; i++)
                            {
                                XMLFilePath = dus.Tables[0].Rows[i].ItemArray[0].ToString();
                            ...
                            if (ST != null && ST != "") StartProcesss(filePath, null);
                                ...
                                StartProcesss(System.IO.Path.GetDirectoryName(XMLFilePath), null);
                            //try
                            //    {
                            ...
                            //    catch (Exception ex)
                            //    {
                            //        var trst = "Error lyrics..." + ex; UpdateLog(timestamp, trst, false, c("dlcm_TempPath"), "", "", null, null);
                            //    }
                        ...
                        var audiod = Directory.GetFiles(filez.Folder_Name, "*.wem", System.IO.SearchOption.AllDirectories);
                        foreach (var audiof in audiod) if (audiof != filez.AudioPath && audiof != filez.audioPreviewPath && !audiof.Contains("multitracks")) DeleteFile(audiof, false);
                        var audioo = Directory.GetFiles(filez.Folder_Name, "*.ogg", System.IO.SearchOption.AllDirectories);
                        foreach (var audiofl in audioo) if (audiofl != filez.OggPath && audiofl != filez.oggPreviewPath && !audiofl.Contains("multitracks")) DeleteFile(audiofl, false);


                        //if multitrack is selected make sure it can be loaded together by having a different path to load or to internally maintain
                        var temppath = c("dlcm_Title"); var oldfolderpath = "";
                        Random random = new Random(); var oldT = ConfigRepository.Instance()["dlcm_Title_Sort"];
                        if ((filez.MultiTrack_Version != "" && filez.AI_TrackAvail == "Yes") || (c("dlcm_UniqueID") == "Yes"))
                        {

                            int rn = random.Next(0, 10000000);
                            temppath = c("dlcm_TempPath") + "\\mutitrk\\" + rn;
                            CopyFolder(filez.Folder_Name, temppath);
                            oldfolderpath = filez.Folder_Name;
                            filez.Folder_Name = temppath;
                            filez.AlbumArtPath = filez.AlbumArtPath.Replace(oldfolderpath, temppath);
                            filez.audioPreviewPath = filez.audioPreviewPath.Replace(oldfolderpath, temppath);
                            filez.AudioPath = filez.AudioPath.Replace(oldfolderpath, temppath);
                            filez.OggPath = filez.OggPath.Replace(oldfolderpath, temppath);
                            filez.oggPreviewPath = filez.oggPreviewPath.Replace(oldfolderpath, temppath);
                            ConfigRepository.Instance()["dlcm_Title_Sort"] += (c("dlcm_Title_Sort").Contains("<DD>") ? "" : "<DD>")
                                + (c("dlcm_Title_Sort").Contains("<Bass Has DynamicDificulty>") ? "" : "<Bass Has DynamicDificulty>")
                                + (c("dlcm_Title_Sort").Contains("<Multi Track>") ? "" : "<Multi Track>");
                        }
                        ...
                        volume = volume != 0 ? float.Parse(filez.Volume.ToString(), NumberStyles.Float, CultureInfo.CurrentCulture) : float.Parse(info.Volume.ToString(), NumberStyles.Float, CultureInfo.CurrentCulture);
                        volumep = volumep != 0 ? float.Parse(filez.Preview_Volume, NumberStyles.Float, CultureInfo.CurrentCulture) : float.Parse(info.PreviewVolume.ToString(), NumberStyles.Float, CultureInfo.CurrentCulture);
                        ...
                        info.ArtFiles[1].sourceFile = GetAlbumArtPath(filez.AlbumArtPath.Replace("256", info.ArtFiles[1].sizeX.ToString())
                            , filez.Album_ArtPathOrig.Replace("256", info.ArtFiles[1].sizeX.ToString()), ".dds");
                        info.ArtFiles[0].sourceFile = GetAlbumArtPath(filez.AlbumArtPath.Replace("256", info.ArtFiles[0].sizeX.ToString())
                            , filez.Album_ArtPathOrig.Replace("128", info.ArtFiles[0].sizeX.ToString()), ".dds");
                        info.ArtFiles[2].sourceFile = GetAlbumArtPath(filez.AlbumArtPath.Replace("256", info.ArtFiles[2].sizeX.ToString())
                            , filez.Album_ArtPathOrig.Replace("64", info.ArtFiles[2].sizeX.ToString()), ".dds");

                        timestamp = (!File.Exists(filez.audioPreviewPath) || !File.Exists(filez.AudioPath)) ?
                            timestamp = UpdateLog(timestamp, "erro no wem on song.." + filez.AudioPath + " " + File.Exists(filez.audioPreviewPath) + "-"
                            + filez.audioPreviewPath + " " + File.Exists(filez.AudioPath), true, tmpPath, multithreadname, form, null, null) : timestamp;

                        //fix if audio is mising for whatever reason
                        ...
                        //temp fix for PS3 sound issues '2024
                        if ((!File.Exists(filez.audioPreviewPath) || !File.Exists(filez.AudioPath)))
                            data.SongInfo.Artist = FixAudiofileInconsist(filez.ID.ToInt32(), null, null, null, timestamp, AppWD, "SELECT * FROM Main WHERE ID=" + filez.ID + "", false, true)
                        ...
                        if (!updateTonesArrangs)
                        {
                            ...
                            if (norec > 0 && vocalmissing)
                            {
                                ...
                                ftst = ftst.Replace("\n", "");
                                UpdateDB("Main", "Update Main Set FilesMissingIssues=(\"" + timestamp + " Issues with Vocal loading(check sng,josn exist besides XML).\") WHERE ID=" + ID + ";", cnb, cnc);/*+REPLACE(FilesMissingIssues,\""+ ftst+"\",\"\")*/
                            }
                        }

                        tsst = "Adding Tones"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        var tz = 0; var j = 0; var jf = 0;
                        try
                        {
                            if (updateTonesArrangs)/* && 1 == 2*/
                            {
                                //Update Tones
                                var norec = 0;
                                    ...
                                    foreach (var arg in info.TonesRS2014)//, Type
                                    {
                                        ...
                                        for (j = 0; j < norec; j++)
                                        {
                                            ...
                                            if (arg.Name == dfs.Tables[0].Rows[j].ItemArray[1].ToString())
                                            {
                                                ...
                                                {
                                                    string[] strArrK = null; string[] strArrV = null; char[] splitchar = { ';' };
                                                    if (data.TonesRS2014[j].GearList.PostPedal1 == null)
                                                    {
                                                        data.TonesRS2014[j].GearList.PostPedal1 = new Pedal2014();
                                                        tsst = "erro0 Adding Tone Pedal1 a missing at read: " + data.ArtFiles[0].sourceFile.ToString(); timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                                    }
                                                ...
                                                {
                                                    string[] strArrK = null; string[] strArrV = null; char[] splitchar = { ';' };
                                                    if (data.TonesRS2014[j].GearList.PrePedal1 == null)
                                                    {
                                                        data.TonesRS2014[j].GearList.PrePedal1 = new Pedal2014();
                                                        tsst = "erro0 Adding Tone pre-Pedal1 a missing at read: " + data.ArtFiles[0].sourceFile.ToString(); timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                                    }
                                                ...
                                                for (int k = 0; k < nrc; k++)
                                                {
                                                    ...
                                                    if (data.TonesRS2014[j].GearList.PrePedal2 == null)
                                                    {
                                                        data.TonesRS2014[j].GearList.PrePedal2 = new Pedal2014();
                                                        tsst = "erro0 Adding Tone pre-Pedal2 a missing at read: " + data.ArtFiles[0].sourceFile.ToString(); timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                                    }
                                                ...
                                                for (int k = 0; k < nrc; k++)
                                                {
                                                    ...
                                                    if (data.TonesRS2014[j].GearList.Rack2 == null)
                                                    {
                                                        data.TonesRS2014[j].GearList.Rack2 = new Pedal2014();
                                                        tsst = "erro0 Adding Tone Rack2 a missing at read: " + data.ArtFiles[0].sourceFile.ToString(); timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                                    }
                                ...
                                {
                                    error = true; error_reason += "error updating tones?" + data.SongInfo.Artist + " " + data.SongInfo.SongDisplayName + " " + j + jf + tz + ex.Message;
                                }

                                //Add Arrangements
                                tsst = "Adding Arrangements (if extra files are found e.e. tool added tracks like vocals or copy between songs) ANd missing"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                norec = 0;
                                string sds = "";
                                ...
                                //tsst = "Adding Arrangements (if extra files are found e.e. tool added tracks like vocals or copy between songs)"; timestamp=UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                norec = GetNoRec(ds, cnb, cnc); //ds.Tables[0].Rows.Count;
                                //tsst = "Adding Arrangements (if extra files are found e.e. tool added tracks like vocals or copy between songs)"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                var wemFiles = Directory.EnumerateFiles(System.IO.Path.GetDirectoryName(info.AlbumArtPath) + "\\..\\..", "*.xml", System.IO.SearchOption.AllDirectories).ToList();
                                if (norec < data.Arrangements.Count) timestamp = UpdateLog(timestamp, "Erro less records than XMLS e.g. " + info.AlbumArtPath, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                //else timestamp = UpdateLog(timestamp, "Error less dataloads than XMLs/records e.g. " + info.AlbumArtPath, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                var morexmls = false;
                                if (wemFiles.Count != norec || wemFiles.Count != data.Arrangements.Count)
                                {
                                    timestamp = UpdateLog(timestamp, "Erro less XMLs than records/data-info-loaded-arrangements e.g. " + info.AlbumArtPath, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                    morexmls = true;
                                }

                                if (norec != data.Arrangements.Count || morexmls)
                                {
                                    for (int k = 0; k < norec; k++)
                                    {
                                        // Add Arrangement
                                        var sd = ds.Tables[0].Rows[k].ItemArray[1].ToString();
                                        var a = (sd == "3" || sd == "Bass" ? "-" : (sd == "0" || sd == "Lead" ? "-_" :
                                            (sd == "4" || sd == "Vocals" ? "--" : (sd == "1" || sd == "Rhythm" ? "---" : (sd == "6" || sd == "ShowLights" ? "----" : "l")))));
                                        //if (filez.MultiTrack_Version != "" && filez.AI_TrackAvail == "Yes")
                                        ...
                                        if (same || (sd == "6" || sd == "ShowLights")) continue;

                                        var tzi = ds.Tables[0].Rows[k].ItemArray[5].ToString();
                                        if (!(filez.MultiTrack_Version != "" && filez.AI_TrackAvail == "Yes") && !(c("dlcm_UniqueID") == "Yes") && oldfolderpath != "")
                                            tzi = tzi.Replace(oldfolderpath, temppath);
                                        data.Arrangements.Add(new Arrangement
                                        {
                                            ArrangementName = (sd == "3" || sds == "Bass" ? ArrangementName.Bass : (sd == "0" || sds == "Lead" ? ArrangementName.Lead :
                                                    (sd == "4" || sd == "Vocals" ? ArrangementName.Vocals : (sd == "1" || sd == "Rhythm" ? ArrangementName.Rhythm : (sd == "6" || sd == "ShowLights" ? ArrangementName.ShowLights
                                                    : (sd == "2" || sd == "Combo" ? ArrangementName.Bass : ArrangementName.Rhythm)))))),// ArrangementName.Vocals,
                                                                                                                                        //ArrangementType = ;// ArrangementType.Vocal,
                                            ArrangementType = (sd == "3" || sds == "Bass" ? ArrangementType.Bass : (sd == "0" || sds == "Lead" ? ArrangementType.Guitar :
                                                    (sd == "4" || sd == "Vocals" ? ArrangementType.Vocal : (sd == "1" || sd == "Rhythm" ? ArrangementType.Guitar : (sd == "6" || sd == "ShowLights" ? ArrangementType.ShowLight
                                                    : (sd == "2" || sd == "Combo" ? ArrangementType.Bass : ArrangementType.Guitar)))))),// ArrangementName.Vocals,
                                                                                                                                        //ArrangementType = ;// ArrangementType.Vocal,
                                                                                                                                        //        ScrollSpeed = 20,
                                            SongXml = new SongXML { File = tzi },
                                ...
                                tsst = "Adding Arrangements (in DLCM has more records than the folder system of the song has XMLs) if missing"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                var n = 0;
                                foreach (var arg in data.Arrangements)//, Type
                                {
                                    bool same = false;
                                    for (int l = 0; l < data.Arrangements.Count; l++)
                                        if (arg.SongXml.Name.ToString() == ds.Tables[0].Rows[l].ItemArray[26].ToString())
                                        {
                                            same = true;
                                            //n = l;
                                            break;
                                    ...
                                    //try to make packages more unique as to allow same song slightly diff version (ai track, etc) existence
                                    if (ds.Tables[0].Rows[n].ItemArray[15].ToString() != "" && c("dlcm_UniqueID") != "Yes")
                                        data.Arrangements[n].Id = Guid.Parse(ds.Tables[0].Rows[n].ItemArray[15].ToString());
                                    ...
                                    else data.Arrangements[n].MasterId = random.Next(0, 10000000);
                                    ...
                                    if (ds.Tables[0].Rows[n].ItemArray[28].ToString() != "" && c("dlcm_UniqueID") != "Yes")
                                        data.Arrangements[n].SongXml.UUID = Guid.Parse(ds.Tables[0].Rows[n].ItemArray[28].ToString());
                                    ...
                                    if (ds.Tables[0].Rows[n].ItemArray[31].ToString() != "" && c("dlcm_UniqueID") != "Yes")
                                        data.Arrangements[n].SongFile.UUID = Guid.Parse(ds.Tables[0].Rows[n].ItemArray[31].ToString());
                                    else if (data.Arrangements[n].SongFile is not null) data.Arrangements[n].SongFile.UUID = Guid.NewGuid();
                                    else
                                    {
                                        //Arrangement = new Arrangement { SongFile = new SongFile { File = "" }, SongXml = new SongXML { File = xmlFilePath } };
                                        data.Arrangements[n].SongFile = new RocksmithToolkitLib.DLCPackage.AggregateGraph.SongFile();
                                        // { SongFile = new SongFile { File = "" } };
                                        data.Arrangements[n].SongFile.UUID = Guid.NewGuid();
                                        data.Arrangements[n].SongFile.File = info.Arrangements[n].SongFile.File;
                        ...
                        {
                            error = true; error_reason += "error updating arangement?" + data.SongInfo.Artist + " " + data.SongInfo.SongDisplayName + " " + j + jf + tz + ex.Message;
                        }
                        ...
                        {
                            tsst = "Get track no."; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                            try
                            {
                                ...
                                timestamp = UpdateLog(timestamp, "Retrieved Spotify details " + SpotifyAlbumPath, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                            ...
                            catch (Exception ex) { var tust = "Spotify Error ..." + ex.Message; timestamp = UpdateLog(timestamp, tust, false, c("dlcm_TempPath"), multithreadname, form, null, null); }
                        }

                        //Gather song Lenght
                        tsst = "Gather song Lenght"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        var bitrate = 350001;
                        var bitratep = 350001;
                           ...
                           && info.OggPath != null)))
                        {
                            ...
                            if (d1.Split(';')[0] == "1")
                            {
                                ...
                                && info.OggPath != null)
                                {
                                    tsst = "Convert Audio to lower bitrate"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                    ...
                                    var t = GetNoRecords(cmd, cnb, cnc);
                                    FixMissingPreview(cmd, cnb, AppWD, null, null, false, windw, cnc);
                                    if (t > 0) data.SongInfo.Artist = data.SongInfo.Artist.Contains("]") ? data.SongInfo.Artist.Replace("]", " wfixMssPrew]") : data.SongInfo.Artist + " [wfixMssPrew]";
                                }
                                ...
                                if (ConfigRepository.Instance()["dlcm_AdditionalManipul69"] == "Yes" && info.OggPath != null)
                                {
                                    ...
                                    cmd += " AND ID=" + ID; var t = GetNoRecords(cmd, cnb, cnc);
                                    FixAudioIssues(cmd, cnb, AppWD, null, null, false, windw, cnc);
                                    if (t > 0) data.SongInfo.Artist = data.SongInfo.Artist.Contains("]") ? data.SongInfo.Artist.Replace("]", " wDownAud]") : data.SongInfo.Artist + " [wDownAud]";
                                }
                        ...
                        {
                            tsst = "REcompress Audio as some PS3 frameworks are not compatible"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                            File.Copy(filez.oggPreviewPath.ToString(), c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(filez.oggPreviewPath.ToString()), true);
                            Converters(c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(filez.oggPreviewPath.ToString()), ConverterTypes.Ogg2Wem, false, true);
                            File.Copy(c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(filez.oggPreviewPath.ToString()).Replace(".ogg", ".wem"), filez.audioPreviewPath, true);

                            File.Copy(filez.OggPath.ToString(), c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(filez.OggPath.ToString()), true);
                            Converters(c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(filez.OggPath.ToString()), ConverterTypes.Ogg2Wem, false, true);
                            File.Copy(c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(filez.OggPath.ToString()).Replace(".ogg", ".wem"), filez.AudioPath, true);
                            ...
                            if (wem == "" || wemo == "" || ogg == "" || oggo == "") FixAudiofileInconsist(0, null, null, null, timestamp, AppWD, SearchCmd, false, true);
                            ...
                            //tsst = "framework bug 1 time fix"; UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                            //var paath = c("dlcm_MediaInfo_CLI");
                            //var xx = "";
                            //if (File.Exists(paath)) xx = paath;
                        ...
                        timestamp = (!File.Exists(filez.audioPreviewPath) || !File.Exists(filez.AudioPath)) ?
                            timestamp = UpdateLog(timestamp, "Erro/erro no wems on song.." + filez.AudioPath + "--" + filez.audioPreviewPath, true, tmpPath, multithreadname, form, null, null) : timestamp;

                        //Add Multitrack if diff audio
                        //STILLTODO: downstze :)
                        if (filez.MultiTrack_Version != "" && filez.AI_TrackAvail == "Yes")/*.Contains(" (Audio Available)")*/
                        {
                            tsst = "get alternative audio"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                            var t = GetAlternativeAudioFile(filez.MultiTrack_Version, filez.Folder_Name, filez.OggPath).Replace(".ogg", ".wem");
                            data.OggPath = File.Exists(t) ? t : t.Replace("_fixed", "");
                        ...
                        //{
                        //    var tgst = Show "; UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        ...
                        try
                        {
                            ...
                            foreach (var fil in sourceAudioFiles)
                            {
                                ...
                                {
                                    tsst = "Fixed the _preview_preview issue"; timestamp = UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        ...
                        {
                            var tust = "Error preview..." + ex.Message; timestamp = UpdateLog(timestamp, tust, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        }

                        var FN = "";
                        if ((c("dlcm_AdditionalManipul127") == "Yes") && txt_OldPath != "") FN = System.IO.Path.GetFileNameWithoutExtension(txt_OldPath.Replace("_p.psarc", ".psarc").Replace("_m.psarc", ".psarc")).Replace("_ps3.psarc", "");
                        else
                            if ((c("dlcm_AdditionalManipul127") == "Yes") && txt_OldPath == "") FN = System.IO.Path.GetFileNameWithoutExtension(filez.Original_FileName.Replace("_p.psarc", ".psarc").Replace("_m.psarc", ".psarc")).Replace("_ps3.psarc", "");
                            else
                                if (MetaChangeActiv("FileName", ConfigRepository.Instance()["dlcm_Activ_FileName"]).Contains("nactive")) //(ConfigRepository.Instance()["dlcm_Activ_FileName"] == "Yes")/*repacked_Path + "\\" + */
                                    FN = ((filez.ToolkitVersion == "") ? "ORIG" : (c("dlcm_AdditionalManipul102") == "Yes" ? "CDLC4CF" : "CDLC"))
                                        + "_" + CleanTitle(data.SongInfo.Artist) + "_" + data.SongInfo.SongYear.ToString() + "_" + CleanTitle(data.SongInfo.Album) + "_" + data.SongInfo.SongDisplayName;
                                else
                        ...
                        {
                            var tgst = "Add Groups to File Name"; timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                            FN = Groupss + FN;
                        }

                        if (ConfigRepository.Instance()["dlcm_AdditionalManipul8"] == "Yes")
                        {
                            var tgst = "Clean path"; timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                            FN = CleanPath(FN);
                        }

                        //make sure FN are different
                        DataSet du; du = SelectFromDB("Pack_AuditTrail", "SELECT PackPath, FileName, Platform FROM Pack_AuditTrail WHERE Pack=\"" + packid + "\" AND INSTR(FileName,\"" + FN + "\")", "", cnb, cnc);
                        var recs = GetNoRec(du, cnb, cnc);
                        if (recs > 0)
                        {
                            FN = FN.Replace("]", "_" + SongRecord[0].ID + "]");
                            var tgst = "Making fileName unique:" + FN; timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        }

                        //make sure DCName are different
                        DataSet diz; diz = SelectFromDB("Pack_AuditTrail", "SELECT PackPath, FileName, Platform FROM Pack_AuditTrail WHERE DLC_Name=\"" + data.Name + "\" ", "", cnb, cnc);/*AND FileName<>\"" + FN + "\"*/
                        var res = GetNoRec(diz, cnb, cnc);
                        if (res > 0 && c("dlcm_UniqueID") == "Yes")
                        {
                            Random rando = new Random();
                            int pid = rando.Next(0, 100000);
                            data.Name += packid + pid;
                            DataSet doz; doz = SelectFromDB("Pack_AuditTrail", "SELECT PackPath, FileName, Platform FROM Pack_AuditTrail WHERE DLC_Name=\"" + data.Name + "\" ", "", cnb, cnc);/*AND FileName<>\"" + FN + "\"*/
                            var re = GetNoRec(doz, cnb, cnc);
                            if (re > 0) data.Name += pid;

                            var tgst = "Making dlcname unique:" + data.Name; timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        }

                        //make sure ArtistSort + SongDisplayNameSort are different
                        DataSet dzz; dzz = SelectFromDB("Pack_AuditTrail", "SELECT Artist_Sort, Song_Title_Sort FROM Pack_AuditTrail WHERE Artist_Sort=\"" + data.SongInfo.ArtistSort + "\" " +
                            "AND Song_Title_Sort=\"" + data.SongInfo.SongDisplayNameSort + "\" AND Pack=\"" + packid + "\";", "", cnb, cnc);
                        var rez = GetNoRec(dzz, cnb, cnc);
                        if (rez > 0)
                        {
                            Random rando = new Random();
                            int pid = rando.Next(0, 100000);
                            data.SongInfo.SongDisplayNameSort += pid;

                            var tgst = "Making internal counter artist_sort & song_title_sort unique:" + data.Name; timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                        }

                        if (data.ToolkitInfo is not null)
                            if (data.ToolkitInfo.PackageComment.Contains("Do you agree with replacement of") || ConfigRepository.Instance()["dlcm_AdditionalManipul102"] == "Yes")
                            {
                                data.ToolkitInfo.PackageComment = "";
                        ...
                        timestamp = UpdateLog(timestamp, "metadata: " + ConfigRepository.Instance()["dlcm_Global2TempVariable"].Replace("\n", "\n\n"), true, c("dlcm_TempPath"), null, null, null, null);
                        ...
                        if (frm2 is not null) if (frm2.B2) return;
                        packcomment = data.ToolkitInfo.PackageComment;
                        ...
                        timestamp = UpdateLog(timestamp, "Preview has " + PreviewLenght + "secs.", true, c("dlcm_TempPath"), null, null, null, null);
                        ...
                        if (c("dlcm_AdditionalManipul98") == "Yes" && form != "MainDB")
                        {
                            ...
                            DataSet dvy = new DataSet(); if (chbx_PS4 == "PS4") dvy = SelectFromDB("Pack_AuditTrail", "SELECT * FROM Pack_AuditTrail WHERE CDLC_ID=" + filez.ID + " AND Platform =\"PS4\"", "", cnb, cnc);
                            if (GetNoRec(dvy, cnb, cnc) > 0) chbx_PS4 = "";
                        }

                        //if ever changed for whateva reason now restore old value in case crashing at pack
                        //if (filez.MultiTrack_Version != "" && filez.AI_TrackAvail == "Yes")
                        //{
                        ConfigRepository.Instance()["dlcm_Title_Sort"] = oldT;// "<DD><BDD><Multi Track>"; temppath                                                                              // }

                        var er = "";
                        if (chbx_PC == "PC")
                            try
                            {
                                dlcSavePath = repacked_Path + "\\" + chbx_PC + "\\" + FN; er = ""; dataPc = data;
                            ...
                            catch (Exception ex)
                            {
                                ...
                                var tgst = dlcSavePath + "Erro generate..." + ex.Message; timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                error = true;
                        ...
                        if (chbx_PS4 == "PS4")
                            try
                            {
                                dlcSavePath = repacked_Path + "\\" + chbx_PS4 + "\\" + FN; er = ""; dataPS4 = data;
                                //data.Arrangements[0].Sng2014. = -1;
                                er = RocksmithToolkitLib.DLCPackage.DLCPackageCreator.Generate(dlcSavePath, data, new Platform(GamePlatform.PS4, GameVersion.RS2014));
                                if (!File.Exists(er)) { error = true; error_reason += "@PS4 pack" + er; }
                                progress += step;
                            }
                            catch (Exception ex)
                            {
                                ...
                                var tgst = dlcSavePath + "Erro generate..." + ex.Message; timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                error = true;
                                error_reason += "@PS4 pack" + ex.Message;
                            }
                        ...
                        if (chbx_Mac == "Mac")
                            try
                            {
                                ...
                                dlcSavePath = repacked_Path + "\\" + chbx_Mac + "\\" + FN; er = ""; dataMac = data;
                        ...
                        if (chbx_XBOX == "XBOX360")//&& 1 == 3
                            try
                            {
                                fixMissingTempArtfiles(data);
                                dlcSavePath = repacked_Path + "\\" + chbx_XBOX + "\\" + FN; er = ""; dataXbox360 = data;
                            ...
                            catch (Exception ex)
                            {
                                ...
                                var tgst = dlcSavePath + "Erro at xbox generate..." + ex.Message; timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                error = true;
                        ...
                        if (chbx_PS3 == "PS3")/*&& 1 == 3*/
                            try
                            {
                                ...
                                if (c("dlcm_AdditionalManipul122") == "Yes" && filez.MultiTrack_Version == "")
                                {
                                    var tgst = "Use Orig Audio as some PS3 are badly encoded and DLCM is not yet fully functional there"; timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                    ...
                                    {
                                        timestamp = UpdateLog(timestamp, "Issues at using orig audio", false, ConfigRepository.Instance()["dlcm_TempPath"], null, null, null, null);
                                ...
                                fixMissingTempArtfiles(data);
                                dlcSavePath = repacked_Path + "\\" + chbx_PS3 + "\\" + FN; er = ""; dataPs3 = data;

                                timestamp = UpdateLog(timestamp, "PS3 Packing:" + ID + data.SongInfo.Artist + data.SongInfo.SongDisplayName, false, ConfigRepository.Instance()["dlcm_TempPath"], null, null, null, null);
                                ...
                                timestamp = UpdateLog(timestamp, "END PS3 Packing.", false, ConfigRepository.Instance()["dlcm_TempPath"], null, null, null, null);

                                //try again with recompressed wem
                                if (!File.Exists(er))
                                    try
                                    {
                                        var tgt = dlcSavePath + "wem erro..." + er; timestamp = UpdateLog(timestamp, tgt, false, ConfigRepository.Instance()["dlcm_TempPath"], null, null, null, null);

                                        var audio = c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(filez.OggPath);
                                        ...
                                        var audiop = c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(filez.oggPreviewPath);
                                    ...
                                    catch (Exception exx)
                                    {
                                        ...
                                        var tgst = dlcSavePath + "Erro @ps3generate..." + exx.Message + "-" + c("dlcm_errorsstring"); timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
                                        error = true;
                            ...
                            catch (Exception ex)
                            {
                                try
                                {
                                    var tgt = dlcSavePath + "wem erro..." + ex.Message.Replace("error", "erro") + "-" + c("dlcm_errorsstring"); timestamp = UpdateLog(timestamp, tgt, false, ConfigRepository.Instance()["dlcm_TempPath"], null, null, null, null);
                                ...
                                {
                                    //var tgt = "Erro during rocksmith lib internal packaging..." + exx.Message+"-"+filez.OggPath; UpdateLog(timestamp, tgt, false, ConfigRepository.Instance()["dlcm_TempPath"], null, null, null, null);
                        ...
                        if ((filez.MultiTrack_Version != "" && filez.AI_TrackAvail == "Yes") || (c("dlcm_UniqueID") == "Yes"))
                        {
                            DeleteDirectory(filez.Folder_Name, true);
                        }
                ...
                if (h != "")
                {
                    ...
                    try
                    {
                        ...
                        if (chbx_PS3 == "PS3")
                        {
                            h = h.Replace("\\0_repacked\\PC", "\\0_repacked\\PS3").Replace("\\0_repacked\\Mac", "\\0_repacked\\PS3").Replace("\\0_repacked\\XBOX360", "\\0_repacked\\PS3").Replace("\\0_repacked\\PS4", "\\0_repacked\\PS3");
                            source = h.IndexOf("_ps3.psarc.edat") <= 0 ? h + "_ps3.psarc.edat" : h;
                            h = h.IndexOf("_ps3.psarc.edat") <= 0 ? h + "_ps3.psarc.edat" : h; fi = new System.IO.FileInfo(source);
                            ...
                            if (File.Exists(source) && chbx_Copy)
                            {
                                ...
                                {
                                    var TrueGameFldr = System.IO.Path.Combine(AppWD, "TrueAncestor_PKG_Repacker_v2.45\\game\\") + c("dlcm_" + c("dlcm_MainDBFormat").Replace("PS3_", "FTP")).Substring(33, 9);
                                    //copy edat in DLC folder
                                    var dst = TrueGameFldr + "\\USRDIR\\DLC\\" + System.IO.Path.GetFileName(source);
                                ...
                                else
                                {
                                    ...
                                    if (a.ToLower() == "not " || a.ToLower() == "not")
                                    {
                                        if (lp_Reas0n == "" && c("dlcm_AdditionalManipul64") == "Yes") lp_Reas0n = "repacked as Last Pack missing";
                                        if (txt_RemotePath == "" || txt_RemotePath is null) txt_RemotePath = System.IO.Path.GetFileName(source);
                                        if (txt_RemotePath == "") lp_Reas0n = "MissingP";
                                        copiedpath = c("dlcm_TempPath") + "\\0_to_import\\" + System.IO.Path.GetFileName(source);
                                        if (File.Exists(source))
                                            if (!File.Exists(copiedpath))
                                            {
                                                File.Copy(source, copiedpath, false);
                                                lp_Reas0n += (c("dlcm_AdditionalManipul64") == "Yes") ? "Last Pack" : "";
                                                timestamp = UpdateLog(timestamp, "copy LAST edat in DLC folder" + copiedpath, true, tmpPath, multithreadname, form, null, null);
                                            }
                                            else
                                            {
                                                if (!(lp_Reas0n == "repacked as Last Pack missing" && c("dlcm_AdditionalManipul64") == "Yes") && c("dlcm_AdditionalManipul64") == "Yes")
                                                    lp_Reas0n += "Last Pack existing";
                                                timestamp = UpdateLog(timestamp, "no copy as already existing LAST edat in DLC folder" + copiedpath, true, tmpPath, multithreadname, form, null, null);
                                            }
                                        else
                                        {
                                            lp_Reas0n = "Missing";
                                            timestamp = UpdateLog(timestamp, "no copy as missing LAST edat in DLC folder" + h, true, tmpPath, multithreadname, form, null, null);
                                        }

                                        var browser = new PsarcBrowser(source);
                                        ...
                                        if (songList.Count > 0)
                                            foreach (var song in songList)
                                            {
                                                ...
                                                dataPs3.SongInfo = new RocksmithToolkitLib.DLCPackage.SongInfo();
                                        ...
                                        {
                                            dataPs3.SongInfo = new RocksmithToolkitLib.DLCPackage.SongInfo();
                                            dataPs3.SongInfo.SongDisplayName = lp_songtitle;
                                            dataPs3.SongInfo.SongDisplayNameSort = lp_songtitles;
                                            dataPs3.SongInfo.Album = lp_album;
                                            dataPs3.SongInfo.AlbumSort = lp_albums;
                                            dataPs3.SongInfo.SongYear = 0;
                                            dataPs3.SongInfo.Artist = lp_artist;
                                            dataPs3.SongInfo.ArtistSort = lp_artists;
                                        }
                                        if (lp_dlcnam != "" && dataPs3.Name == "") dataPs3.Name = lp_dlcnam;
                                    }
                                ...
                                if (!File.Exists(source))
                                {
                                    error = true; error_reason += "failed at ps3-packing ";/*@FTP*/
                                }

                            if (!error && ConfigRepository.Instance()["dlcm_AdditionalManipul101"] == "Yes")
                            {
                                error = CheckSong(source); if (error)
                                    error_reason += "Packed but failing at Ps3Packing PSARC ErrorCheck" + ConfigRepository.Instance()["dlcm_Global2TempVariable"];
                                else frmt += "PS3,";
                            }
                            else if (!error) frmt += "PS3,";
                            ...
                            if (chbx_Last_Packed && chbx_Last_PackedEnabled)
                                Add2Pack(multithreadname, form, platfrm, chbx_Replace, chbx_ReplaceEnabled, txt_FTPPath, source, copiedpath, cnb,
                                  fi, ID, DLC_Name, chbx_PS3, packid, a, chbx_Copy, cnc, dataPs3, lp_Reas0n, (ttt1 + ttt2), packcomment);
                            if (!error && lp_Reas0n == "")
                                Add2Pack(multithreadname, form, platfrm, chbx_Replace, chbx_ReplaceEnabled, txt_FTPPath, source, copiedpath, cnb,
                                    fi, ID, DLC_Name, chbx_PS3, packid, a, chbx_Copy, cnc, dataPs3, lp_Reas0n, (ttt1 + ttt2), packcomment);
                        }
                        ...
                        {
                            source = h.IndexOf("_p.psarc") <= 0 ? h.Replace("_ps3.psarc.edat", "").Replace("\\0_repacked\\PS3", "\\0_repacked\\PC").Replace("\\0_repacked\\Mac", "\\0_repacked\\PC").Replace("\\0_repacked\\XBOX360", "\\0_repacked\\PC")
                                + platfrm + ".psarc" : h;
                            fi = new System.IO.FileInfo(source);
                            bool errorpc = false;
                            if (!File.Exists(source))
                            {
                                error = true; error_reason += "failed at pc-packing ";/*@FTP*/
                            }
                            else
                                if (fi.Length == 0)/*|| !File.Exists(source)*/
                                {
                                    errorpc = true; error_reason += "chbx_PC filesize zero";
                                }
                            dest = RocksmithDLCPath + source.Substring(source.LastIndexOf("\\"));
                            if (!errorpc && ConfigRepository.Instance()["dlcm_AdditionalManipul101"] == "Yes")
                            {
                                errorpc = CheckSong(source); if (errorpc)
                                {
                                    error_reason += "Packed but failing at Pc Packing PSARC ErrorCheck" + ConfigRepository.Instance()["dlcm_Global2TempVariable"];
                                    error = true;
                                }
                                else frmt += "Pc,";
                            }
                            else if (!error) frmt += "Pc,";

                            ////Add Pack Audit Trail
                            if (!(chbx_CopyOld && chbx_CopyOldEnabled && needRebuildPackage) && !(chbx_Last_Packed && chbx_Last_PackedEnabled))
                                copiedpath = dest.Replace(System.IO.Path.GetDirectoryName(dest), Directory.Exists(c("general_rs2014path")) && c("general_rs2014path").IndexOf(":\\") >= 0 ? c("general_rs2014path") : c("dlcm_PC"));
                            if (!errorpc)
                                copyftp += " and " + Add2Pack(multithreadname, form, platfrm, chbx_Replace, chbx_ReplaceEnabled, txt_RemotePath,
                                    source, copiedpath == "" ? dest : copiedpath, cnb, fi, ID, DLC_Name, chbx_PC, packid, "", chbx_Copy, cnc, dataPc, "", ttt1 + ttt2, packcomment) //&& oldfilePath.GetPlatform().platform.ToString() != chbx_Format
                                 + " Copied(PC)";
                        }
                        ...
                        platfrm = "";
                        if (chbx_PS4 == "PS4")// && chbx_Copy
                        {
                            source = h.IndexOf(".psarc") <= 0 ? h.Replace("_ps3.psarc.edat", "").Replace("_p.psarc", "").Replace("\\0_repacked\\PS3", "\\0_repacked\\PS4").Replace("\\0_repacked\\Mac", "\\0_repacked\\PS4").Replace("\\0_repacked\\XBOX360", "\\0_repacked\\PS4") + platfrm + ".psarc" : h;
                            fi = new System.IO.FileInfo(source);
                            bool errorps4 = false;
                            if (!File.Exists(source))
                            {
                                error = true; error_reason += "failed at ps4-packing ";/*@FTP*/
                            }
                            else
                                if (fi.Length == 0)/*|| !File.Exists(source)*/
                                {
                                    errorps4 = true; error_reason += "chbx_PS4 filesize zero";
                                }
                            dest = RocksmithDLCPath + source.Substring(source.LastIndexOf("\\"));
                            if (!errorps4 && ConfigRepository.Instance()["dlcm_AdditionalManipul101"] == "Yes")
                            {
                                errorps4 = CheckSong(source);
                                if (errorps4)
                                {
                                    error_reason += "Packed but failing at PS4 Packing PSARC ErrorCheck" + ConfigRepository.Instance()["dlcm_Global2TempVariable"];
                                    error = true;
                                }
                                else frmt += "PS4,";
                            }
                            else if (!error) frmt += "PS4,";

                            ////Add Pack Audit Trail
                            if (!(chbx_CopyOld && chbx_CopyOldEnabled && needRebuildPackage) && !(chbx_Last_Packed && chbx_Last_PackedEnabled))
                                copiedpath = dest.Replace(System.IO.Path.GetDirectoryName(dest), Directory.Exists(c("general_rs2014path")) && c("general_rs2014path").IndexOf(":\\") >= 0 ? c("general_rs2014path") : c("dlcm_PS4"));
                            if (!errorps4)
                                copyftp += " and " + Add2Pack(multithreadname, form, platfrm, chbx_Replace, chbx_ReplaceEnabled, txt_RemotePath,
                                    source, copiedpath == "" ? dest : copiedpath, cnb, fi, ID, DLC_Name, chbx_PS4, packid, "", chbx_Copy, cnc, dataPS4, "", ttt1 + ttt2, packcomment) //&& oldfilePath.GetPlatform().platform.ToString() != chbx_Format
                                 + " Copied(PS4)";
                        }
                        ...
                        {
                            source = h.IndexOf("_m.psarc") <= 0 ?
                                h.Replace("_ps3.psarc.edat", "").Replace("_p.psarc", "").Replace("\\0_repacked\\XBOX360", "\\0_repacked\\Mac").Replace("\\0_repacked\\PS3", "\\0_repacked\\Mac").Replace("\\0_repacked\\PC", "\\0_repacked\\Mac")
                                + platfrm + ".psarc" : h;
                            fi = new System.IO.FileInfo(source);
                            bool errormac = false;
                            if (!File.Exists(source))
                            {
                                error = true; error_reason += "failed at mac-packing ";/*@FTP*/
                            }
                            else
                                if (fi.Length == 0)//|| !File.Exists(source)
                                {
                                    errormac = true; error_reason += "mac filezise zero";
                                }
                            dest = RocksmithDLCPath + source.Substring(source.LastIndexOf("\\"));
                            if (!errormac && ConfigRepository.Instance()["dlcm_AdditionalManipul101"] == "Yes")
                            {
                                errormac = CheckSong(source); if (errormac)
                                {
                                    error_reason += "Packed but failing at Mac Packing PSARC ErrorCheck" + ConfigRepository.Instance()["dlcm_Global2TempVariable"];
                                    error = true;
                                }
                                else frmt += "Mac,";
                            }
                            else if (!error) frmt += "Mac,";

                            ////Add Pack Audit Trail
                            if (!(chbx_CopyOld && chbx_CopyOldEnabled && needRebuildPackage) && !(chbx_Last_Packed && chbx_Last_PackedEnabled))
                                copiedpath = dest.Replace(System.IO.Path.GetDirectoryName(dest), Directory.Exists(c("general_rs2014path")) ? c("general_rs2014path") : c("dlcm_Mac"));
                            if (!error)
                                copiedpath = dest.Replace(System.IO.Path.GetDirectoryName(dest), Directory.Exists(c("general_rs2014path")) ? c("general_rs2014path") : c("dlcm_Mac"));
                            copyftp += " and " + Add2Pack(multithreadname, form, platfrm, chbx_Replace, chbx_ReplaceEnabled, txt_RemotePath, source
                                , copiedpath == "" ? dest : copiedpath, cnb, fi, ID, DLC_Name, chbx_Mac, packid, "", chbx_Copy, cnc, dataMac, "", ttt1 + ttt2, packcomment) //&& oldfilePath.GetPlatform().platform.ToString() != chbx_Format
                            + " Copied(Mac)";
                        }

                        platfrm = "_xbox"; copiedpath = "";
                        if (chbx_XBOX == "XBOX360")// &&1==3&& chbx_Copy
                        {
                            source = h.Replace("_ps3.psarc.edat", "").Replace("_p.psarc", "").Replace("_m.psarc", "").Replace("\\0_repacked\\PC", "\\0_repacked\\XBOX360").Replace("\\0_repacked\\PS3", "\\0_repacked\\XBOX360").Replace("\\0_repacked\\Mac", "\\0_repacked\\XBOX360")
                               ;// h.IndexOf("_m.psarc") <= 0 ? + platfrm : h;/*+ ".psarc"*/
                            fi = new System.IO.FileInfo(source);
                            bool errorxbox = false;
                            if (!File.Exists(source))
                            {
                                error = true; error_reason += "failed at xbox-packing ";/*@FTP*/
                            }
                            else
                                if (fi.Length == 0)
                                {
                                    errorxbox = true; error_reason += "xbobx360 filezise zero";
                                }
                            dest = RocksmithDLCPath + source.Substring(source.LastIndexOf("\\"));

                            if (!errorxbox && ConfigRepository.Instance()["dlcm_AdditionalManipul101"] == "Yes")
                            {
                                errorxbox = CheckSong(source);
                                if (errorxbox)
                                {
                                    error_reason += "Packed but failing at XBOX360 Packing PSARC ErrorCheck" + ConfigRepository.Instance()["dlcm_Global2TempVariable"];
                                    error = true;
                                }
                                else frmt += "XBOX360,";
                            }
                            else if (!error) frmt += "XBOX360,";

                            ////Add Pack Audit Trail
                            if (!(chbx_CopyOld && chbx_CopyOldEnabled && needRebuildPackage) && !(chbx_Last_Packed && chbx_Last_PackedEnabled))
                                copiedpath = dest.Replace(System.IO.Path.GetDirectoryName(dest), Directory.Exists(c("general_rs2014path")) ? c("general_rs2014path") : c("dlcm_XBOX"));
                            if (!error)
                                copiedpath = dest.Replace(System.IO.Path.GetDirectoryName(dest), Directory.Exists(c("general_rs2014path")) ? c("general_rs2014path") : c("dlcm_XBOX"));
                            copyftp += " and " + Add2Pack(multithreadname, form, platfrm, chbx_Replace, chbx_ReplaceEnabled, txt_RemotePath, source
                                , copiedpath == "" ? dest : copiedpath, cnb, fi, ID, DLC_Name, chbx_Mac, packid, "", chbx_Copy, cnc, dataXbox360, "", ttt1 + ttt2, packcomment) //&& oldfilePath.GetPlatform().platform.ToString() != chbx_Format
                            + " Copied(XBOX360)";
                    ...
                    {
                        var tgst = "Erro after packing at copying/ftping..." + ex.Message; timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), multithreadname, form, null, null);
            ...
            if (xmlFilex != null) foreach (var xml in xmlFilex)
            {
                if (xml.ToLower().IndexOf("showlights") < 0)
                    try
                    {
                        ...
                        timestamp = UpdateLog(timestamp, "Restore XML " + xml, true, tmpPath, multithreadname, form, null, null);
                        DeleteFile(xml, false);
                    }
                    catch (Exception ex)
                    {
                        var tgst = "Error at restoring xml changes..." + ex.Message; timestamp = UpdateLog(timestamp, tgst, false, c("dlcm_TempPath"), "", "", null, null);
                    }
            }
            //delete rrngfwmwnt dded temporarely "empty lyricxs added temporarerly "
            //DeleteFromDB("Arrangements", "DELETE * FROM Arrangements WHERE CDLC_ID=" + ID + " AND Comments like \"*empty lyricxs added temporarerly*\"", cnb, cnc);
            var xmlFile = DirectoryExists(Folder_Name) ? Directory.GetFiles(Folder_Name, "*_No_v0cal.xml", System.IO.SearchOption.AllDirectories) : null;
            if (xmlFile != null)
                foreach (var xml in xmlFile)
                {
                    DeleteFile(xml, true);

                    //DeleteFromDB("Arrangements", "DELETE * FROM Arrangements WHERE CDLC_ID=" + ID + " AND Comments like \"*empty lyricxs added temporarerly*\";", cnb, cnc);
                    //DeleteFromDB("Arrangements", "DELETE FROM Arrangements WHERE CDLC_ID=" + ID + " AND Comments like \"*empty lyricxs added temporarerly*\";", cnb, cnc);
                    //DeleteFromDB("Arrangements", "DELETE * FROM Arrangements WHERE Comments like \"*empty lyricxs added temporarerly*\";", cnb, cnc);
                    //DeleteFromDB("Arrangements", "DELETE * FROM Arrangements WHERE ID=94907;", cnb, cnc);
                    //DeleteFromDB("Arrangements", "DELETE FROM Arrangements WHERE Comments like \"*empty lyricxs added temporarerly*\";", cnb, cnc);
                    var sel = "SELECT ID FROM Arrangements WHERE CDLC_ID = " + ID + " AND Comments like \"%empty lyricxs added temporarerly%\";";
                    DataSet dus = new DataSet(); dus = SelectFromDB("Arrangements", sel, "", cnb, cnc);
                    var noOfRec = GetNoRec(dus, cnb, cnc);
                    if (noOfRec > 0) DeleteFromDB("Arrangements", "DELETE * FROM Arrangements WHERE ID= " + dus.Tables[0].Rows[0].ItemArray[0].ToString() + ";", cnb, cnc);
                }
            if (error)
            {
                e.Cancel = true;
                UpdatePackingLog("LogPackingError", ConfigRepository.Instance()["dlcm_DBFolder"], packid.ToInt32(), args[0], error_reason, cnb, cnc, null);
                timestamp = UpdateLog(timestamp, "End Packing", true, tmpPath, multithreadname, form, null, null);
            }
            else
                UpdatePackingLog("LogPacking", ConfigRepository.Instance()["dlcm_DBFolder"], packid.ToInt32(), args[0], "", cnb, cnc, (frmt.Contains(",") ? frmt.Substring(0, frmt.Length - 1) : null));
            ...
            , string ord_no, bool bassRemoved, bool chbx_Beta, string FN, bool uniformcolumnlenght)/*, MainDBfields[] SongRecord*/
        {
            ...
            //manipulating the info Artist& Album & Lyrics info
            if (c("dlcm_AdditionalManipul132") == "Yes")
            {
                if (!ConfigRepository.Instance()["dlcm_Artist"].Contains("Author")) ConfigRepository.Instance()["dlcm_Artist"] = c("dlcm_Artist").Contains("]") ? c("dlcm_Artist").Replace("]", "") + "<Author>" + "]" : c("dlcm_Artist");
                if (!ConfigRepository.Instance()["dlcm_Album"].Contains("Author")) ConfigRepository.Instance()["dlcm_Album"] = c("dlcm_Album").Contains("]") ? c("dlcm_Album").Replace("]", "") + "<Author>" + "]" : c("dlcm_Adlcm_Albumrtist");
                if (!ConfigRepository.Instance()["dlcm_Lyric_Info"].Contains("Author")) ConfigRepository.Instance()["dlcm_Lyric_Info"] = c("dlcm_Lyric_Info").Contains("]") ? c("dlcm_Lyric_Info").Replace("]", "") + "<Author>" + "]" : c("dlcm_Lyric_Info");

                if (!c("dlcm_Artist").Contains("IntheWorks") && !c("dlcm_Artist").Contains("<Attributes")) ConfigRepository.Instance()["dlcm_Artist"] = c("dlcm_Artist").Contains("]") ? c("dlcm_Artist").Replace("]", "") + "<IntheWorks>" + "]" : c("dlcm_Artist");
                if (!ConfigRepository.Instance()["dlcm_Album"].Contains("IntheWorks") && !c("dlcm_Album").Contains("<Attributes")) ConfigRepository.Instance()["dlcm_Album"] = c("dlcm_Album").Contains("]") ? c("dlcm_Album").Replace("]", "") + "<IntheWorks>" + "]" : c("dlcm_Album");
                if (!ConfigRepository.Instance()["dlcm_Lyric_Info"].Contains("IntheWorks") && !c("dlcm_Lyric_Info").Contains("<Attributes")) ConfigRepository.Instance()["dlcm_Lyric_Info"] = c("dlcm_Lyric_Info").Contains("]") ? c("dlcm_Lyric_Info").Replace("]", "") + "<IntheWorks>" + "]" : c("dlcm_Lyric_Info");

                if (!ConfigRepository.Instance()["dlcm_Artist"].Contains("NOTProductionReady") && !c("dlcm_Artist").Contains("<Attributes")) ConfigRepository.Instance()["dlcm_Artist"] = c("dlcm_Artist").Contains("]") ? c("dlcm_Artist").Replace("]", "") + "<NOTProductionReady>" + "]" : c("dlcm_Artist");
                if (!ConfigRepository.Instance()["dlcm_Album"].Contains("NOTProductionReady") && !c("dlcm_Album").Contains("<Attributes")) ConfigRepository.Instance()["dlcm_Album"] = c("dlcm_Album").Contains("]") ? c("dlcm_Album").Replace("]", "") + "<NOTProductionReady>" + "]" : c("dlcm_Album");
                if (!ConfigRepository.Instance()["dlcm_Lyric_Info"].Contains("NOTProductionReady") && !c("dlcm_Lyric_Info").Contains("<Attributes")) ConfigRepository.Instance()["dlcm_Lyric_Info"] = c("dlcm_Lyric_Info").Contains("]") ? c("dlcm_Lyric_Info").Replace("]", "") + "<NOTProductionReady>" + "]" : c("dlcm_Lyric_Info");
                if (!ConfigRepository.Instance()["dlcm_Lyric_Info"].Contains("Improvements Assurance Recommendations")) ConfigRepository.Instance()["dlcm_Lyric_Info"] = c("dlcm_Lyric_Info").Contains("]") ? c("dlcm_Lyric_Info").Replace("]", "") + "<Improvements Assurance Recommendations>" + "]" : c("dlcm_Lyric_Info");
            }
            ...
            {
                data.SongInfo.SongDisplayName = CleanTitle(data.SongInfo.SongDisplayName);
                data.SongInfo.SongDisplayNameSort = CleanTitle(data.SongInfo.SongDisplayNameSort);
                data.SongInfo.Artist = CleanTitle(data.SongInfo.Artist);
                data.SongInfo.ArtistSort = CleanTitle(data.SongInfo.ArtistSort);
                data.SongInfo.Album = CleanTitle(data.SongInfo.Album);
                data.SongInfo.AlbumSort = CleanTitle(data.SongInfo.AlbumSort);
            }

            if (c("dlcm_AdditionalManipul44") == "Yes")
                data.AppId = ConfigRepository.Instance()["general_defaultappid_RS2014"];

            //Add 1st GroupNames
            if (c("dlcm_AdditionalManipul113") == "Yes" && (!Groupss.Contains("Group") || Groupss.Contains("Packing")) && (Groupss != "Beta" && !chbx_Beta) && c("dlcm_AdditionalManipul102") != "Yes")
                if (!MetaChangeActiv("ArtistSort", ConfigRepository.Instance()["dlcm_Activ_ArtistSort"]).Contains("nactive"))
                    ...
                    {
                        var grpinde = "<FirstGroupIndexAndName>";
                        if (c("dlcm_AdditionalManipul136") == "Yes" && Groupss.Contains("Weekly") && Groupss.Contains("Mothly")) grpinde = "<FirstGroupIndexDateAddedAndName>";//Index
                        if (c("dlcm_AdditionalManipul135") == "Yes") grpinde = "<FirstGroupIndexAddedDateAndName>";//Index
                        var r = ConfigRepository.Instance()["dlcm_Artist_Sort"];
                        ConfigRepository.Instance()["dlcm_ArtistSort"] = ConfigRepository.Instance()["dlcm_Artist_Sort"].Replace(grpinde, "");
                        ...
                        data.SongInfo.ArtistSort = Manipulate_strings(grpinde, 0, false, false, bassRemoved, SongRecord, "", "", chbx_Beta, true, false, cnc)
                    + data.SongInfo.ArtistSort;

                        ConfigRepository.Instance()["dlcm_Artist_Sort"] = r;
                    }

            //Add selected GroupNames
            if ((c("dlcm_AdditionalManipul134") == "Yes" || Groupss.Contains("Group") || (!Groupss.Contains("Packing")) && (Groupss != "Beta" && !chbx_Beta)) && c("dlcm_AdditionalManipul102") != "Yes")
                if (!MetaChangeActiv("ArtistSort", ConfigRepository.Instance()["dlcm_Activ_ArtistSort"]).Contains("nactive"))
                    if (!ConfigRepository.Instance()["dlcm_Artist_Sort"].Contains("GroupIndex"))
                    {
                        var grpinde = "<GroupIndexAndName>";
                        if (c("dlcm_AdditionalManipul136") == "Yes" && Groupss.Contains("Weekly") && Groupss.Contains("Mothly")) grpinde = "<GroupIndexDateAddedAndName>";//Index
                        if (c("dlcm_AdditionalManipul135") == "Yes") grpinde = "<GroupIndexAddedDateAndName>";//Index
                        var r = ConfigRepository.Instance()["dlcm_Artist_Sort"];
                        ConfigRepository.Instance()["dlcm_ArtistSort"] = ConfigRepository.Instance()["dlcm_Artist_Sort"].Replace(grpinde, "");
                        data.SongInfo.ArtistSort = r;
                        ConfigRepository.Instance()["dlcm_Artist_Sort"] = ConfigRepository.Instance()["dlcm_Artist_Sort"].Replace("<Beta>", "");
            ...
            if (ConfigRepository.Instance()["dlcm_AdditionalManipul124"] == "Yes" && c("dlcm_AdditionalManipul102") != "Yes") //make sort fields lower capitalization
            {
                data.SongInfo.SongDisplayNameSort = (data.SongInfo.SongDisplayNameSort).ToLower();
                filez.Song_Title_Sort = data.SongInfo.SongDisplayNameSort;
                data.SongInfo.ArtistSort = (data.SongInfo.ArtistSort).ToLower();
                filez.Artist_Sort = data.SongInfo.ArtistSort;
                data.SongInfo.AlbumSort = (data.SongInfo.AlbumSort).ToLower();
                filez.Album_Sort = data.SongInfo.AlbumSort;
            }

            if (ConfigRepository.Instance()["dlcm_AdditionalManipul2"] == "Yes" && c("dlcm_AdditionalManipul102") != "Yes")
            ...
            + ";" + filez.BasedOn_CF + ";" + filez.BasedOn_Tabs + ";" + filez.Spotify_Song_ID + ";" + filez.Description.Replace("\v", "\n") + ";" + filez.ToDos.Replace("\v", "\n")
            + ";" + filez.ToneDetails.Replace("\v", "\n") + ";" + "Yes"
            + ";" + ";" + "Yes" + ";" + "Yes" + ConfigRepository.Instance()["dlcm_EoFPath"]
            + ";" + ";" + filez.PackingDate + ";" + filez.UpdateVersionDate + ";" + filez.BasedOn_GP
            + ";" + filez.Song_Title + ";" + filez.Artist + ";" + filez.Album + ";" + filez.Description.Replace("\v", "\n") + ";" + filez.BasedOn_RB
            + "Author,DLC_Name,TrackNo,Version,CDLCID,txt_EoFPath,YBLink,BasedOnYB,BasedOnCF,TabLinks,Spotify,Description,toDo" +
            ",ToneDetails,SaveInVerisonInfo,SaveInDB,SaveRemotely,SaveRemotelyPath,PackageDate,UpdateDate,BasedOn_GP,Songtitle,Artist,Album,PackageDetails,BasedOn_RB" +
            ",Has_Slide,CF_Author,Has_Acoustic,ProductionReady;";

            var txt = "ArtistSort" + MetaChangeActiv("ArtistSort", ConfigRepository.Instance()["dlcm_Activ_ArtistSort"]) + data.SongInfo.ArtistSort
             ...
             + " \n" + "Package internal Comment: " + ((ConfigRepository.Instance()["dlcm_GlobalTempVariable"] + filez.PackageDetails) == null || ConfigRepository.Instance()["dlcm_AdditionalManipul102"] == "Yes" ? "" : (ConfigRepository.Instance()["dlcm_GlobalTempVariable"] + filez.PackageDetails))
         + "----";
            ConfigRepository.Instance()["dlcm_Global2TempVariable"] = CleanInvalidXmlChars(txt);
            //IntheWorksWDetails
            ...
            {
                PackageAuthor = ConfigRepository.Instance()["dlcm_AdditionalManipul102"] == "Yes" ? "Ubisoft" : filez.Author,
                PackageVersion = filez.Version,
                PackageComment = ConfigRepository.Instance()["dlcm_AdditionalManipul102"] == "Yes" ? "" : ConfigRepository.Instance()["dlcm_GlobalTempVariable"] + filez.Comments
            };
        ...
        public static void FixPreview(MainDBfields filez, DateTime timestamp)
        {
            ...
            var t = c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(filez.oggPreviewPath);
        ...
        public static void GeneratePackingSummary(string pack, string metainfo, int brkn, OleDbConnection cnb, int total
            , int norows, SQLite.SQLiteConnection cnc, string samplegrphead)
        {
            //GenerateSumamrty
            /*var total = 0;*/
            var PS3P = 0; var PCP = 0; var MACP = 0; var XBOXP = 0; var PS4P = 0; var FailedP = 0; var ListP = "\n"; ; var ListNP = "\n";
            var PS3F = 0; var PCF = 0; var MACF = 0; var XBOXF = 0; var PS4F = 0; var cpy = 0;
            ...
            MACP = GetNoRecords(dmz, cnb, cnc); //dmz.Tables[0].Rows[0].ItemArray[0].ToString().ToInt32();
                                                //dmz.Dispose(); dmz = new DataSet(); dmz = SelectFromDB("Pack_AuditTrail",
            dmz = "SELECT ID FROM Pack_AuditTrail where Pack=\"" + pack + "\" AND UCASE(Platform)=\"PS4\"";
            PS4P = GetNoRecords(dmz, cnb, cnc);
            //if (dmz.Tables.Count > 0) if (dmz.Tables[0].Rows.Count > 0) 
            XBOXP = GetNoRecords(dmz, cnb, cnc);
            ...
            dmz = "SELECT ID FROM Pack_AuditTrail where Pack=\"" + pack + "\" AND UCASE(Platform)=\"PS4\" AND FTPed=\"Yes\"";
            PS4F = GetNoRecords(dmz, cnb, cnc);
            ...
            for (var j = 0; j < noOfRecs; j++)
            {
                ...
                ListNP += j + ". " + gmz.Tables[0].Rows[j].ItemArray[0].ToString() + "-" + (noOfRecu > 0 ? dnz.Tables[0].Rows[0].ItemArray[0].ToString() : "-") + "-" + (noOfRecu > 0 ? dnz.Tables[0].Rows[0].ItemArray[1].ToString() : "-") + "-" +
            ...
            //}
            var cm = new DataSet(); var ListPaths = ""; cm = SelectFromDB("Pack_AuditTrail", "SELECT PackPath FROM Pack_AuditTrail where Pack=\"" + pack + "\" GROUP BY PackPath", null, cnb, cnc);
            var noOfRech = GetNoRec(cm, cnb, cnc);//dmz.Tables.Count == 0 ? 0 : cmz.Tables[0].Rows.Count;
            for (var k = 0; k < noOfRech; k++)
                //{
                ListPaths += k + ". " + cm.Tables[0].Rows[k].ItemArray[0].ToString() + "\n";

            //Show Summary window
            var summary = "Packed/(Copied/FTPed) Summary(PackID: " + pack + " of processed " + total + " of " + norows + " selected songs )" +
                (c("dlcm_AdditionalManipul113") == "Yes" && (c("dlcm_Groups").Contains("MultiSelect")) ? "\n\nAdded extra song to mark the groupping name\n" : "") +
                 (c("dlcm_AdditionalManipul64") == "Yes" ? "\n\nSelected to Copy Last Packed" : "") +
                 "\nCopy location" + (noOfRech > 1 ? "(s)" : "") + " :" + ListPaths +//cmz.Tables[0].Rows[0].ItemArray[0].ToString() +
                "\n\nFailed at packing: " + FailedP +
                "\nPacked PS3: " + PS3P + "/" + PS3F +
               "\nPacked PC: " + PCP + "/" + PCF +
                "\nPacked MAC: " + MACP + "/" + MACF +
                "\nPacked XBOX360: " + XBOXP + "/" + XBOXF +
                "\nPacked PS4: " + PS4P + "/" + PS4F +
                "\nPacked All: " + (PS3P + PCP + MACP + XBOXP + PS4P) + "/" + (PS3F + PCF + MACF + XBOXF + PS4F) +
                ...
                (c("dlcm_AdditionalManipul64") == "Yes" ? "\n\nSample of Meta info:\n" + "\t" + metainfo.Replace("\n", "\n\t") : "no SAmple of Meta as Last Pack selected") +
                "\n\nSample of Group info added into headers Headers:\n" + (samplegrphead == "" ? "N/A" : samplegrphead) +
                "\n\nFailed at packing (" + pack + "): " + "\n" + ListNP +
                ("\n\nListP (" + pack + "):\n" + ListP);
            ErrorWindow frm9 = new ErrorWindow(summary, "", "Summary of the Mass-Repack process", false, false, true, "", "", "", false);
            frm9.Show();
            ErrorWindow frm10 = new ErrorWindow(GetMEtaAfterPacking(pack, AppWD, "SELECT * FROM Pack_AuditTrail where Pack=\"" + pack + "\"")
                , "", "Meta-tag List of the Mass-Repack process", false, false, true, "", "", "", true);
            frm10.Show();
        ...
        public static string AddTrackStart2Lyrics(string SongID, OleDbConnection cnb, bool arrangoff, SQLite.SQLiteConnection cnc)
        {
            ...
            try
            {
                ...
                for (i = 0; i <= noOfRec - 1; i++)
                {
                    ...
                    if (RouteMask == "Lead" || RouteMask == "Bass" || RouteMask == "Rhythm" || RouteMask == "Combo")
                ...
                if (XMLFilePath != "")
                            ...
                            if (RouteMask == "Lead" || RouteMask == "Bass" || RouteMask == "Rhythm" || RouteMask == "Combo")
                            {
                                ...
                                for (j = 1; j < xmlContent.Vocal.Length; j++)
                                {
                                        ...
                                        && changeaplied == false)
                                    {
                                        ...
                                        changeaplied = true;
                                        insertedinlyric++;
                                        sLyric += xmlContent.Vocal[j - 1].Lyric;
                                    }
                    ...
                    {
                        var tsst = "Error add lyric ..." + ex.Message; UpdateLog(DateTime.Now, tsst, false, c("dlcm_TempPath"), "", "", null, null);
                    }
            ...
            catch (Exception ex) { var tgst = "Error ..." + ex.Message; UpdateLog(DateTime.Now, tgst, false, c("dlcm_TempPath"), "", "", null, null); }
                    ...
                    , string Is_Acoustic, string Is_Live, string Live_Details, string Is_Multitrack, string Is_Original, OleDbConnection cnb, SQLite.SQLiteConnection cnc, MainDBfields[] SongRecord, bool chbx_Beta, bool arrangoff)
        {
            ...
            var tgst = "";
            var sdetails = "[";
            sdetails = (Comments == "" ? "" : "Comment: " + Comments);
            ...
            if (noOfRec > 0)
            {
                ...
                sdetails = sdetails.Replace("  ", " ").TrimEnd().Replace("(", "").Replace(")", "").Replace("[", "").Replace("]", "").Replace(":", "_");

                //manipulating the info Artist& Album & Lyrics info
                var r1 = ConfigRepository.Instance()["dlcm_Lyric_Info"];
                if (c("dlcm_AdditionalManipul132") == "Yes")
                {
                    if (!ConfigRepository.Instance()["dlcm_Lyric_Info"].Contains("Author")) ConfigRepository.Instance()["dlcm_Lyric_Info"] = c("dlcm_Lyric_Info").Contains("]") ? c("dlcm_Lyric_Info").Replace("]", "") + "<Author>" + "]" : c("dlcm_Lyric_Info");

                    if (!ConfigRepository.Instance()["dlcm_Lyric_Info"].Contains("IntheWorks")) ConfigRepository.Instance()["dlcm_Lyric_Info"] = c("dlcm_Lyric_Info").Contains("]") ? c("dlcm_Lyric_Info").Replace("]", "") + "<IntheWorks>" + "]" : c("dlcm_Lyric_Info");

                    if (!ConfigRepository.Instance()["dlcm_Lyric_Info"].Contains("NOTProductionReady")) ConfigRepository.Instance()["dlcm_Lyric_Info"] = c("dlcm_Lyric_Info").Contains("]") ? c("dlcm_Lyric_Info").Replace("]", "") + "<NOTProductionReady>" + "]" : c("dlcm_Lyric_Info");
                ...
                if (c("dlcm_AdditionalManipul132") == "Yes") ConfigRepository.Instance()["dlcm_Lyric_Info"] = r1;
                ...
                catch (Exception ex) { tgst = "Error ..." + ex.Message; UpdateLog(DateTime.Now, tgst, false, c("dlcm_TempPath"), "", "", null, null); }
                ...
                try
                {
                    ...
                    if (tgst.IndexOf("Error") >= 0)
                        ...
                        catch (Exception ex) { tgst = "Error at backup restore..." + ex.Message; UpdateLog(DateTime.Now, tgst, false, c("dlcm_TempPath"), "", "", null, null); }
                }
                catch (Exception ex) { tgst = "Error ..." + ex.Message; UpdateLog(DateTime.Now, tgst, false, c("dlcm_TempPath"), "", "", null, null); }
            }
            else UpdateLog(DateTime.Now, "Error: no Arrangement record despite Vocal existing flagging", false, c("dlcm_TempPath"), "", "", null, null);

            return sdetails + " " + scomments;
        }


        public static string AddLyricsWStuff(string SongID, string Comments, string Group, string Has_DD, string bassRemoved, string Bass_Has_DD, string Author
                    //, string Is_Acoustic, string Is_Live, string Live_Details, string Is_Multitrack, string Is_Original, OleDbConnection cnb, SQLiteConnection cnz, MainDBfields[] SongRecord, bool chbx_Beta, bool arrangoff)
                    , string Is_Acoustic, string Is_Live, string Live_Details, string Is_Multitrack, string Is_Original, OleDbConnection cnb, SQLite.SQLiteConnection cnc, MainDBfields[] SongRecord, bool chbx_Beta, bool arrangoff)
        {
            var ST = "";
            ...
            if (noOfRec > 0)
            {
                ...
                if (c("dlcm_AdditionalManipul132") == "Yes")
                {
                    ...
                    if (!ConfigRepository.Instance()["dlcm_Lyric_Info"].Contains("ProductionReady")) ConfigRepository.Instance()["dlcm_Lyric_Info"] = c("dlcm_Lyric_Info").Contains("]") ? c("dlcm_Lyric_Info").Replace("]", "") + "<ProductionReady>" + "]" : c("dlcm_Lyric_Info");
                ...
                //create a placehoder lyrics file

                //try
                //{
                //    if (File.Exists(AppWD + "\\..\\No_vocals.xml")) File.Copy(AppWD + "\\..\\No_vocals.xml", ST.Replace(".xml", "_No_vocal.xml"), true);
                //    else System.Windows.Forms.MessageBox.Show("No vocal template");
                //}
                //catch (Exception ex) { tgst = "Error ..." + ex.Message; UpdateLog(DateTime.Now, tgst, false, c("dlcm_TempPath"), "", "", null, null); }
                ...
                Vocals newLyrics = null; tz = sdetails;
                try
                {
                    newLyrics = Vocals.LoadFromFile(AppWD + "\\..\\No_vocals.xml");
                    var size = int.Parse(Math.Ceiling(decimal.Parse(((sdetails.Length + int.Parse(ft.ToString())) / ft).ToString())).ToString());
                    for (i = 0; i < (ft); i++)
                    {
                        var txt = sdetails.Length >= (size - 1) ? sdetails.Substring(0, size - 1) : sdetails.Substring(0, sdetails.Length);
                        newLyrics.Vocal[i].Lyric = "" + txt.Trim().TrimEnd() + "+";
                    ...
                    using (var stream = File.Open(ST.Replace(".xml", "_No_v0cal.xml").Replace("bass", "").Replace("lead", "").Replace("rhythm", "").Replace("combo", ""), FileMode.Create))
                        newLyrics.Serialize(stream);

                    ////write new file
                    //using (var stream = File.Open(ST.Replace(".xml", "_No_vocal.xml"), FileMode.Create))
                    //    newLyrics.Serialize(stream);
                    tsst = "End add stuff to lyrics ..."; timestamp = UpdateLog(timestamp, tsst, true, c("dlcm_TempPath"), "", "", null, null);
                }
                catch (Exception ex) { tgst = "Error ..." + ex.Message; UpdateLog(DateTime.Now, tgst, false, c("dlcm_TempPath"), "", "", null, null); }
            }
            else UpdateLog(DateTime.Now, "Error: no Arrangement record to use to create missing empty Lyric/Vocal file", false, c("dlcm_TempPath"), "", "", null, null);

            ApplyLyric(ST.Replace(".xml", "_No_v0cal.xml").Replace("bass", "").Replace("lead", "").Replace("rhythm", "").Replace("combo", "")
                , System.IO.Path.GetDirectoryName(ST.Replace(".xml", "_No_v0cal.xml").Replace("bass", "").Replace("lead", "").Replace("rhythm", "").Replace("combo", "")).Replace("\\songs\\arr", ""), cnb,
                     "Pc", SongID, true, cnc, true);
        ...
        public static void FixBitrate(object sender, DoWorkEventArgs e)
        {
            ...
            if (g.IndexOf("\\\\") > -1 || gg.IndexOf("\\\\") > -1 || c("dlcm_AdditionalManipul6") == "Yes")
            {
                try
                {
                    ...
                    File.Copy(AudioPath, c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(AudioPath), true);
                    File.Copy(aa, c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(aa), true);
                    AudioPath = c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(AudioPath);
                    File.Copy(audioPreviewPath, c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(audioPreviewPath), true);
                    File.Copy(bb, c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(bb), true);
                    audioPreviewPath = c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(audioPreviewPath);
                    remote = true;
                }
                catch (Exception ee)
                {
            ...
            try
            {
                if (d1.Split(';')[0] == "1")
                {
                    ...
                    foreach (string wav_name in Directory.GetFiles(System.IO.Path.GetDirectoryName(AudioPath), "*.wav", System.IO.SearchOption.AllDirectories))
                    {
            ...
            catch (Exception ee)
            {
                ...
                catch (Exception Ex) { err = "Erro ..." + Ex.Message; UpdateLog(DateTime.Now, err, false, c("dlcm_TempPath"), "", "", null, null); }
            }
            try
            {
                if (remote)
            ...
            {
                err = "Erro at REstore TH ..." + Ex5; timestamp = startT; UpdateLog(timestamp, err, false, tmpPath, multithreadname, windw, null, null);
                return;
            }
            ...
            {
                DeleteFile(c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(AudioPath), true);
                DeleteFile(c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(audioPreviewPath), true);
                DeleteFile(c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(oggPath), true);
                DeleteFile(c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(oggPreviewPath), true);
            }

            if (err != "")
            {
                var cmdupd = "UPDATE Main Set FilesMissingIssues =\"" + timestamp + " Issues at audiofix" + err.ToLower().Replace("error", "erro") + "\" WHERE ID =" + ID;
                DataSet dus = new DataSet(); dus = UpdateDB("Main", cmdupd + ";", cnb, cnc);
            }
        }

        public static void FixPreviewMT(object sender, DoWorkEventArgs e)
        {
            var startT = DateTime.Now;
            string logPath = ConfigRepository.Instance()["dlcm_LogPath"] == "" ? c("dlcm_TempPath") + "\\0_log" : ConfigRepository.Instance()["dlcm_LogPath"];
            string tmpPath = c("dlcm_TempPath");
            ...
            var tsst = "Start FixPreview TH ..."; DateTime timestamp = startT; UpdateLog(timestamp, tsst, false, tmpPath, "1", windw, null, null);//multithreadname
            ...
            try
            {
                if (g.IndexOf("\\\\") > -1 || gg.IndexOf("\\\\") > -1 || c("dlcm_AdditionalManipul6") == "Yes")
                {
                    File.Copy(t, c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(t), true);
                    t = c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(t);
                    if (File.Exists(tt)) File.Copy(tt, c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(tt), true);
                    tt = c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(tt);
                    remote = true;
                }
            }
            catch (Exception Ex5)
            ...
            try
            {
                try
                {
                    ...
                    if (File.Exists(t))
                        using (var DDC = new Process())
                        {
                            ...
                            if (DDC.ExitCode == 0 && File.Exists(tt))
                            {
                                ...
                                if (!File.Exists(tt.Replace(".ogg", ".wem")))
                                {
                                    err = "1erro @ogg cut..." + tt; timestamp = startT; UpdateLog(timestamp, err, false, tmpPath, multithreadname, windw, null, null);
                                    //if (!File.Exists(gg)) File.Move(gg + ".orig", gg);
                                }
                            }
                            else
                            {
                                err = "2erro @ogg cut..." + tt; timestamp = startT; UpdateLog(timestamp, err, false, tmpPath, multithreadname, windw, null, null);
                    ...
                    //Delete any Wav file created..by....?ccc
                    foreach (string wav_name in Directory.GetFiles(System.IO.Path.GetDirectoryName(OggPath), "*.wav", System.IO.SearchOption.AllDirectories))
                    {
                        DeleteFile(wav_name, false);
                    }
                }
                ...
                {
                    err = "Erro at FixPreview TH ..." + Ex.Message; timestamp = startT; UpdateLog(timestamp, err, false, tmpPath, multithreadname, windw, null, null);
            ...
            {
                err = "Erro at restoring old FixPreview ..." + Ex.Message; timestamp = startT; UpdateLog(timestamp, err, false, tmpPath, multithreadname, windw, null, null);
            ...
            else if (File.Exists(audioPreviewPath + ".orig")) File.Move(AudioPath + ".orig", AudioPath);
            else UpdateLog(timestamp, "Erro at restoring old AudioPath..." + AudioPath, false, tmpPath, multithreadname, windw, null, null);

            if (File.Exists(audioPreviewPath)) { if (File.Exists(audioPreviewPath + ".orig")) DeleteFile(audioPreviewPath + ".orig", false); }
            else if (File.Exists(audioPreviewPath + ".orig")) File.Move(audioPreviewPath + ".orig", audioPreviewPath);
            else UpdateLog(timestamp, "Erro at restoring old audioPreviewPath..." + audioPreviewPath, false, tmpPath, multithreadname, windw, null, null);

            if (File.Exists(OggPath)) { if (File.Exists(OggPath + ".orig")) DeleteFile(OggPath + ".orig", false); }
            else if (File.Exists(OggPath + ".orig")) File.Move(OggPath + ".orig", OggPath);
            else UpdateLog(timestamp, "Erro at restoring old OggPath..." + OggPath, false, tmpPath, multithreadname, windw, null, null);

            if (File.Exists(tr)) { if (File.Exists(tr + ".orig")) DeleteFile(tr + ".orig", false); }
            else if (File.Exists(tr + ".orig")) File.Move(tr + ".orig", tr);
            else UpdateLog(timestamp, "Erro at restoring old OggPathPreview..." + tr, false, tmpPath, multithreadname, windw, null, null);
            ...
            if (c("dlcm_AdditionalManipul6") == "Yes")
            {
                ...
                DeleteFile(c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(audioPreviewPath), true);
                DeleteFile(c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(OggPath), true);
                DeleteFile(c("dlcm_TempPath") + "\\0_temp\\" + System.IO.Path.GetFileName(tr), true);
            }
        ...
        public static string GetTranslation_And_Correction(string dbp, System.Windows.Forms.ProgressBar pB_ReadDLCs, OleDbConnection cnb
        ...
        public static string OneTranslation_And_Correction(string dbp, System.Windows.Forms.ProgressBar pB_ReadDLCs, OleDbConnection cnb
        ...
        public static void Translation_And_Correction(string dbp, System.Windows.Forms.ProgressBar pB_ReadDLCs, OleDbConnection cnb, System.Windows.Forms.RichTextBox rtxt_StatisticsOnReadDLCs, SQLite.SQLiteConnection cnc)
        ...
        public static string ManuallyApplyTransalations(OleDbConnection cnb, System.Windows.Forms.ProgressBar pB_ReadDLCs, System.Windows.Forms.RichTextBox rtxt_StatisticsOnReadDLCs, SQLite.SQLiteConnection cnc)
        {
            //Multiply
        ...
        public static string Multiplycorrections(OleDbConnection cnb, System.Windows.Forms.ProgressBar pB_ReadDLCs, System.Windows.Forms.RichTextBox rtxt_StatisticsOnReadDLCs, SQLite.SQLiteConnection cnc)
        {
        ...
        public static bool ShowDialogue(string d, string toreplace, int noofstuff, string verb, int nobuttons)
        {
            ...
            d = noofstuff > -1 ? d.Replace(toreplace, " " + verb + " " + noofstuff.ToString() + " items, ") + " " : d;
        ...
        public static string ApplyArtistAutoGroup(OleDbConnection cnb, System.Windows.Forms.ProgressBar pB_ReadDLCs, System.Windows.Forms.RichTextBox rtxt_StatisticsOnReadDLCs, SQLite.SQLiteConnection cnc)//(string DBs_Path)//, string AlbumArt, string Artist, string Albums)
        {
            ...
            if (norec > 0)
                foreach (DataRow defaultgrp in df.Tables[0].Rows)
                {
                    ...
                    tsst = "9-1/12 Applied " + norecs + "/" + norec + " " + artist_c + " Auto Group '" + grp + "' grp"; UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), "", "", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
                }
            ...
            //DefaultGroup
            DataSet dzf = new DataSet();
            selstand = "SELECT DISTINCT Groupz,Comments FROM Groups WHERE Type=\"DefaultGroup\"";
            dzf = SelectFromDB("Groups", selstand, "", cnb, cnc);
            norec = GetNoRec(dzf, cnb, cnc);//df.Tables.Count > 0 ? df.Tables[0].Rows.Count : 0;
            i = 0; tsst = ""; norecs = 0;
            pB_ReadDLCs.Maximum = norec; pB_ReadDLCs.Value = 0;
            if (norec > 0)
                foreach (DataRow defaultgrp in dzf.Tables[0].Rows)
                {
                    string grp = defaultgrp.ItemArray[0].ToString();
                    string artist_c = defaultgrp.ItemArray[1].ToString();
                    //string artist_d = defaultgrp.ItemArray[2].ToString();
                    ...
                    i++;
                    DataSet dfz = new DataSet();
                    selstand = "SELECT ID FROM Main WHERE ID NOT IN (" + IDs + ") AND (Artist =\"" + artist_c + "\" );";/*OR Artist =\"" + artist_d + "\"*/
                    dfz = SelectFromDB("Main", selstand, "", cnb, cnc); /*Artist_AutoGroup /*, Artist_AutoGroup,*/
                    norecs = GetNoRec(dfz, cnb, cnc);//dfz.Tables.Count > 0 ? dfz.Tables[0].Rows.Count : 0;
                    if (norecs > 0)
                    {
                    ...
                    pB_ReadDLCs.Maximum = norec; pB_ReadDLCs.Value = i;
                    tsst = "9-2/12 Applied " + norecs + "/" + norec + " " + artist_c + " Auto Group '" + grp + "' grp"; UpdateLog(timestamp, tsst, false, c("dlcm_TempPath"), "", "", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
                }
        ...
        //pseudocode:
        public static void ApplyArtistAutoGroup_old(OleDbConnection cnb, System.Windows.Forms.ProgressBar pB_ReadDLCs, System.Windows.Forms.RichTextBox rtxt_StatisticsOnReadDLCs, SQLite.SQLiteConnection cnc)//(string DBs_Path)//, string AlbumArt, string Artist, string Albums)
        {
            var timestamp = DateTime.Now;//.ToString("yyyyMMdd HHmmssfff");
        ...
        public static string CleanAlternates_and_MultiplyGroups(OleDbConnection cnb, SQLite.SQLiteConnection cnc, System.Windows.Forms.ProgressBar pB_ReadDLCs)//, string grps, bool inclexcl(string DBs_Path)//, string AlbumArt, string Artist, string Albums)
        {
            var timestamp = DateTime.Now;//.ToString("yyyyMMdd HHmmssfff");
            var tsst = "";
            ...
            {
                tsst = "Erro ..." + ex.Message; timestamp = UpdateLog(DateTime.Now, tsst, false, c("dlcm_TempPath"), "", "", null, null);
            }
        ...
        public static string MultiplyMetaAlbum(OleDbConnection cnb, SQLite.SQLiteConnection cnc, System.Windows.Forms.ProgressBar pB_ReadDLCs)//, string grps, bool inclexcl(string DBs_Path)//, string AlbumArt, string Artist, string Albums)
        {
            var timestamp = DateTime.Now;//.ToString("yyyyMMdd HHmmssfff");
                                         //var tsst = "";   
        ...
        public static bool copyallfilesinatemplate(MainDBfields SongRecord, int j, System.Windows.Forms.ProgressBar pB_ReadDLCs, RichTextBox rtxt_StatisticsOnReadDLCs
        ...
        {
            var timestamp = UpdateLog(DateTime.Now, j + " loading..." + System.IO.Path.GetFileName(SongRecord.Folder_Name), true, c("dlcm_TempPath"), "", "DLCManager", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
            ...
            var artpd = System.IO.Path.GetDirectoryName(artp);
            var songanddlcname = System.IO.Path.GetFileName(artp).Replace("album", "song").Replace("_128.dds", "").Replace("_256.dds", "").Replace("_64.dds", "");
            listofdlcs += songanddlcname;
            if (listofdlcs.IndexOf(";" + songanddlcname + ";") > 0)
                songanddlcname += j.ToString();
            var dlcname = System.IO.Path.GetFileName(artp).Replace("album_", "").Replace("_256.dds", "");
            ...
            FileCopy(artp, dest + "\\" + "gfxassets\\album_art\\" + System.IO.Path.GetFileName(artp), true, j, false);
            FileCopy(artp.Replace("_256.dds", "_128.dds"), dest + "\\" + "gfxassets\\album_art\\" + System.IO.Path.GetFileName(artp.Replace("_256.dds", "_128.dds")), true, j, false);
            FileCopy(artp.Replace("_256.dds", "_64.dds"), dest + "\\" + "gfxassets\\album_art\\" + System.IO.Path.GetFileName(artp.Replace("_256.dds", "_64.dds")), true, j, false);
            if (!File.Exists(dest + "\\" + "gfxassets\\album_art\\" + System.IO.Path.GetFileName(artp)) || !File.Exists(dest + "\\" + "gfxassets\\album_art\\" + System.IO.Path.GetFileName(artp.Replace("_256.dds", "_128.dds"))) || !File.Exists(dest + "\\" + "gfxassets\\album_art\\" + System.IO.Path.GetFileName(artp.Replace("_256.dds", "_64.dds"))))
            ...
            for (int k = 0; k < norec; k++)
            {
                ...
                if (File.Exists(xml.Replace("songs\\arr", "manifests\\songs_dlc_songs_psarc_rs2014_pc\\") + ".json")
                    && (dest + "\\" + "manifests\\songs_dlc_" + dlcname + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".json").Length > 250)
                    continue;
                else if (File.Exists(xml.Replace("songs\\arr", "manifests\\songs\\") + ".json") &&
                    (dest + "\\" + "manifests\\songs_dlc_" + dlcname + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".json").Length > 250)
                    continue;
                else if ((dest + "\\" + "manifests\\songs_dlc_" + dlcname + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".json").Length > 250)
                    continue
                        ;
                ...
                FileCopy(xml + ".xml", dest + "\\" + "songs\\arr\\" + System.IO.Path.GetFileName(xml) + ".xml", true, j, false);

                if (!File.Exists(dest + "\\" + "songs\\arr\\" + System.IO.Path.GetFileName(xml) + ".xml"))
                    FileCopy((xml + ".xml").Replace(System.IO.Path.GetDirectoryName(SongRecord.Folder_Name), "songs_psarc_RS2014_Pc"), dest + "\\" + "songs\\arr\\" + System.IO.Path.GetFileName(xml) + ".xml", true, j, false);
                if (!File.Exists(dest + "\\" + "songs\\arr\\" + System.IO.Path.GetFileName(xml) + ".xml"))
                ...
                if (xml.IndexOf("showlights") < 0)
                {
                    ...
                    var gb = dest + "\\" + "songs\\bin\\" + ReturnPlatformFolder(format) + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".sng";

                    FileCopy(xml.Replace("songs\\arr", "songs\\bin\\" + ReturnPlatformBINFolder(sourceformat.ToLower())) + ".sng"
                        , dest + "\\" + "songs\\bin\\" + ReturnPlatformFolder(format) + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".sng", true, j, true);
                    if (!File.Exists(dest + "\\" + "songs\\bin\\" + ReturnPlatformFolder(format) + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".sng"))
                    ...
                    if (File.Exists(xml.Replace("songs\\arr", "manifests\\songs_dlc_songs_psarc_rs2014_pc\\") + ".json"))
                        FileCopy(xml.Replace("songs\\arr", "manifests\\songs_dlc_songs_psarc_rs2014_pc\\") + ".json"
                            , dest + "\\" + "manifests\\songs_dlc_" + dlcname + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".json", true, j, true);
                    else if (File.Exists(xml.Replace("songs\\arr", "manifests\\songs\\") + ".json"))
                        ...
                        FileCopy(xml.Replace("songs\\arr", "manifests\\songs_dlc_" + dlcname) + ".json" //songs_dlc_songs_psarc_rs2014_pc
                            , dest + "\\" + "manifests\\songs_dlc_" + dlcname + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".json", true, j, true);
                    if (!File.Exists(dest + "\\" + "manifests\\songs_dlc_" + dlcname + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".json") && !File.Exists(dest + "\\" + "manifests\\songs_dlc_" + dlcname + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".json") && !File.Exists(dest + "\\" + "manifests\\songs_dlc_" + dlcname + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".json"))
                        timestamp = UpdateLog(DateTime.Now, " error at prep JSON file...: " + dest + "\\" + "manifests\\songs_dlc_" + dlcname + "\\" + System.IO.Path.GetFileNameWithoutExtension(xml + ".xml") + ".json", true, c("dlcm_TempPath"), "", "DLCManager", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
                    else
        ...
        static public void Format_ASCII()
        {
            ErrorWindow frm1 = new ErrorWindow("Paste the ASCI tab you need to expand (e.g. mutiply as pe x2 indication" +
                ", consolidate multiple lines into 1 long) / process:\n" +
                "Money Tab by The Beaches \r\n[Intro]\r\ne|------------------------------------------------------------------------------------------------------------|Guitar 1\r\nB|------------------------------------------------------------------------------------------------------------|\r\nG|----------------------------------------------------9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-|\r\nD|------------------------------------9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-9-|\r\nA|--7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-7-|\r\nE|------------------------------------------------------------------------------------------------------------|\r\n[Riff]\r\ne|----------------------------------------------------------------------------------------------------|\r\nB|----------------------------------------------------------------------------------------------------|Guitar2\r\nG|--------------------------------------------------5-------------------------------------------------|\r\nD|---------------------------7-5-7-5-7-5---7-5-7-5-7---7-5--------------------------------------------|\r\nA|-7-5-7-5-7-5--7-5-7-5-7-5---------------------------------------------------------------------------| X2\r\nE|----------------------------------------------------------------------------------------------------|\r\n"
                , "", "Process / Expand ASCII tabulature to GuitarPro Import", true, false, false, "Import ASCII"
                , "", "", false);
            frm1.ShowDialog();
            if (frm1.erorrfeedback is not null)
            {
                //clean a little ASCII
                var t = frm1.erorrfeedback;
                t = t.Replace("|\n\n", "|\naaa\n");
                t = t.Replace("|\n \n", "|\naaa\n");
                t = t.Replace("|\n\t\n", "|\naaa\n");
                t = t.Replace("\t", " ");
                ...
                t = t.Replace("\n\n", "\n").Replace("\n\n", "\n").Replace("\n\n", "\n").Replace("\n\n", "\n").Replace("\n\n", "\n");
                t = t.Replace("\n \n", "\n");
                t += "\n" + "\n" + "\n" + "\n" + "\n" + "\n" + "\n" + "\n" + "\n";//add7+ end of line not to have multiplier gen fail

                string[,] ag = new string[10000, 10];
                var instr = 1; string[] a = t.Split('\n');
                int nolines = a.Length;
                for (var i = 1; i <= nolines; i++) ag[i, instr] = a[i - 1]; //read ASCII into a variable

                ag = ConsolidateTxtLinesinto1(ag, instr, nolines);//further clean of any 2 lines of txt between notes should be consolid in 1
                nolines = ag[0, 0].ToInt32();

                string[,] neck = new string[11, 4];
                string[,] tracks = new string[10, 10];

                CheckASCIITrack(ag, instr, nolines); //do some validations, show some messages if not right

                string[] arrang = GetNoOfASCIIInstr(ag, nolines);

                tracks = GetASCIITrack(ag, arrang, nolines);
                if (tracks is null)
                {
                    ErrorWindow frm3 = null; var txt = "";
                    for (var j = 0; j < nolines; j++) txt += j.ToString().PadRight(4) + ": " + tracks[j, instr] + "\n";
                    frm3 = new ErrorWindow(txt, "", "", false, true, true, "", "Stop", "OK", true);
                    frm3.ShowDialog();
                }

                //temp show the split fo tracks :)

                //row 0 sections
                //row 1-10 strings
                //column 1-3 content per instrument; atm hardcoded for 1 instrument per file/txt pasted
                // ignore column 0 :)
                var line = false; var strng = 0; var cord = ""; var multipl = 0;

                for (instr = 1; instr < 10; instr++)
                    for (var i = 1; i <= nolines; i++)
                    {
                        cord = ag[i, instr].Trim();
                        //decide if a line with notes else continue
                        if (ag[i, instr].Contains("|"))
                        {
                            if (!line) line = true;
                            //ToDo: GetInstrument(); atm hardcoded for 1 instrument per file/txt pasted
                            strng = GetASCIIString(cord, tracks, instr, nolines);
                            multipl = multipl > 0 ? multipl : GetASCIIMultiplier(ag, i, i + 6 - strng, instr, nolines);
                            if (multipl == -1) return;
                            for (var j = 0; j < multipl; j++)
                                neck[strng, instr] += cord.Substring(cord.IndexOf("|") + 1).Replace("x" + multipl, "").Trim();
                        }
                        else
                        {
                            line = false; strng = 1;
                            ...
                            //Get multiplier
                            multipl = GetASCIIMultiplier(ag, i + 1, i + 1 + 6 - strng, instr, nolines);
                            if (multipl == -1) return;
                            //Add section name
                            if (i + 1 < nolines) if (ag[i + 1, instr].Contains("|"))
                                for (var j = 1; j <= multipl; j++)
                                {
                                    neck[0, instr] += cord.PadRight(ag[i + 1, instr].Replace("x" + multipl, "").Trim().Length - 2);/*- cord.Length*/
                                    cord = cord.PadRight(ag[i, instr].Trim().Length - 2);
                                }
                        }
                    }

                var tt = "";
                for (instr = 1; instr < 10; instr++) tt = tracks[0, instr] + "|" + neck[0, instr] + "\n" + tracks[1, instr] + "|" + neck[1, instr] + "\n" + tracks[2, instr] + "|" + neck[2, instr] + "\n" + tracks[3, instr] + "|" + neck[3, instr] + "\n" +
                        tracks[4, instr] + "|" + neck[4, instr] + "\n" + tracks[5, instr] + "|" + neck[5, instr] + "\n" + tracks[6, instr] + "|" + neck[6, instr] + "\n" + tracks[7, instr] + "|" + neck[7, instr];
                ErrorWindow frm2 = new ErrorWindow(tt, "", "Result of the Process / Expand ASCII tabulature to GuitarPro Import:", true, false, false, "Okey", "", "", false);
                frm2.ShowDialog();
            }
        }

        static private string[,] ConsolidateTxtLinesinto1(string[,] ag, int instr, int nolines)
        {
            //further clean of any 2 lines of txt between notes should be consolid in 1
            for (var i = 1; i <= nolines; i++)
                if (!ag[i, instr].Contains("|"))/*&& (ag[i, instr].IndexOf("|") == 0 || ag[i, instr].IndexOf("|") > 3)*/
                    //ag[i, instr] = ag[i, instr].Replace("|", "");
                    if (i > 2) if (!ag[i - 1, instr].Contains("|"))
                    {
                        ag[i - 1, instr] += ag[i, instr];
                        if (ag[i + 1, instr].Contains("|")) if (ag[i + 1, instr].Length < ag[i - 1, instr].Length) ag[i - 1, instr] = ag[i - 1, instr].Substring(ag[i + 1, instr].Length);
                        for (var j = i; j < nolines - 1; j++) ag[j, instr] = ag[j + 1, instr];
                        ag[nolines - 1, instr] = "";
                        nolines--;
                        i--;
                    }

            ag[0, 0] = nolines.ToString();
            return ag;
        }

        static private int GetASCIIString(string cord, string[,] instruments, int instr, int nolines)
        {
            string strng = cord.Split('|')[0];

            for (var i = 0; i < 10; i++)
            {
                if (instruments[i, instr] == strng) return i;

            }
            return 0;
        }

        static private void CheckASCIITrack(string[,] a, int inst, int nolines)
        {
            string[,] tracks = new string[10, inst + 1];
            for (var i = 0; i < 10; i++) tracks[i, inst] = "";
            var line = false; var crd = 0; var cord = "";
            for (var i = 1; i <= nolines; i++)
            {
                cord = a[i, inst].ToLower();
                //decide if a line with notes else continue
                if (cord.Contains("|") && cord.IndexOf("|") >= 1 && cord.IndexOf("|") < 4)
                {
                    if (!line) line = true;
                    crd++;

                    if (tracks[crd, inst] != cord.Substring(0, cord.IndexOf("|")) && tracks[crd, inst] != "")//.ToLower() 
                        System.Windows.MessageBox.Show("There are more tunings than planned: " + cord);
                    if (cord.Substring(0, cord.IndexOf("|")) == "" || cord.Substring(0, cord.IndexOf("|")).Length > 3)
                    {
                        System.Windows.MessageBox.Show("There are some no-tuning / empty-tuning strings: " + cord);
                    }
                    if (crd > 6)
                        ShowImportASCII(a, "position: " + i + "/" + a.Length + ". There are more than 6 strings:\n" + cord, inst, nolines);

                    tracks[crd, inst] = cord.Substring(0, cord.IndexOf("|"));
                }
                else
                    if (cord.Contains("|"))
                    {
                        if (cord.IndexOf("|") >= 4)
                            System.Windows.MessageBox.Show("Tunning name is longer than 2 char: " + cord);

                        if (GetInstrFromASCII(cord) != "")
                        {
                            var last10char = cord.ToString().Substring(cord.ToString().Length - 10);
                            var inr = last10char.Substring(last10char.IndexOf("|") + 1).Trim();
                            System.Windows.MessageBox.Show("Unexpected track name:" + inr + "\n\n\n\n" +
                                "lead1" + ",rhythm1" + ",bass1" + ",lead2" + ",rhythm2" + ",bass2" + ",lead 1"
                                + ",rhythm 1" + ",bass 1" + ",lead 2" + ",rhythm 2" + ",bass 2" + ",lead" + ",rhythm" + ",bass"
                                + ",guitar 1" + ",guitar 2" + ",guitar1" + ",guitar2" + ",x..");
                        }
            ...
            //        if (a[i, inst] != null && a[j, inst] != null && a[i, inst].Trim() != "" && a[j, inst].Trim() != "")

            //            if (a[i, inst].Substring(0, a[i, inst].IndexOf("|")) == a[j, inst].Substring(0, a[j, inst].IndexOf("|")))
            //                System.Windows.MessageBox.Show("Some strings are in the same tunning");
        }

        static private string GetInstrFromASCII(string cord)
        {
            if (cord.Contains("lead1") || cord.Contains("rhythm1") || cord.Contains("bass1")
                             || cord.Contains("lead2") || cord.Contains("rhythm2") || !cord.Contains("bass2")
                             || cord.Contains("lead 1") || cord.Contains("rhythm 1") || cord.Contains("bass 1")
                             || cord.Contains("lead 2") || cord.Contains("rhythm 2") || cord.Contains("bass 2")
                             || cord.Contains("lead") || cord.Contains("rhythm") || cord.Contains("bass")
                             || cord.Contains("guitar 1") || cord.Contains("guitar 2")
                             || cord.Contains("guitar1") || cord.Contains("guitar2"))/*|| !cord.Contains("x")*/
            {
                if (cord.ToString().Length < 8) return "";
                var last10char = cord.ToString().Substring(cord.ToString().Length - 7);
                var inr = last10char.Substring(last10char.IndexOf("|") + 1).Trim();  //save the name of the track/arrangement/instrument
                inr = inr.Replace(" ", "").ToLower().Trim();
                return inr;
            }
            else return "";
        }

        static private string[,] GetASCIITrack(string[,] a, string[] inst, int nolines)
        {
            string[,] tracks = new string[10, 10];
            //for (var i = 0; i < 10; i++) tracks[i, inst] = "";
            var line = false; ; var cord = "";
            for (var j = 1; j <= inst[0].ToInt32(); j++)
            {
                var crd = 1;
                var notez = ""; var n = 1;
                for (var i = 1; i <= nolines; i++)
                {
                    ...
                    if (cord.Contains("|") && cord.IndexOf("|") >= 1 && cord.IndexOf("|") < 4)
                    {
                        if (!line)
                        {
                            for (var k = i; k <= nolines; k++)
                                if (a[k, 1].Contains("|") && a[k, 1].IndexOf("|") >= 1 && a[k, 1].IndexOf("|") < 4)
                                {
                                    var t = GetInstrFromASCII(a[k, 1].ToLower().Trim().Replace(" ", ""));
                                    notez = t != "" ? t : "";
                                    if ("" != notez) for (var m = 1; m < 10; m++) if (inst[m] == notez) { n = m; k = nolines + 1; break; }
                                }
                                else break;
                        ...
                        crd++;
                        if (n == j) tracks[crd, j] = cord.Substring(cord.IndexOf("|") + 1);
                    }
                    else
                    {
                        line = false; tracks[crd, 0] = crd.ToString();
                        crd = 0; notez = inst[n];
                    }
                }
            }
        ...
        static private string[] GetNoOfASCIIInstr(string[,] a, int nolines)
        {
            var cord = "";
            string[,] tracks = new string[10, 10];
            var inst = 1;
            string[] arrag = new string[10];
            //for (var inst = 1; inst < 10; inst++)
            for (var i = 1; i <= nolines; i++)
            {
                //if (a[i, 1] is null) continue;
                cord = a[i, 1].ToLower().Trim().Replace(" ", ""); ;// a[i, inst] is not null ? :null;
                                                                   //decide if a line with notes else continue
                if (cord.Contains("|") && cord.IndexOf("|") >= 1)
                {
                    if ((cord.Contains("lead1") || cord.Contains("rhythm1") || cord.Contains("bass1")
                            || cord.Contains("lead2") || cord.Contains("rhythm2") || cord.Contains("bass2")
                            //|| cord.Contains("lead 1") || cord.Contains("rhythm 1") || cord.Contains("bass 1")
                            ...
                            || cord.Contains("lead") || cord.Contains("rhythm") || cord.Contains("bass")
                        //|| cord.Contains("guitar 1") || cord.Contains("guitar 2")
                        || cord.Contains("guitar1") || cord.Contains("guitar2")))
                    {
                        var last10char = cord.ToString().Substring(cord.ToString().Length - 10);
                        var inr = last10char.Substring(last10char.IndexOf("|") + 1).Trim();  //save the name of the track/arrangement/instrument
                        inr = inr.Replace(" ", "").ToLower().Trim();
                        var found = false;
                        for (var j = 1; j < 10; j++) if (arrag[j] == inr) found = true;
                        if (!found)
                        {
                            arrag[inst] = inr;
                            arrag[0] = inst.ToString(); //store how many instr
                            inst++;
                        }
                    }
                }
        ...
        static private bool ShowImportASCII(string[,] a, string ttl, int instr, int nolines)
        {
            ErrorWindow frm2 = null; var txt = "";
            for (var j = 0; j < nolines; j++) txt += j.ToString().PadRight(4) + ": " + a[j, instr] + "\n";
            frm2 = new ErrorWindow(txt, "", ttl, false, true, true, "", "Stop", "OK", true);
            frm2.ShowDialog();

            if (frm2.B2) return true;
            return false;
        }

        static private int GetASCIIMultiplier(string[,] g, int j, int k, int inst, int nolines)
        {
            var multpl = "1";

            for (var i = j; i <= k; i++)
            {
                if (k >= nolines) return 0;
                var cord = g[i, inst].ToLower();
                if (cord.Contains("|"))
                {
                    if (cord.Contains("x2") || cord.Contains("x3") || cord.Contains("x4")
                        || cord.Contains("x5") || cord.Contains("x6") || cord.Contains("x7") || cord.Contains("x8")
                        || cord.Contains("x9") || cord.Contains("x10") || cord.Contains("x11") || cord.Contains("x12") || cord.Contains("x13")
                        || cord.Contains("x14") || cord.Contains("x15") || cord.Contains("x16"))
                    {
                        multpl = cord.Substring(cord.Length - 3).Trim().Replace("x", "");
                        if ((cord.IndexOf("x2") < cord.Length - 2 && cord.IndexOf("x2") > 0) || (cord.IndexOf("x3") < cord.Length - 2 && cord.IndexOf("x3") > 0) || (cord.IndexOf("x4") < cord.Length - 3 && cord.IndexOf("x4") > 0)
                            || (cord.IndexOf("x5") < cord.Length - 2 && cord.IndexOf("x5") > 0) || (cord.IndexOf("x6") < cord.Length - 2 && cord.IndexOf("x6") > 0) || (cord.IndexOf("x7") < cord.Length - 2 && cord.IndexOf("x7") > 0) || (cord.IndexOf("x8") < cord.Length - 2 && cord.IndexOf("x8") > 0)
                            || (cord.IndexOf("x9") < cord.Length - 2 && cord.IndexOf("x9") > 0) || (cord.IndexOf("x10") < cord.Length - 3 && cord.IndexOf("x10") > 0) || (cord.IndexOf("x11") < cord.Length - 3 && cord.IndexOf("11") > 0) || (cord.IndexOf("x12") < cord.Length - 3 && cord.IndexOf("x12") > 0) || (cord.IndexOf("x13") < cord.Length - 3 && cord.IndexOf("x13") > 0)
                            || (cord.IndexOf("x14") < cord.Length - 3 && cord.IndexOf("x14") > 0) || (cord.IndexOf("x15") < cord.Length - 3 && cord.IndexOf("x15") > 0) || (cord.IndexOf("x16") < cord.Length - 3 && cord.IndexOf("x16") > 0))
                            if (ShowImportASCII(g,
                                i + "\"" + k + ". xmultiplier prb not as last chords in the string notes. Please move them to a last row before importing: " + cord, inst, nolines)) return -1;
                        break;
                    }
                }
            }

            try { return multpl.ToInt32(); }
            catch (Exception ex)
            {
                var timestamp = UpdateLog(DateTime.Now, "GetAscii multiplier: " + ex.Message, true, ConfigRepository.Instance()["dlcm_TempPath"], "", "DLCManager", null, null);
                return 0;
            }
        }
