    ...
    public partial class MainDB : Form
    {
        ...
        public void ChangeRow()
        {
            ...
            if (databox.SelectedCells.Count > 0 && databox.Rows[databox.SelectedCells[0].RowIndex].Cells["ID"].ToString() != "")
            {
                ...
                txt_Playthough.Text = databox.Rows[i].Cells["Youtube_Playthrough"].Value.ToString();
                btn_Playthrough.Enabled = databox.Rows[i].Cells["Youtube_Playthrough"].Value.ToString() == "" ? false : true;
                ...
                //txt_UseInternalDDRemovalLogic.Text = databox.Rows[i].Cells["UseInternalDDRemovalLogic"].Value.ToString();
                ...
                if (databox.Rows[i].Cells["UseInternalDDRemovalLogic"].Value.ToString() == "Yes") chbx_UseInternalDDRemovalLogic.Checked = true;
                ...
                if (databox.Rows[i].Cells["Has_Bass"].Value.ToString() == "Yes") { chbx_Bass.Checked = true; chbx_Bass.ForeColor = System.Drawing.Color.Green; }/*chbx_Bass.Font = new Font(chbx_Bass.Font.Name, 7, FontStyle.Bold); | FontStyle.Underline*/
                ...
                if (databox.Rows[i].Cells["Has_Lead"].Value.ToString() == "Yes") { chbx_Lead.Checked = true; chbx_Lead.ForeColor = btn_Debug.ForeColor; }/*chbx_Lead.Font = new Font(chbx_Lead.Font.Name, 7, FontStyle.Bold);  | FontStyle.Underline*/
                ...
                if (databox.Rows[i].Cells["Has_Combo"].Value.ToString() == "Yes") { chbx_Combo.Checked = true; chbx_Combo.ForeColor = System.Drawing.Color.Green; }/*chbx_Combo.Font = new Font(chbx_Combo.Font.Name, 7, FontStyle.Bold); | FontStyle.Underline*/
                ...
                if (databox.Rows[i].Cells["Has_Rhythm"].Value.ToString() == "Yes") { chbx_Rhythm.Checked = true; chbx_Rhythm.ForeColor = System.Drawing.Color.Green; }/*chbx_Rhythm.Font = new Font(chbx_Rhythm.Font.Name, 7, FontStyle.Bold); | FontStyle.Underline*/
                ...
                if (float.Parse(databox.Rows[i].Cells["audioBitrate"].Value.ToString(), NumberStyles.Float, CultureInfo.CurrentCulture) > ConfigRepository.Instance()["dlcm_MaxBitRate"].ToInt32()
                    || float.Parse(databox.Rows[i].Cells["audioSampleRate"].Value.ToString(), NumberStyles.Float, CultureInfo.CurrentCulture) > ConfigRepository.Instance()["dlcm_MaxSampleRate"].ToInt32()
                    || databox.Rows[i].Cells["Has_Preview"].Value.ToString() != "Yes" || databox.Rows[i].Cells["Has_Track_No"].Value.ToString() != "Yes"
                    || databox.Rows[i].Cells["Track_No"].Value.ToString() == "-1" || databox.Rows[i].Cells["Track_No"].Value.ToString() == "0")
                ...
                toolTip1.SetToolTip(btn_PlayAudio, databox.Rows[i].Cells["Audio_OrigHash"].Value.ToString());
                toolTip2.SetToolTip(btn_PlayPreview, databox.Rows[i].Cells["Audio_OrigPreviewHash"].Value.ToString());
                toolTip3.SetToolTip(picbx_AlbumArtPath, databox.Rows[i].Cells["audioBitrate"].Value.ToString() + " - " + databox.Rows[i].Cells["audioSampleRate"].Value.ToString());
        ...
        public void SaveRecord()
        {
            ...
            if (databox.SelectedCells.Count > 0 && txt_ID.Text != "")
            {
                ...
                using (OleDbConnection cnn = new OleDbConnection("Provider=Microsoft." + ConfigRepository.Instance()["dlcm_AccessDLLVersion"] + ";Data Source=" + DB_Path))
                {
                    ...
                    command.Parameters.AddWithValue("@param92", databox.Rows[i].Cells["UseInternalDDRemovalLogic"].Value.ToString());
        ...
        private void cmb_Filter_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (chbx_FilterCompound.Checked)
            {
                ...
                {
                    SearchCmd = "SELECT * FROM (" + oldSearchCmd + ") WHERE ID not IN (" + SearchCmd.Replace("*", "ID") + ") ORDER BY Artist, Album_Year, Album, Track_No, Song_Title";
                    chbx_FilterNot.Checked = false;
                }
                else
                    SearchCmd = "SELECT * FROM (" + oldSearchCmd + ") WHERE ID IN (" + SearchCmd.Replace("*", "ID") + ") ORDER BY Artist, Album_Year, Album, Track_No, Song_Title";
                chbx_FilterCompound.Checked = false;
            }
            else if (chbx_FilterNot.Checked)
            {
                SearchCmd = "SELECT * FROM Main WHERE ID not IN (" + SearchCmd + ")";
                chbx_FilterNot.Checked = false;
            }
        ...
        private void btn_Duplicate_Click(object sender, EventArgs e)
        {
            ...
            try //Copy dir
            {
                ...
                var insertcmdd = "Song_Title, Song_Title_Sort, Album, Artist, Artist_Sort, Album_Year, AverageTempo, Volume, Preview_Volume, AlbumArtPath, AudioPath," +
                    ...
                    " AlbumArt_OrigHash, Duplicate_Of, Split4Pack";
                var insertvalues = "SELECT Song_Title+\" alt" + max.ToString() + "\", Song_Title_Sort+\" alt" + max.ToString() + "\", Album, Artist, Artist_Sort, Album_Year," +
                    ...
                    "Spotify_Album_URL, Top10, Audio_OrigHash, Audio_OrigPreviewHash, AlbumArt_OrigHash, \"" + txt_ID.Text + "\", Split4Pack FROM Main WHERE ID = " + txt_ID.Text;
                ...
                insertcmdd = "Arrangement_Name, CDLC_ID, Bonus, SNGFilePath, XMLFilePath, XMLFile_Hash, ScrollSpeed, Tunning, Rating, PlayThoughYBLink, CustomsForge_Link," +
                    ...
                    "SNGFileHash, Has_Sections, Comments, Start_Time, SNGFileHash_Orig, XMLFile_Hash_Orig, Part";
                insertvalues = "SELECT Arrangement_Name, " + CDLC_ID + ", Bonus, \"" + destination_dir + "\\manifests\\\"+right(SNGFilePath,len(SNGFilePath)-" +
                    ...
                    " XMLFile_Hash_Orig, Part FROM Arrangements WHERE CDLC_ID = " + txt_ID.Text;
                ...
                insertcmdd = "CDLC_ID, Gear_Name, Category, KnobValuesKeys, KnobValuesValues, PedalKey, Skin, SkinIndex, Type, Comments, Tone_Name";
                insertvalues = "SELECT \"" + CDLC_ID + "\", Gear_Name, Category, KnobValuesKeys, KnobValuesValues, PedalKey, Skin, SkinIndex, Type, Comments, Tone_Name" +
...
*/
        ...
        private void btn_CreateLyrics_Click(object sender, EventArgs e)
        {
            ...
            ErrorWindow frm1 = new ErrorWindow("Steps to follow: \n\n1.Google for Lyrics e.g." + link + " \n\n2. Use Ultrastar" +
        ...
        private void btn_ChangeLyrics_Click(object sender, EventArgs e)
        {
            ...
            using (var fbd = new OpenFileDialog())
            {
                ...
                if (fbd.FileName.IndexOf(fbd.InitialDirectory) < 0)
                {
                    File.Copy(fbd.FileName, fbd.InitialDirectory + "\\songs\\arr\\" + Path.GetFileName(fbd.FileName), true);
                    temppath = fbd.InitialDirectory + "\\songs\\arr\\" + Path.GetFileName(fbd.FileName);

                }
                else temppath = fbd.FileName;
                //Generating the HASH code
                var FileHash = "";
                ...
                File.Copy(outputFile, fbd.InitialDirectory + "\\songs\\bin\\" + Path.GetFileName(outputFile), true);
                DeleteFile(outputFile);
                outputFile = fbd.InitialDirectory + "\\songs\\bin\\" + Path.GetFileName(outputFile);
        ...
        private void btn_Find_FilesMissingIssues_Click(object sender, EventArgs e)
        {
                            ...
                            if (stdoutx != "\r\n") if (float.Parse(stdoutx.Replace("\r\n", ""), NumberStyles.Float, CultureInfo.CurrentCulture) > float.Parse(ConfigRepository.Instance()["dlcm_MaxBitRate"], NumberStyles.Float, CultureInfo.CurrentCulture))
                                {
                                    ...
                                    j++; timestamp = UpdateLog(DateTime.Now, SongRecord.Tables[0].Rows[i].ItemArray[5].ToString() + "_" + j + "/" + i + "/" + noOfRecs + " bitrate " + stdoutx.Replace("\r\n", ""), true, ConfigRepository.Instance()["dlcm_LogPath"], ConfigRepository.Instance()["dlcm_TempPath"], "", "MainDB", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
                                }
            ...
            {
                if (s.IndexOf("0_old") <= 0 && s.IndexOf("0_repacked") <= 0 && s.IndexOf("0_duplicate") <= 0 && s.IndexOf("0_dlcpacks") <= 0 && s.IndexOf("0_broken") <= 0 && s.IndexOf("0_albumCovers") <= 0 && s.IndexOf("0_log") <= 0 && s.IndexOf("0_archive") <= 0)
        ...
        private void btn_Remove_All_Packed_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                CleanFolder(TempPath + "\\0_repacked\\PC", "", false, Archive_Path, "MainDB", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
                CleanFolder(TempPath + "\\0_repacked\\PS3", "", false, Archive_Path, "MainDB", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
                CleanFolder(TempPath + "\\0_repacked\\MAC", "", false, Archive_Path, "MainDB", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
                CleanFolder(TempPath + "\\0_repacked\\XBOX360", "", false, Archive_Path, "MainDB", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
            }
            catch (Exception ex) { var tsst = "Error ..." + ex; UpdateLog(DateTime.Now, tsst, false, ConfigRepository.Instance()["dlcm_LogPath"], ConfigRepository.Instance()["dlcm_TempPath"], "", "", null, null); }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    CleanFolder(TempPath + "\\0_duplicate", "", true, Archive_Path, "MainDB", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
                }
                catch (Exception ex) { var tsst = "Error ..." + ex; UpdateLog(DateTime.Now, tsst, false, ConfigRepository.Instance()["dlcm_LogPath"], ConfigRepository.Instance()["dlcm_TempPath"], "", "", null, null); }
            }
        ...
        public async void btn_Debug_ClickAsync(object sender, EventArgs e)
        {
            ...
            foreach (var filez in SongRecords)
            {
                ...
                var yAddress = await new GenericFunctions().YoutubeRun(SongRecords[j], j, cnb);//.Result;//.Wait();
        ...
        public void btn_Fix_All_Audio_isues_Click(object sender, EventArgs e)
        {
            ...
            cmd += " AND ID=" + txt_ID.Text + "";
            FixAudioIssues(cmd, cnb, AppWD, pB_ReadDLCs, rtxt_StatisticsOnReadDLCs, cancel);
            ...
            //{
            //pB_ReadDLCs.Increment(1);
            FixWithSpotifyDetails(SongRecord, 0, noOfRec);
        ...
        public void btn_FixAudioAll_Click(object sender, EventArgs e)
        {
            ...
            if (netstatus == "NOK" || netstatus == "")
                ...
                try { netstatus = GenericFunctions.ActivateSpotify_ClickAsync().Result.ToString(); }
                catch (Exception ex) { var tsst = "Error ..." + ex; UpdateLog(DateTime.Now, tsst, false, ConfigRepository.Instance()["dlcm_LogPath"], ConfigRepository.Instance()["dlcm_TempPath"], "", "", null, null); }
            //else;
            var sel = "SELECT Song_Title, Song_Title_Sort, Album, Artist, Album_Year, ID FROM Main WHERE (Track_No = \"00\" OR Track_No = \"0\" OR Track_No = \"-1\" OR Track_No = \"\" OR Track_No is null) "
            ...
            {
                pB_ReadDLCs.Increment(1);
                FixWithSpotifyDetails(SongRecord, i, noOfRec);
            }
            SongRecord.Dispose();
            ...
            {
                if (filez.Artist == null) break;
                GetYoutubeDetailsAsync(SongRecords[j], j, cnb, pB_ReadDLCs);
                j++;
        ...
        public void FixWithSpotifyDetails(DataSet SongRecord, int i, int noOfRec)
        {
            try
            {
                ...
                var timestamp = UpdateLog(DateTime.Now, i + "/" + (noOfRec - 1) + " Spotify details: " + trackno + " " + SpotifyAlbumPath, true, logPath, ConfigRepository.Instance()["dlcm_TempPath"], "", "MainDB", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
        ...
        private void button4_Click_1(object sender, EventArgs e)
        {
            ...
            if (norows > 1)
                foreach (var file in SongRecord)
                {
                    ...
                    timestamp = UpdateLog(timestamp, dupli_reason, true, logPath, ConfigRepository.Instance()["dlcm_TempPath"], "", "DLCManager", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
                    ...
                    //Exit condition
                    var tst = "end check for dupli..."; timestamp = UpdateLog(timestamp, tst, true, logPath, ConfigRepository.Instance()["dlcm_TempPath"], "", "DLCManager", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
        ...
        internal string AssessConflict(GenericFunctions.MainDBfields filed, DLCPackageData datas, string Fauthor, string tkversion, string DD,
            ...
            string IsAcoustic, string has_Orig, string dupli_reason, string sel, int Duplic, bool Rebuild, float versio, float norowsduo, string fzg, int j, string SongLenght)
        {
            ...
            //    {
            //        dupli_reason += "Initially assed as duplicate with all files hash identical."; timestamp = UpdateLog(timestamp, dupli_reason, true, logPath, ConfigRepository.Instance()["dlcm_TempPath"], "", "DLCManager", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
            ...
            //        has_Orig = "Yes";
            //        dupli_reason += "Initially assed as Duplicate-Original."; timestamp = UpdateLog(timestamp, dupli_reason, true, logPath, ConfigRepository.Instance()["dlcm_TempPath"], "", "DLCManager", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
            ...
            //        UpdateDB("Main", "UPDATE Main SET Has_Other_Officials=\"Yes\" WHERE ID=" + filed.ID + "", cnb);
            //        has_Orig = "Yes";
            //        dupli_reason += "Initially assed as Duplicate-Original-DiffPlatform."; timestamp = UpdateLog(timestamp, dupli_reason, true, logPath, ConfigRepository.Instance()["dlcm_TempPath"], "", "DLCManager", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
            ...
            //    {
            //        dupli_reason += "Initially assed as duplicate cause same aothor but different platform."; timestamp = UpdateLog(timestamp, dupli_reason, true, logPath, ConfigRepository.Instance()["dlcm_TempPath"], "", "DLCManager", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
            ...
            //    {
            //        dupli_reason += "Initially assed as alternate cause multitrack/live/aCOUSRTIC."; timestamp = UpdateLog(timestamp, dupli_reason, true, logPath, ConfigRepository.Instance()["dlcm_TempPath"], "", "DLCManager", pB_ReadDLCs, rtxt_StatisticsOnReadDLCs);
            //        return "Alternate;alt";
            //    }
            //}
            ...
            frm_Duplicates_Management frm1 = new frm_Duplicates_Management(filed, datas, Fauthor, tkversion, DD, Bass, Guitar, Combo,
                ...
                fsz, unpackedDir, Is_MultiTrack, MultiTrack_Version, FileDate, title_duplic, platform, IsLive, LiveDetails, IsAcoustic, cnb, dupli_reason, SongLenght);
            frm1.ShowDialog();
