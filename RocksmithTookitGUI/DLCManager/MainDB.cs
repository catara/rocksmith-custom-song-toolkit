        ...
        private void cmb_Filter_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            switch (Filtertxt)
            {
                ...
                case "Main_NoPreviewFile":
                    ...
                    break;
                case "Uploaded Last":
                    var SearchCmd3 = "SELECT max(Pack) FROM Main ;";//ORDER BY Pack,Import_Date DESC "SELECT MAX(ID),Import_Date FROM Main;";// WHERE Import_Date=''";
