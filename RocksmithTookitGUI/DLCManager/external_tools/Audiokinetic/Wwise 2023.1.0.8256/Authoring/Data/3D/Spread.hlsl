...
VSOutput mainVS(float4 pos : POSITION0, float4 normal : NORMAL)
{
	...
	unselected_spread_mask = clamp(unselected_spread_mask, 0, 1) * UnSelectedMultiplier;
	...
	selected_spread_mask = clamp(selected_spread_mask, 0, 1) * SelectedMultiplier;
