...
namespace RocksmithToolkitLib.Extensions
{
    public static class ExternalApps
    {
        ...
        public static void Ogg2Preview(string sourcePath, string destinationPath, long msLength = 30000, long msStart = 4000)
        {
            ...
            GeneralExtensions.RunExternalExecutable(APP_OGGCUT, true, true, true, cmdArgs); //bcapi hidding conversion windows
        }
        ...
        public static void Ogg2Wav(string sourcePath, string destinationPath)
        {
            ...
            GeneralExtensions.RunExternalExecutable(APP_OGGDEC, true, true, true, cmdArgs); //bcapi hidding conversion windows
        }
